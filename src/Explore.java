...
//buildings2ChangeColorRect(\d+)\.col = Color.PINK;
//buildings2ChangeColorRect\1\.col = Color.PINK;  buildings2ChangeColorRect\1\.grayCol = grayPink;
...
//	ColorfulRectangle player = new ColorfulRectangle(450,300,50,50,Blue,grayBlue);
	...
	boolean winscreenshown = false; //false
	...
	public void setup() {
		...
		pausedImg = loadImage("pausedImage.png");
	...
	public void draw() {
		...
		if(!menushown && !optionsshown && !pausedshown && !mapshown && !finished && !secEnd && !winscreenshown) {
			emeny.draw(); 
			emeny.update();
				if(!wall1) {
					emeny2.draw(); 
		...
		if(!menushown && !optionsshown && !pausedshown && !mapshown && !winscreenshown) {
			buildings();
			buildings2();
			buildingdarkness();
		}
...
//		}
		...
		if(!wall1 && !menushown && !optionsshown && !pausedshown && !mapshown && FlashingLights && !winscreenshown) {
		...
		randomxGRAY = randon.nextInt(500);
		randomyGRAY = randon.nextInt(250);
		...
		Endinggray2.setBounds(movex+randomxGRAY+100,movey+randomyGRAY+750,20,20);
		...
		if(finished && !optionsshown && !pausedshown && FlashingLights && !winscreenshown) {
			...
			arandomxGRAY = randon.nextInt(4300);
			arandomyGRAY = randon.nextInt(3100);
			...
			aEndinggray2.setBounds(movex+arandomxGRAY-2350,movey+arandomyGRAY-1150,20,20);
		...
		if(finished==true && !optionsshown && !pausedshown && !winscreenshown) {
			endingBlocks();
		...
		if(!menushown && !optionsshown && !pausedshown && !mapshown && !finished && !winscreenshown) {
				door1.draw();
				door1.update();
				if(wall1==false) {
				door2.draw();
		...
		if(finished && !optionsshown && !pausedshown && !winscreenshown) {
...
//		System.out.println(noDoubleClickOptions);
		...
		if(showTeleport==true && !menushown && !optionsshown && !pausedshown && !mapshown && !winscreenshown) {
		...
		//System.out.println(movex + " " + movey);
		if(!menushown && !optionsshown && !pausedshown && !mapshown && !wall2 && !finished && !winscreenshown) {
		...
		}if(!FlashingLights && !menushown && !optionsshown && !pausedshown && !mapshown && !winscreenshown) {
		...
		if(!menushown && !optionsshown && !pausedshown && !mapshown && FlashingLights && !winscreenshown) {
		teleport1RED.draw();
		...
		if(finished && !menushown && !optionsshown && !pausedshown && !mapshown && !winscreenshown) {
		...
		if(yellowKeyCount.keys==1) {
			...
			keynum4.draw();
			keynum5.draw();
		}else if(yellowKeyCount.keys==6) {
			ColorfulRectangle keynum1 = new ColorfulRectangle(710,0, 30, 10, Color.WHITE);
			ColorfulRectangle keynum2 = new ColorfulRectangle(710,10, 10, 40, Color.WHITE);
			ColorfulRectangle keynum3 = new ColorfulRectangle(710,20, 30, 10, Color.WHITE);
			ColorfulRectangle keynum4 = new ColorfulRectangle(730,30, 10, 20, Color.WHITE);
			ColorfulRectangle keynum5 = new ColorfulRectangle(710,40, 30, 10, Color.WHITE);
			keynum1.draw();
			...
			keynum4.draw();
			keynum5.draw();
		}else if(yellowKeyCount.keys==7) {
			ColorfulRectangle keynum1 = new ColorfulRectangle(710,0, 30, 10, Color.WHITE);
			ColorfulRectangle keynum2 = new ColorfulRectangle(730,0, 10, 50, Color.WHITE);
			keynum1.draw();
			keynum2.draw();
		}else if(yellowKeyCount.keys==8) {
			ColorfulRectangle keynum1 = new ColorfulRectangle(710,0, 30, 10, Color.WHITE);
			ColorfulRectangle keynum2 = new ColorfulRectangle(710,10, 10, 40, Color.WHITE);
			ColorfulRectangle keynum3 = new ColorfulRectangle(710,20, 30, 10, Color.WHITE);
			ColorfulRectangle keynum4 = new ColorfulRectangle(730,10, 10, 40, Color.WHITE);
			ColorfulRectangle keynum5 = new ColorfulRectangle(710,40, 30, 10, Color.WHITE);
			keynum1.draw();
			keynum2.draw();
			keynum3.draw();
		...
		if(pinkKeyCount.keys==1) {
			...
			keynum4.draw();
			keynum5.draw();
		}else if(pinkKeyCount.keys==6) {
			ColorfulRectangle keynum1 = new ColorfulRectangle(560,0, 30, 10, Color.WHITE);
			ColorfulRectangle keynum2 = new ColorfulRectangle(560,10, 10, 40, Color.WHITE);
			ColorfulRectangle keynum3 = new ColorfulRectangle(560,20, 30, 10, Color.WHITE);
			ColorfulRectangle keynum4 = new ColorfulRectangle(580,30, 10, 20, Color.WHITE);
			ColorfulRectangle keynum5 = new ColorfulRectangle(560,40, 30, 10, Color.WHITE);
			keynum1.draw();
			...
			keynum4.draw();
			keynum5.draw();
		}else if(pinkKeyCount.keys==7) {
			ColorfulRectangle keynum1 = new ColorfulRectangle(560,0, 30, 10, Color.WHITE);
			ColorfulRectangle keynum2 = new ColorfulRectangle(580,0, 10, 50, Color.WHITE);
			keynum1.draw();
			keynum2.draw();
		}else if(pinkKeyCount.keys==8) {
			ColorfulRectangle keynum1 = new ColorfulRectangle(560,0, 30, 10, Color.WHITE);
			ColorfulRectangle keynum2 = new ColorfulRectangle(560,10, 10, 40, Color.WHITE);
			ColorfulRectangle keynum3 = new ColorfulRectangle(560,20, 30, 10, Color.WHITE);
			ColorfulRectangle keynum4 = new ColorfulRectangle(580,10, 10, 40, Color.WHITE);
			ColorfulRectangle keynum5 = new ColorfulRectangle(560,40, 30, 10, Color.WHITE);
			keynum1.draw();
			keynum2.draw();
			keynum3.draw();
		...
		if(orangeKeyCount.keys==1) {
			...
			keynum4.draw();
			keynum5.draw();
		}else if(orangeKeyCount.keys==6) {
			ColorfulRectangle keynum1 = new ColorfulRectangle(410,0, 30, 10, Color.WHITE);
			ColorfulRectangle keynum2 = new ColorfulRectangle(410,10, 10, 40, Color.WHITE);
			ColorfulRectangle keynum3 = new ColorfulRectangle(410,20, 30, 10, Color.WHITE);
			ColorfulRectangle keynum4 = new ColorfulRectangle(430,30, 10, 20, Color.WHITE);
			ColorfulRectangle keynum5 = new ColorfulRectangle(410,40, 30, 10, Color.WHITE);
			keynum1.draw();
			...
			keynum4.draw();
			keynum5.draw();
		}else if(orangeKeyCount.keys==7) {
			ColorfulRectangle keynum1 = new ColorfulRectangle(410,0, 30, 10, Color.WHITE);
			ColorfulRectangle keynum2 = new ColorfulRectangle(430,0, 10, 50, Color.WHITE);
			keynum1.draw();
			keynum2.draw();
		}else if(orangeKeyCount.keys==8) {
			ColorfulRectangle keynum1 = new ColorfulRectangle(410,0, 30, 10, Color.WHITE);
			ColorfulRectangle keynum2 = new ColorfulRectangle(410,10, 10, 40, Color.WHITE);
			ColorfulRectangle keynum3 = new ColorfulRectangle(410,20, 30, 10, Color.WHITE);
			ColorfulRectangle keynum4 = new ColorfulRectangle(430,10, 10, 40, Color.WHITE);
			ColorfulRectangle keynum5 = new ColorfulRectangle(410,40, 30, 10, Color.WHITE);
			keynum1.draw();
			keynum2.draw();
			keynum3.draw();
		...
		if(blueKeyCount.keys==1) {
			...
			keynum4.draw();
			keynum5.draw();
		}else if(blueKeyCount.keys==6) {
			ColorfulRectangle keynum1 = new ColorfulRectangle(260,0, 30, 10, Color.WHITE);
			ColorfulRectangle keynum2 = new ColorfulRectangle(260,10, 10, 40, Color.WHITE);
			ColorfulRectangle keynum3 = new ColorfulRectangle(260,20, 30, 10, Color.WHITE);
			ColorfulRectangle keynum4 = new ColorfulRectangle(280,30, 10, 20, Color.WHITE);
			ColorfulRectangle keynum5 = new ColorfulRectangle(260,40, 30, 10, Color.WHITE);
			keynum1.draw();
			...
			keynum4.draw();
			keynum5.draw();
		}else if(blueKeyCount.keys==7) {
			ColorfulRectangle keynum1 = new ColorfulRectangle(260,0, 30, 10, Color.WHITE);
			ColorfulRectangle keynum2 = new ColorfulRectangle(280,0, 10, 50, Color.WHITE);
			keynum1.draw();
			keynum2.draw();
		}else if(blueKeyCount.keys==8) {
			ColorfulRectangle keynum1 = new ColorfulRectangle(260,0, 30, 10, Color.WHITE);
			ColorfulRectangle keynum2 = new ColorfulRectangle(260,10, 10, 40, Color.WHITE);
			ColorfulRectangle keynum3 = new ColorfulRectangle(260,20, 30, 10, Color.WHITE);
			ColorfulRectangle keynum4 = new ColorfulRectangle(280,10, 10, 40, Color.WHITE);
			ColorfulRectangle keynum5 = new ColorfulRectangle(260,40, 30, 10, Color.WHITE);
			keynum1.draw();
			keynum2.draw();
			keynum3.draw();
		...
		if(blackKeyCount.keys==1) {
			...
			keynum4.draw();
			keynum5.draw();
		}else if(blackKeyCount.keys==6) {
			ColorfulRectangle keynum1 = new ColorfulRectangle(110,0, 30, 10, Color.WHITE);
			ColorfulRectangle keynum2 = new ColorfulRectangle(110,10, 10, 40, Color.WHITE);
			ColorfulRectangle keynum3 = new ColorfulRectangle(110,20, 30, 10, Color.WHITE);
			ColorfulRectangle keynum4 = new ColorfulRectangle(130,30, 10, 20, Color.WHITE);
			ColorfulRectangle keynum5 = new ColorfulRectangle(110,40, 30, 10, Color.WHITE);
			keynum1.draw();
			...
			keynum4.draw();
			keynum5.draw();
		}else if(blackKeyCount.keys==7) {
			ColorfulRectangle keynum1 = new ColorfulRectangle(110,0, 30, 10, Color.WHITE);
			ColorfulRectangle keynum2 = new ColorfulRectangle(130,0, 10, 50, Color.WHITE);
			keynum1.draw();
			keynum2.draw();
		}else if(blackKeyCount.keys==8) {
			ColorfulRectangle keynum1 = new ColorfulRectangle(110,0, 30, 10, Color.WHITE);
			ColorfulRectangle keynum2 = new ColorfulRectangle(110,10, 10, 40, Color.WHITE);
			ColorfulRectangle keynum3 = new ColorfulRectangle(110,20, 30, 10, Color.WHITE);
			ColorfulRectangle keynum4 = new ColorfulRectangle(130,10, 10, 40, Color.WHITE);
			ColorfulRectangle keynum5 = new ColorfulRectangle(110,40, 30, 10, Color.WHITE);
			keynum1.draw();
			keynum2.draw();
			keynum3.draw();
		...
		if(map && !optionsshown && !pausedshown) {
			facing=0;
			mapp();
			mapp2();
			mappdarkness();
		...
		//OPTIONS
		if(!menushown && !optionsshown && !pausedshown && Stroke && !winscreenshown) {
		stroke(bgColor.getRGB());
		}
		
		if(chosenBGcolor==1) {
		bgColor = new Color(50, 0, 0);
		bgColorOutline = new Color(255, 0, 0);
		}else if(chosenBGcolor==2) {
		bgColor = new Color(50, 50, 0);
		bgColorOutline = new Color(255, 255, 0);
		}else if(chosenBGcolor==3) {
		bgColor = new Color(0, 50, 0);
		bgColorOutline = new Color(0, 255, 0);
		}else if(chosenBGcolor==4) {
		bgColor = new Color(0, 0, 50);
		bgColorOutline = new Color(0, 0, 255);
		}else if(chosenBGcolor==5) {
		bgColor = new Color(50, 0, 50);
		bgColorOutline = new Color(255, 0, 255);
		}else if(chosenBGcolor==6) {
		bgColor = new Color(0, 0, 0);
		bgColorOutline = new Color(0, 0, 0);
		}
				
		if(chosenEnemyDifficultyOutline==1) {
		enemyDifficultyOutline = new Color(0, 255, 0);
		}else if(chosenEnemyDifficultyOutline==2) {
		enemyDifficultyOutline = new Color(255, 255, 0);
		}else if(chosenEnemyDifficultyOutline==3) {
		enemyDifficultyOutline = new Color(255, 0, 0);
		}else if(chosenEnemyDifficultyOutline==4) {
		enemyDifficultyOutline = new Color(255, 0, 255);
		}
...
//		rects.add(new ColorfulRectangle(500+40,280+105, 5, 5, Color.WHITE));
	...
	public void endingBlocks() {
		...
		buildings2ChangeColorRect1 = new ColorfulRectangle(movex+-300,movey+750, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect2 = new ColorfulRectangle(movex+-300,movey+700, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect3 = new ColorfulRectangle(movex+-300,movey+650, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect4 = new ColorfulRectangle(movex+0,movey+650, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect5 = new ColorfulRectangle(movex+-50,movey+650, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect6 = new ColorfulRectangle(movex+-400,movey+500, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect7 = new ColorfulRectangle(movex+-350,movey+500, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect8 = new ColorfulRectangle(movex+-300,movey+250, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect9 = new ColorfulRectangle(movex+-300,movey+300, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect10 = new ColorfulRectangle(movex+-1000,movey+100, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect11 = new ColorfulRectangle(movex+-700,movey+-400, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect12 = new ColorfulRectangle(movex+-700,movey+-350, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect13 = new ColorfulRectangle(movex+-1000,movey+-600, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect14 = new ColorfulRectangle(movex+-450,movey+-550, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect15 = new ColorfulRectangle(movex+-400,movey+-800, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect16 = new ColorfulRectangle(movex+-400,movey+-750, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect17 = new ColorfulRectangle(movex+-400,movey+-700, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect18 = new ColorfulRectangle(movex+-100,movey+-800, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect19 = new ColorfulRectangle(movex+-100,movey+-750, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect20 = new ColorfulRectangle(movex+-50,movey+-400, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect21 = new ColorfulRectangle(movex+-50,movey+-350, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect22 = new ColorfulRectangle(movex+150,movey+-300, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect23 = new ColorfulRectangle(movex+200,movey+-300, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect24 = new ColorfulRectangle(movex+600,movey+-450, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect25 = new ColorfulRectangle(movex+650,movey+-450, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect26 = new ColorfulRectangle(movex+450,movey+-50, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect27 = new ColorfulRectangle(movex+450,movey+0, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect28 = new ColorfulRectangle(movex+500,movey+0, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect29 = new ColorfulRectangle(movex+1050,movey+-150, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect30 = new ColorfulRectangle(movex+1000,movey+-150, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect31 = new ColorfulRectangle(movex+950,movey+-150, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect32 = new ColorfulRectangle(movex+900,movey+-150, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect33 = new ColorfulRectangle(movex+850,movey+-150, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect34 = new ColorfulRectangle(movex+1100,movey+-200, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect35 = new ColorfulRectangle(movex+600,movey+-700, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect36 = new ColorfulRectangle(movex+1050,movey+-650, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect37 = new ColorfulRectangle(movex+1150,movey+-650, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect38 = new ColorfulRectangle(movex+1150,movey+-550, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect39 = new ColorfulRectangle(movex+1250,movey+-550, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect40 = new ColorfulRectangle(movex+1700,movey+-600, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect41 = new ColorfulRectangle(movex+1850,movey+-1050, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect42 = new ColorfulRectangle(movex+1000,movey+-950, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect43 = new ColorfulRectangle(movex+-50,movey+1300, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect44 = new ColorfulRectangle(movex+-50,movey+1400, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect45 = new ColorfulRectangle(movex+-500,movey+-50, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect46 = new ColorfulRectangle(movex+-450,movey+-50, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect47 = new ColorfulRectangle(movex+-400,movey+-50, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect48 = new ColorfulRectangle(movex+-350,movey+-50, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect49 = new ColorfulRectangle(movex+-350,movey+0, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect50 = new ColorfulRectangle(movex+-650,movey+-900, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect51 = new ColorfulRectangle(movex+-650,movey+-950, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect52 = new ColorfulRectangle(movex+-750,movey+-50, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect53 = new ColorfulRectangle(movex+-800,movey+-50, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect53a = new ColorfulRectangle(movex+-150,movey+1150, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect54 = new ColorfulRectangle(movex+-150,movey+1200, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect55 = new ColorfulRectangle(movex+-150,movey+1250, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect56 = new ColorfulRectangle(movex+-200,movey+1250, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect57 = new ColorfulRectangle(movex+-200,movey+1300, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect58 = new ColorfulRectangle(movex+-200,movey+1350, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect59 = new ColorfulRectangle(movex+-50,movey+1350, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect60 = new ColorfulRectangle(movex+-50,movey+1450, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect61 = new ColorfulRectangle(movex+0,movey+1450, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect62 = new ColorfulRectangle(movex+0,movey+1500, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect63 = new ColorfulRectangle(movex+-200,movey+600, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect64 = new ColorfulRectangle(movex+-150,movey+600, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect65 = new ColorfulRectangle(movex+50,movey+650, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect66 = new ColorfulRectangle(movex+-300,movey+600, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect67 = new ColorfulRectangle(movex+-250,movey+600, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect68 = new ColorfulRectangle(movex+-450,movey+450, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect69 = new ColorfulRectangle(movex+-500,movey+450, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect70 = new ColorfulRectangle(movex+-450,movey+500, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect71 = new ColorfulRectangle(movex+-300,movey+500, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect72 = new ColorfulRectangle(movex+-250,movey+500, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect73 = new ColorfulRectangle(movex+-250,movey+550, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect74 = new ColorfulRectangle(movex+-200,movey+550, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect75 = new ColorfulRectangle(movex+-250,movey+200, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect76 = new ColorfulRectangle(movex+-250,movey+150, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect77 = new ColorfulRectangle(movex+-150,movey+250, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect78 = new ColorfulRectangle(movex+-200,movey+250, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect79 = new ColorfulRectangle(movex+-550,movey+-200, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect80 = new ColorfulRectangle(movex+-500,movey+-200, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect81 = new ColorfulRectangle(movex+-450,movey+-200, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect82 = new ColorfulRectangle(movex+-400,movey+0, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect83 = new ColorfulRectangle(movex+-350,movey+50, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect84 = new ColorfulRectangle(movex+-300,movey+50, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect85 = new ColorfulRectangle(movex+-300,movey+0, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect86 = new ColorfulRectangle(movex+-250,movey+50, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect87 = new ColorfulRectangle(movex+-850,movey+-50, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect88 = new ColorfulRectangle(movex+-900,movey+-200, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect89 = new ColorfulRectangle(movex+-900,movey+-50, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect90 = new ColorfulRectangle(movex+-700,movey+-50, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect91 = new ColorfulRectangle(movex+-700,movey+-200, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect92 = new ColorfulRectangle(movex+-650,movey+-200, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect93 = new ColorfulRectangle(movex+-1050,movey+200, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect94 = new ColorfulRectangle(movex+-2000,movey+50, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect95 = new ColorfulRectangle(movex+-950,movey+200, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect96 = new ColorfulRectangle(movex+-2000,movey+150, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect97 = new ColorfulRectangle(movex+-950,movey+150, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect98 = new ColorfulRectangle(movex+-650,movey+-450, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect99 = new ColorfulRectangle(movex+-700,movey+-450, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect100 = new ColorfulRectangle(movex+-650,movey+-500, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect101 = new ColorfulRectangle(movex+-650,movey+-400, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect102 = new ColorfulRectangle(movex+-700,movey+-300, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect103 = new ColorfulRectangle(movex+-750,movey+-300, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect104 = new ColorfulRectangle(movex+-2000,movey+-550, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect105 = new ColorfulRectangle(movex+-1050,movey+-550, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect106 = new ColorfulRectangle(movex+-1050,movey+-500, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect107 = new ColorfulRectangle(movex+-1050,movey+-450, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect108 = new ColorfulRectangle(movex+-1200,movey+-450, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect109 = new ColorfulRectangle(movex+-400,movey+-550, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect110 = new ColorfulRectangle(movex+-350,movey+-600, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect111 = new ColorfulRectangle(movex+-350,movey+-550, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect112 = new ColorfulRectangle(movex+-300,movey+-600, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect113 = new ColorfulRectangle(movex+-250,movey+-600, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect114 = new ColorfulRectangle(movex+-300,movey+-550, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect115 = new ColorfulRectangle(movex+-350,movey+-800, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect116 = new ColorfulRectangle(movex+-350,movey+-850, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect117 = new ColorfulRectangle(movex+-350,movey+-750, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect118 = new ColorfulRectangle(movex+-650,movey+-2000, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect119 = new ColorfulRectangle(movex+-700,movey+-2000, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect120 = new ColorfulRectangle(movex+-700,movey+-950, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect121 = new ColorfulRectangle(movex+-750,movey+-950, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect122 = new ColorfulRectangle(movex+-700,movey+-850, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect123 = new ColorfulRectangle(movex+-650,movey+-850, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect124 = new ColorfulRectangle(movex+-700,movey+-900, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect125 = new ColorfulRectangle(movex+-200,movey+-700, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect126 = new ColorfulRectangle(movex+-150,movey+-700, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect127 = new ColorfulRectangle(movex+-150,movey+-750, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect128 = new ColorfulRectangle(movex+-150,movey+-800, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect129 = new ColorfulRectangle(movex+-450,movey+-500, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect130 = new ColorfulRectangle(movex+-50,movey+-450, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect131 = new ColorfulRectangle(movex+-200,movey+-400, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect132 = new ColorfulRectangle(movex+-200,movey+-350, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect133 = new ColorfulRectangle(movex+-50,movey+-300, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect134 = new ColorfulRectangle(movex+0,movey+-250, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect135 = new ColorfulRectangle(movex+50,movey+-200, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect136 = new ColorfulRectangle(movex+50,movey+-250, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect137 = new ColorfulRectangle(movex+200,movey+-250, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect138 = new ColorfulRectangle(movex+200,movey+-200, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect139 = new ColorfulRectangle(movex+150,movey+-250, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect140 = new ColorfulRectangle(movex+200,movey+-350, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect141 = new ColorfulRectangle(movex+400,movey+-200, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect142 = new ColorfulRectangle(movex+400,movey+-50, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect143 = new ColorfulRectangle(movex+350,movey+-200, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect144 = new ColorfulRectangle(movex+500,movey+50, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect145 = new ColorfulRectangle(movex+550,movey+50, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect146 = new ColorfulRectangle(movex+550,movey+-500, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect147 = new ColorfulRectangle(movex+500,movey+-500, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect148 = new ColorfulRectangle(movex+550,movey+-450, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect149 = new ColorfulRectangle(movex+600,movey+-500, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect150 = new ColorfulRectangle(movex+700,movey+-450, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect151 = new ColorfulRectangle(movex+700,movey+-400, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect152 = new ColorfulRectangle(movex+750,movey+-400, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect153 = new ColorfulRectangle(movex+800,movey+-400, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect154 = new ColorfulRectangle(movex+800,movey+-450, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect155 = new ColorfulRectangle(movex+850,movey+-450, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect156 = new ColorfulRectangle(movex+850,movey+-400, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect157 = new ColorfulRectangle(movex+800,movey+-150, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect158 = new ColorfulRectangle(movex+800,movey+-200, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect159 = new ColorfulRectangle(movex+850,movey+-200, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect160 = new ColorfulRectangle(movex+900,movey+-200, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect161 = new ColorfulRectangle(movex+950,movey+-200, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect162 = new ColorfulRectangle(movex+750,movey+-200, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect163 = new ColorfulRectangle(movex+750,movey+-50, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect164 = new ColorfulRectangle(movex+700,movey+-50, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect165 = new ColorfulRectangle(movex+650,movey+-50, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect166 = new ColorfulRectangle(movex+1150,movey+-150, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect167 = new ColorfulRectangle(movex+1150,movey+-200, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect168 = new ColorfulRectangle(movex+1150,movey+-250, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect169 = new ColorfulRectangle(movex+1200,movey+-250, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect170 = new ColorfulRectangle(movex+1150,movey+-300, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect171 = new ColorfulRectangle(movex+1200,movey+-300, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect172 = new ColorfulRectangle(movex+1250,movey+-250, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect173 = new ColorfulRectangle(movex+1300,movey+-250, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect174 = new ColorfulRectangle(movex+550,movey+-700, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect175 = new ColorfulRectangle(movex+500,movey+-700, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect176 = new ColorfulRectangle(movex+500,movey+-650, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect177 = new ColorfulRectangle(movex+450,movey+-650, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect178 = new ColorfulRectangle(movex+450,movey+-600, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect179 = new ColorfulRectangle(movex+650,movey+-700, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect180 = new ColorfulRectangle(movex+700,movey+-700, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect181 = new ColorfulRectangle(movex+700,movey+-750, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect182 = new ColorfulRectangle(movex+750,movey+-750, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect183 = new ColorfulRectangle(movex+800,movey+-750, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect184 = new ColorfulRectangle(movex+800,movey+-700, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect185 = new ColorfulRectangle(movex+850,movey+-700, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect186 = new ColorfulRectangle(movex+850,movey+-650, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect187 = new ColorfulRectangle(movex+850,movey+-600, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect188 = new ColorfulRectangle(movex+900,movey+-600, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect189 = new ColorfulRectangle(movex+900,movey+-650, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect190 = new ColorfulRectangle(movex+950,movey+-650, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect191 = new ColorfulRectangle(movex+950,movey+-700, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect192 = new ColorfulRectangle(movex+-250,movey+250, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect193 = new ColorfulRectangle(movex+1050,movey+-700, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect194 = new ColorfulRectangle(movex+1200,movey+-650, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect195 = new ColorfulRectangle(movex+1150,movey+-700, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect196 = new ColorfulRectangle(movex+1200,movey+-700, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect197 = new ColorfulRectangle(movex+1250,movey+-700, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect198 = new ColorfulRectangle(movex+1300,movey+-700, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect199 = new ColorfulRectangle(movex+1300,movey+-750, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect200 = new ColorfulRectangle(movex+1350,movey+-750, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect201 = new ColorfulRectangle(movex+1400,movey+-750, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect202 = new ColorfulRectangle(movex+1400,movey+-800, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect203 = new ColorfulRectangle(movex+1350,movey+-800, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect204 = new ColorfulRectangle(movex+1450,movey+-800, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect205 = new ColorfulRectangle(movex+1200,movey+-550, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect206 = new ColorfulRectangle(movex+1050,movey+-500, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect207 = new ColorfulRectangle(movex+1200,movey+-500, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect208 = new ColorfulRectangle(movex+1200,movey+-550, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect209 = new ColorfulRectangle(movex+1300,movey+-550, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect210 = new ColorfulRectangle(movex+1300,movey+-500, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect211 = new ColorfulRectangle(movex+1350,movey+-500, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect212 = new ColorfulRectangle(movex+1350,movey+-450, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect213 = new ColorfulRectangle(movex+1350,movey+-400, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect214 = new ColorfulRectangle(movex+1700,movey+-650, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect215 = new ColorfulRectangle(movex+1650,movey+-650, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect216 = new ColorfulRectangle(movex+1750,movey+-600, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect217 = new ColorfulRectangle(movex+1800,movey+-600, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect218 = new ColorfulRectangle(movex+1800,movey+-550, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect219 = new ColorfulRectangle(movex+1850,movey+-1200, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect220 = new ColorfulRectangle(movex+1800,movey+-1200, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect221 = new ColorfulRectangle(movex+1850,movey+-2000, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect222 = new ColorfulRectangle(movex+1850,movey+-950, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect223 = new ColorfulRectangle(movex+1800,movey+-950, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect224 = new ColorfulRectangle(movex+1750,movey+-950, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect225 = new ColorfulRectangle(movex+1750,movey+-900, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect226 = new ColorfulRectangle(movex+1800,movey+-900, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect227 = new ColorfulRectangle(movex+1700,movey+-900, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect228 = new ColorfulRectangle(movex+1700,movey+-850, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect229 = new ColorfulRectangle(movex+950,movey+-950, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect230 = new ColorfulRectangle(movex+950,movey+-2000, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect231 = new ColorfulRectangle(movex+950,movey+-1050, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect232 = new ColorfulRectangle(movex+900,movey+-1050, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect233 = new ColorfulRectangle(movex+900,movey+-2000, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect234 = new ColorfulRectangle(movex+850,movey+-1050, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect235 = new ColorfulRectangle(movex+-250,movey+300, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect236 = new ColorfulRectangle(movex+-250,movey+350, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect237 = new ColorfulRectangle(movex+0,movey+-300, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect238 = new ColorfulRectangle(movex+400,movey+0, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect239 = new ColorfulRectangle(movex+550,movey+0, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect240 = new ColorfulRectangle(movex+450,movey+-200, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect241 = new ColorfulRectangle(movex+1200,movey+-150, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect242 = new ColorfulRectangle(movex+-1150,movey+-450, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect243 = new ColorfulRectangle(movex+1050,movey+-200, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect244 = new ColorfulRectangle(movex+1200,movey+-250, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect245 = new ColorfulRectangle(movex+-750,movey+1000, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect246 = new ColorfulRectangle(movex+-700,movey+1000, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect247 = new ColorfulRectangle(movex+-650,movey+1000, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect248 = new ColorfulRectangle(movex+-650,movey+1050, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect249 = new ColorfulRectangle(movex+-650,movey+1100, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect250 = new ColorfulRectangle(movex+-600,movey+1100, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect251 = new ColorfulRectangle(movex+-600,movey+1050, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect252 = new ColorfulRectangle(movex+-550,movey+1100, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect253 = new ColorfulRectangle(movex+-550,movey+1150, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect254 = new ColorfulRectangle(movex+-500,movey+1150, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect255 = new ColorfulRectangle(movex+-500,movey+1100, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect256 = new ColorfulRectangle(movex+-550,movey+1050, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect257 = new ColorfulRectangle(movex+-700,movey+950, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect258 = new ColorfulRectangle(movex+-700,movey+1050, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect259 = new ColorfulRectangle(movex+-950,movey+550, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect260 = new ColorfulRectangle(movex+-950,movey+600, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect261 = new ColorfulRectangle(movex+-950,movey+650, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect262 = new ColorfulRectangle(movex+-950,movey+700, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect263 = new ColorfulRectangle(movex+-950,movey+750, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect264 = new ColorfulRectangle(movex+-950,movey+800, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect265 = new ColorfulRectangle(movex+-900,movey+800, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect266 = new ColorfulRectangle(movex+-900,movey+750, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect267 = new ColorfulRectangle(movex+-1000,movey+700, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect268 = new ColorfulRectangle(movex+-1000,movey+650, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect269 = new ColorfulRectangle(movex+-1000,movey+600, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect270 = new ColorfulRectangle(movex+-1000,movey+550, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect271 = new ColorfulRectangle(movex+-1050,movey+550, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect272 = new ColorfulRectangle(movex+-1050,movey+500, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect273 = new ColorfulRectangle(movex+-1000,movey+500, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect274 = new ColorfulRectangle(movex+-1100,movey+500, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect275 = new ColorfulRectangle(movex+-1100,movey+450, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect276 = new ColorfulRectangle(movex+-1050,movey+450, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect277 = new ColorfulRectangle(movex+-850,movey+300, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect278 = new ColorfulRectangle(movex+-800,movey+300, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect279 = new ColorfulRectangle(movex+-800,movey+250, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect280 = new ColorfulRectangle(movex+-750,movey+250, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect281 = new ColorfulRectangle(movex+-750,movey+200, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect282 = new ColorfulRectangle(movex+-700,movey+200, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect283 = new ColorfulRectangle(movex+-650,movey+200, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect284 = new ColorfulRectangle(movex+-650,movey+150, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect285 = new ColorfulRectangle(movex+-650,movey+100, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect286 = new ColorfulRectangle(movex+-650,movey+50, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect287 = new ColorfulRectangle(movex+-1100,movey+100, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect288 = new ColorfulRectangle(movex+-1100,movey+50, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect289 = new ColorfulRectangle(movex+-1150,movey+50, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect290 = new ColorfulRectangle(movex+-1150,movey+0, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect291 = new ColorfulRectangle(movex+-1200,movey+0, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect292 = new ColorfulRectangle(movex+-1150,movey+-50, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect293 = new ColorfulRectangle(movex+-1200,movey+-50, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect294 = new ColorfulRectangle(movex+-1250,movey+-50, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect295 = new ColorfulRectangle(movex+-1250,movey+-100, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect296 = new ColorfulRectangle(movex+-1300,movey+-100, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect297 = new ColorfulRectangle(movex+-1300,movey+-150, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect298 = new ColorfulRectangle(movex+-1300,movey+-200, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect299 = new ColorfulRectangle(movex+-1300,movey+-250, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect300 = new ColorfulRectangle(movex+-1350,movey+-250, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect301 = new ColorfulRectangle(movex+-1400,movey+-250, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect302 = new ColorfulRectangle(movex+-1400,movey+-300, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect303 = new ColorfulRectangle(movex+-1550,movey+-700, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect304 = new ColorfulRectangle(movex+-1550,movey+-650, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect305 = new ColorfulRectangle(movex+-1600,movey+-650, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect306 = new ColorfulRectangle(movex+-1600,movey+-600, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect307 = new ColorfulRectangle(movex+-1600,movey+-550, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect308 = new ColorfulRectangle(movex+-1550,movey+-550, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect309 = new ColorfulRectangle(movex+-1500,movey+-550, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect310 = new ColorfulRectangle(movex+-1500,movey+-500, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect311 = new ColorfulRectangle(movex+-1500,movey+-450, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect312 = new ColorfulRectangle(movex+-1550,movey+-450, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect313 = new ColorfulRectangle(movex+-1450,movey+-450, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect314 = new ColorfulRectangle(movex+-1600,movey+-550, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect315 = new ColorfulRectangle(movex+-1600,movey+-400, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect316 = new ColorfulRectangle(movex+-1550,movey+-400, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect317 = new ColorfulRectangle(movex+-800,movey+950, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect318 = new ColorfulRectangle(movex+-1200,movey+50, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect319 = new ColorfulRectangle(movex+-1250,movey+50, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect320 = new ColorfulRectangle(movex+-1300,movey+50, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect321 = new ColorfulRectangle(movex+-1300,movey+100, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect322 = new ColorfulRectangle(movex+-1350,movey+100, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect323 = new ColorfulRectangle(movex+-1350,movey+150, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect324 = new ColorfulRectangle(movex+-150,movey+550, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect325 = new ColorfulRectangle(movex+-250,movey+250, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect326 = new ColorfulRectangle(movex+-600,movey+-100, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect327 = new ColorfulRectangle(movex+-300,movey+-750, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect328 = new ColorfulRectangle(movex+-250,movey+-750, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect329 = new ColorfulRectangle(movex+-200,movey+-750, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect330 = new ColorfulRectangle(movex+-250,movey+-700, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect331 = new ColorfulRectangle(movex+-250,movey+-650, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect332 = new ColorfulRectangle(movex+-500,movey+-550, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect333 = new ColorfulRectangle(movex+-550,movey+-550, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect334 = new ColorfulRectangle(movex+-600,movey+-550, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect335 = new ColorfulRectangle(movex+-600,movey+-500, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect336 = new ColorfulRectangle(movex+-50,movey+600, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect337 = new ColorfulRectangle(movex+-250,movey+100, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect338 = new ColorfulRectangle(movex+-950,movey+-550, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect339 = new ColorfulRectangle(movex+-900,movey+-550, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect340 = new ColorfulRectangle(movex+-900,movey+-500, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect341 = new ColorfulRectangle(movex+-850,movey+-500, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect342 = new ColorfulRectangle(movex+-850,movey+-450, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect343 = new ColorfulRectangle(movex+-800,movey+-450, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect344 = new ColorfulRectangle(movex+-800,movey+-400, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect345 = new ColorfulRectangle(movex+-850,movey+-350, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect346 = new ColorfulRectangle(movex+-850,movey+-300, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect347 = new ColorfulRectangle(movex+-800,movey+-300, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect348 = new ColorfulRectangle(movex+-800,movey+-350, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect349 = new ColorfulRectangle(movex+-300,movey+-700, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect350 = new ColorfulRectangle(movex+-50,movey+-800, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect351 = new ColorfulRectangle(movex+-50,movey+-850, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect352 = new ColorfulRectangle(movex+-100,movey+-850, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect353 = new ColorfulRectangle(movex+-50,movey+-900, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect354 = new ColorfulRectangle(movex+-500,movey+-500, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect355 = new ColorfulRectangle(movex+-450,movey+-500, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect356 = new ColorfulRectangle(movex+-400,movey+-600, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect357 = new ColorfulRectangle(movex+-550,movey+-500, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect358 = new ColorfulRectangle(movex+-750,movey+-850, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect359 = new ColorfulRectangle(movex+-750,movey+-800, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect360 = new ColorfulRectangle(movex+-800,movey+-800, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect361 = new ColorfulRectangle(movex+-850,movey+-800, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect362 = new ColorfulRectangle(movex+-900,movey+-800, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect363 = new ColorfulRectangle(movex+-800,movey+-850, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect364 = new ColorfulRectangle(movex+-300,movey+-800, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect365 = new ColorfulRectangle(movex+-300,movey+-850, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect366 = new ColorfulRectangle(movex+0,movey+-900, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect367 = new ColorfulRectangle(movex+-800,movey+1000, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect368 = new ColorfulRectangle(movex+-850,movey+1000, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect369 = new ColorfulRectangle(movex+-850,movey+950, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect370 = new ColorfulRectangle(movex+-850,movey+900, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect371 = new ColorfulRectangle(movex+-850,movey+850, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect372 = new ColorfulRectangle(movex+-900,movey+850, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect373 = new ColorfulRectangle(movex+-1050,movey+700, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect374 = new ColorfulRectangle(movex+-1100,movey+700, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect375 = new ColorfulRectangle(movex+-1100,movey+650, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect376 = new ColorfulRectangle(movex+-1050,movey+400, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect377 = new ColorfulRectangle(movex+-1050,movey+350, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect378 = new ColorfulRectangle(movex+-1050,movey+300, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect379 = new ColorfulRectangle(movex+-1000,movey+300, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect380 = new ColorfulRectangle(movex+-1000,movey+250, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect381 = new ColorfulRectangle(movex+1400,movey+-300, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect382 = new ColorfulRectangle(movex+-950,movey+250, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect383 = new ColorfulRectangle(movex+-900,movey+250, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect384 = new ColorfulRectangle(movex+-900,movey+300, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect385 = new ColorfulRectangle(movex+-600,movey+150, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect386 = new ColorfulRectangle(movex+-550,movey+150, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect387 = new ColorfulRectangle(movex+-500,movey+150, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect388 = new ColorfulRectangle(movex+-450,movey+150, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect389 = new ColorfulRectangle(movex+-450,movey+200, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect390 = new ColorfulRectangle(movex+-750,movey+150, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect391 = new ColorfulRectangle(movex+-750,movey+100, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect392 = new ColorfulRectangle(movex+-800,movey+100, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect393 = new ColorfulRectangle(movex+-850,movey+100, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect394 = new ColorfulRectangle(movex+-850,movey+50, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect395 = new ColorfulRectangle(movex+-1350,movey+-200, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect396 = new ColorfulRectangle(movex+-1300,movey+-300, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect397 = new ColorfulRectangle(movex+-1350,movey+-400, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect398 = new ColorfulRectangle(movex+-1350,movey+-450, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect399 = new ColorfulRectangle(movex+-1400,movey+-450, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect400 = new ColorfulRectangle(movex+-1150,movey+-850, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect401 = new ColorfulRectangle(movex+-1150,movey+-900, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect402 = new ColorfulRectangle(movex+-1200,movey+-900, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect403 = new ColorfulRectangle(movex+-1250,movey+-900, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect404 = new ColorfulRectangle(movex+-1300,movey+-900, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect405 = new ColorfulRectangle(movex+-1350,movey+-900, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect406 = new ColorfulRectangle(movex+-1350,movey+-950, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect407 = new ColorfulRectangle(movex+-1300,movey+-950, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect408 = new ColorfulRectangle(movex+-1200,movey+-850, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect409 = new ColorfulRectangle(movex+-1400,movey+-900, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect410 = new ColorfulRectangle(movex+-1450,movey+-900, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect411 = new ColorfulRectangle(movex+-1500,movey+-950, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect412 = new ColorfulRectangle(movex+-1500,movey+-900, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect413 = new ColorfulRectangle(movex+-1450,movey+-850, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect414 = new ColorfulRectangle(movex+-1450,movey+-800, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect415 = new ColorfulRectangle(movex+-1450,movey+-750, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect416 = new ColorfulRectangle(movex+-1500,movey+-750, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect417 = new ColorfulRectangle(movex+-1550,movey+-750, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect418 = new ColorfulRectangle(movex+-250,movey+-450, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect419 = new ColorfulRectangle(movex+-250,movey+-400, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect420 = new ColorfulRectangle(movex+-300,movey+-400, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect421 = new ColorfulRectangle(movex+-300,movey+-350, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect422 = new ColorfulRectangle(movex+-350,movey+-350, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect423 = new ColorfulRectangle(movex+-300,movey+-500, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect424 = new ColorfulRectangle(movex+-250,movey+-500, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect425 = new ColorfulRectangle(movex+-700,movey+-1050, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect426 = new ColorfulRectangle(movex+-750,movey+-1050, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect427 = new ColorfulRectangle(movex+-750,movey+-1100, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect428 = new ColorfulRectangle(movex+-750,movey+-1150, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect429 = new ColorfulRectangle(movex+-750,movey+-1200, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect430 = new ColorfulRectangle(movex+-800,movey+-1200, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect431 = new ColorfulRectangle(movex+-800,movey+-1250, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect432 = new ColorfulRectangle(movex+-800,movey+-1300, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect433 = new ColorfulRectangle(movex+-850,movey+-1300, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect434 = new ColorfulRectangle(movex+-850,movey+-1350, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect435 = new ColorfulRectangle(movex+-900,movey+-1400, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect436 = new ColorfulRectangle(movex+-850,movey+-1400, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect437 = new ColorfulRectangle(movex+-100,movey+-650, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect438 = new ColorfulRectangle(movex+-100,movey+-600, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect439 = new ColorfulRectangle(movex+-100,movey+-550, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect440 = new ColorfulRectangle(movex+-100,movey+-500, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect441 = new ColorfulRectangle(movex+-50,movey+-500, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect442 = new ColorfulRectangle(movex+550,movey+250, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect443 = new ColorfulRectangle(movex+450,movey+250, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect444 = new ColorfulRectangle(movex+500,movey+250, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect445 = new ColorfulRectangle(movex+450,movey+200, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect446 = new ColorfulRectangle(movex+400,movey+200, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect447 = new ColorfulRectangle(movex+350,movey+200, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect448 = new ColorfulRectangle(movex+300,movey+200, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect449 = new ColorfulRectangle(movex+300,movey+150, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect450 = new ColorfulRectangle(movex+300,movey+100, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect451 = new ColorfulRectangle(movex+400,movey+150, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect452 = new ColorfulRectangle(movex+400,movey+100, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect453 = new ColorfulRectangle(movex+450,movey+100, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect454 = new ColorfulRectangle(movex+500,movey+100, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect455 = new ColorfulRectangle(movex+250,movey+100, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect456 = new ColorfulRectangle(movex+250,movey+50, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect457 = new ColorfulRectangle(movex+250,movey+0, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect458 = new ColorfulRectangle(movex+250,movey+-50, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect459 = new ColorfulRectangle(movex+200,movey+-50, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect460 = new ColorfulRectangle(movex+200,movey+-100, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect461 = new ColorfulRectangle(movex+200,movey+-150, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect462 = new ColorfulRectangle(movex+150,movey+-150, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect463 = new ColorfulRectangle(movex+150,movey+-200, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect464 = new ColorfulRectangle(movex+200,movey+0, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect465 = new ColorfulRectangle(movex+200,movey+50, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect466 = new ColorfulRectangle(movex+150,movey+50, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect467 = new ColorfulRectangle(movex+150,movey+100, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect468 = new ColorfulRectangle(movex+300,movey+0, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect469 = new ColorfulRectangle(movex+250,movey+-150, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect470 = new ColorfulRectangle(movex+250,movey+-200, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect471 = new ColorfulRectangle(movex+900,movey+-50, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect472 = new ColorfulRectangle(movex+900,movey+0, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect473 = new ColorfulRectangle(movex+900,movey+50, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect474 = new ColorfulRectangle(movex+950,movey+50, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect475 = new ColorfulRectangle(movex+950,movey+100, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect476 = new ColorfulRectangle(movex+1000,movey+50, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect477 = new ColorfulRectangle(movex+1100,movey+-100, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect478 = new ColorfulRectangle(movex+1050,movey+-50, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect479 = new ColorfulRectangle(movex+1100,movey+-50, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect480 = new ColorfulRectangle(movex+1250,movey+-200, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect481 = new ColorfulRectangle(movex+1800,movey+-350, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect482 = new ColorfulRectangle(movex+1800,movey+-300, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect483 = new ColorfulRectangle(movex+1750,movey+-300, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect484 = new ColorfulRectangle(movex+1700,movey+-300, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect485 = new ColorfulRectangle(movex+1650,movey+-300, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect486 = new ColorfulRectangle(movex+1650,movey+-250, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect487 = new ColorfulRectangle(movex+1600,movey+-250, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect488 = new ColorfulRectangle(movex+1550,movey+-250, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect489 = new ColorfulRectangle(movex+1500,movey+-250, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect490 = new ColorfulRectangle(movex+1500,movey+-200, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect491 = new ColorfulRectangle(movex+1450,movey+-200, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect492 = new ColorfulRectangle(movex+1400,movey+-200, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect493 = new ColorfulRectangle(movex+1400,movey+-250, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect494 = new ColorfulRectangle(movex+1350,movey+-250, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect495 = new ColorfulRectangle(movex+950,movey+-1100, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect496 = new ColorfulRectangle(movex+950,movey+-1150, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect497 = new ColorfulRectangle(movex+900,movey+-1150, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect498 = new ColorfulRectangle(movex+850,movey+-1150, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect499 = new ColorfulRectangle(movex+-1400,movey+-350, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect500 = new ColorfulRectangle(movex+-1400,movey+-400, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect501 = new ColorfulRectangle(movex+-350,movey+-1300, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect502 = new ColorfulRectangle(movex+-300,movey+-1300, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect503 = new ColorfulRectangle(movex+-250,movey+-1300, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect504 = new ColorfulRectangle(movex+-250,movey+-1350, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect505 = new ColorfulRectangle(movex+-200,movey+-1350, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect506 = new ColorfulRectangle(movex+-100,movey+-1350, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect507 = new ColorfulRectangle(movex+-150,movey+-1350, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect508 = new ColorfulRectangle(movex+-50,movey+-1350, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect509 = new ColorfulRectangle(movex+-50,movey+-1400, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect510 = new ColorfulRectangle(movex+0,movey+-1400, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect511 = new ColorfulRectangle(movex+50,movey+-1400, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect512 = new ColorfulRectangle(movex+350,movey+-900, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect513 = new ColorfulRectangle(movex+400,movey+-900, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect514 = new ColorfulRectangle(movex+400,movey+-850, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect515 = new ColorfulRectangle(movex+450,movey+-850, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect516 = new ColorfulRectangle(movex+500,movey+-850, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect517 = new ColorfulRectangle(movex+500,movey+-800, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect518 = new ColorfulRectangle(movex+500,movey+-750, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect519 = new ColorfulRectangle(movex+1350,movey+-350, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect520 = new ColorfulRectangle(movex+1350,movey+-300, 50, 50, Color.MAGENTA, grayYellow);
		buildings2ChangeColorRect521 = new ColorfulRectangle(movex+1400,movey+-350, 50, 50, Color.MAGENTA, grayYellow);
		...
		if(endingBlockSwitch<10) {
			...
			buildings2ChangeColorRect1.col = Color.PINK;  buildings2ChangeColorRect1.grayCol = grayBlue;
			buildings2ChangeColorRect2.col = Color.PINK;  buildings2ChangeColorRect2.grayCol = grayBlue;
			buildings2ChangeColorRect3.col = Color.PINK;  buildings2ChangeColorRect3.grayCol = grayBlue;
			buildings2ChangeColorRect4.col = Color.PINK;  buildings2ChangeColorRect4.grayCol = grayBlue;
			buildings2ChangeColorRect5.col = Color.PINK;  buildings2ChangeColorRect5.grayCol = grayBlue;
			buildings2ChangeColorRect6.col = Color.PINK;  buildings2ChangeColorRect6.grayCol = grayBlue;
			buildings2ChangeColorRect7.col = Color.PINK;  buildings2ChangeColorRect7.grayCol = grayBlue;
			buildings2ChangeColorRect8.col = Color.PINK;  buildings2ChangeColorRect8.grayCol = grayBlue;
			buildings2ChangeColorRect9.col = Color.PINK;  buildings2ChangeColorRect9.grayCol = grayBlue;
			buildings2ChangeColorRect10.col = Color.PINK;  buildings2ChangeColorRect10.grayCol = grayBlue;
			buildings2ChangeColorRect11.col = Color.PINK;  buildings2ChangeColorRect11.grayCol = grayBlue;
			buildings2ChangeColorRect12.col = Color.PINK;  buildings2ChangeColorRect12.grayCol = grayBlue;
			buildings2ChangeColorRect13.col = Color.PINK;  buildings2ChangeColorRect13.grayCol = grayBlue;
			buildings2ChangeColorRect14.col = Color.PINK;  buildings2ChangeColorRect14.grayCol = grayBlue;
			buildings2ChangeColorRect15.col = Color.PINK;  buildings2ChangeColorRect15.grayCol = grayBlue;
			buildings2ChangeColorRect16.col = Color.PINK;  buildings2ChangeColorRect16.grayCol = grayBlue;
			buildings2ChangeColorRect17.col = Color.PINK;  buildings2ChangeColorRect17.grayCol = grayBlue;
			buildings2ChangeColorRect18.col = Color.PINK;  buildings2ChangeColorRect18.grayCol = grayBlue;
			buildings2ChangeColorRect19.col = Color.PINK;  buildings2ChangeColorRect19.grayCol = grayBlue;
			buildings2ChangeColorRect20.col = Color.PINK;  buildings2ChangeColorRect20.grayCol = grayBlue;
			buildings2ChangeColorRect21.col = Color.PINK;  buildings2ChangeColorRect21.grayCol = grayBlue;
			buildings2ChangeColorRect22.col = Color.PINK;  buildings2ChangeColorRect22.grayCol = grayBlue;
			buildings2ChangeColorRect23.col = Color.PINK;  buildings2ChangeColorRect23.grayCol = grayBlue;
			buildings2ChangeColorRect24.col = Color.PINK;  buildings2ChangeColorRect24.grayCol = grayBlue;
			buildings2ChangeColorRect25.col = Color.PINK;  buildings2ChangeColorRect25.grayCol = grayBlue;
			buildings2ChangeColorRect26.col = Color.PINK;  buildings2ChangeColorRect26.grayCol = grayBlue;
			buildings2ChangeColorRect27.col = Color.PINK;  buildings2ChangeColorRect27.grayCol = grayBlue;
			buildings2ChangeColorRect28.col = Color.PINK;  buildings2ChangeColorRect28.grayCol = grayBlue;
			buildings2ChangeColorRect29.col = Color.PINK;  buildings2ChangeColorRect29.grayCol = grayBlue;
			buildings2ChangeColorRect30.col = Color.PINK;  buildings2ChangeColorRect30.grayCol = grayBlue;
			buildings2ChangeColorRect31.col = Color.PINK;  buildings2ChangeColorRect31.grayCol = grayBlue;
			buildings2ChangeColorRect32.col = Color.PINK;  buildings2ChangeColorRect32.grayCol = grayBlue;
			buildings2ChangeColorRect33.col = Color.PINK;  buildings2ChangeColorRect33.grayCol = grayBlue;
			buildings2ChangeColorRect34.col = Color.PINK;  buildings2ChangeColorRect34.grayCol = grayBlue;
			buildings2ChangeColorRect35.col = Color.PINK;  buildings2ChangeColorRect35.grayCol = grayBlue;
			buildings2ChangeColorRect36.col = Color.PINK;  buildings2ChangeColorRect36.grayCol = grayBlue;
			buildings2ChangeColorRect37.col = Color.PINK;  buildings2ChangeColorRect37.grayCol = grayBlue;
			buildings2ChangeColorRect38.col = Color.PINK;  buildings2ChangeColorRect38.grayCol = grayBlue;
			buildings2ChangeColorRect39.col = Color.PINK;  buildings2ChangeColorRect39.grayCol = grayBlue;
			buildings2ChangeColorRect40.col = Color.PINK;  buildings2ChangeColorRect40.grayCol = grayBlue;
			buildings2ChangeColorRect41.col = Color.PINK;  buildings2ChangeColorRect41.grayCol = grayBlue;
			buildings2ChangeColorRect42.col = Color.PINK;  buildings2ChangeColorRect42.grayCol = grayBlue;
			buildings2ChangeColorRect43.col = Color.PINK;  buildings2ChangeColorRect43.grayCol = grayBlue;
			buildings2ChangeColorRect44.col = Color.PINK;  buildings2ChangeColorRect44.grayCol = grayBlue;
			buildings2ChangeColorRect45.col = Color.PINK;  buildings2ChangeColorRect45.grayCol = grayBlue;
			buildings2ChangeColorRect46.col = Color.PINK;  buildings2ChangeColorRect46.grayCol = grayBlue;
			buildings2ChangeColorRect47.col = Color.PINK;  buildings2ChangeColorRect47.grayCol = grayBlue;
			buildings2ChangeColorRect48.col = Color.PINK;  buildings2ChangeColorRect48.grayCol = grayBlue;
			buildings2ChangeColorRect49.col = Color.PINK;  buildings2ChangeColorRect49.grayCol = grayBlue;
			buildings2ChangeColorRect50.col = Color.PINK;  buildings2ChangeColorRect50.grayCol = grayBlue;
			buildings2ChangeColorRect51.col = Color.PINK;  buildings2ChangeColorRect51.grayCol = grayBlue;
			buildings2ChangeColorRect52.col = Color.PINK;  buildings2ChangeColorRect52.grayCol = grayBlue;
			buildings2ChangeColorRect53.col = Color.PINK;  buildings2ChangeColorRect53.grayCol = grayBlue;
			buildings2ChangeColorRect53a.col = Color.PINK; buildings2ChangeColorRect53a.grayCol = grayBlue;
			buildings2ChangeColorRect54.col = Color.PINK;  buildings2ChangeColorRect54.grayCol = grayBlue;
			buildings2ChangeColorRect55.col = Color.PINK;  buildings2ChangeColorRect55.grayCol = grayBlue;
			buildings2ChangeColorRect56.col = Color.PINK;  buildings2ChangeColorRect56.grayCol = grayBlue;
			buildings2ChangeColorRect57.col = Color.PINK;  buildings2ChangeColorRect57.grayCol = grayBlue;
			buildings2ChangeColorRect58.col = Color.PINK;  buildings2ChangeColorRect58.grayCol = grayBlue;
			buildings2ChangeColorRect59.col = Color.PINK;  buildings2ChangeColorRect59.grayCol = grayBlue;
			buildings2ChangeColorRect60.col = Color.PINK;  buildings2ChangeColorRect60.grayCol = grayBlue;
			buildings2ChangeColorRect61.col = Color.PINK;  buildings2ChangeColorRect61.grayCol = grayBlue;
			buildings2ChangeColorRect62.col = Color.PINK;  buildings2ChangeColorRect62.grayCol = grayBlue;
			buildings2ChangeColorRect63.col = Color.PINK;  buildings2ChangeColorRect63.grayCol = grayBlue;
			buildings2ChangeColorRect64.col = Color.PINK;  buildings2ChangeColorRect64.grayCol = grayBlue;
			buildings2ChangeColorRect65.col = Color.PINK;  buildings2ChangeColorRect65.grayCol = grayBlue;
			buildings2ChangeColorRect66.col = Color.PINK;  buildings2ChangeColorRect66.grayCol = grayBlue;
			buildings2ChangeColorRect67.col = Color.PINK;  buildings2ChangeColorRect67.grayCol = grayBlue;
			buildings2ChangeColorRect68.col = Color.PINK;  buildings2ChangeColorRect68.grayCol = grayBlue;
			buildings2ChangeColorRect69.col = Color.PINK;  buildings2ChangeColorRect69.grayCol = grayBlue;
			buildings2ChangeColorRect70.col = Color.PINK;  buildings2ChangeColorRect70.grayCol = grayBlue;
			buildings2ChangeColorRect71.col = Color.PINK;  buildings2ChangeColorRect71.grayCol = grayBlue;
			buildings2ChangeColorRect72.col = Color.PINK;  buildings2ChangeColorRect72.grayCol = grayBlue;
			buildings2ChangeColorRect73.col = Color.PINK;  buildings2ChangeColorRect73.grayCol = grayBlue;
			buildings2ChangeColorRect74.col = Color.PINK;  buildings2ChangeColorRect74.grayCol = grayBlue;
			buildings2ChangeColorRect75.col = Color.PINK;  buildings2ChangeColorRect75.grayCol = grayBlue;
			buildings2ChangeColorRect76.col = Color.PINK;  buildings2ChangeColorRect76.grayCol = grayBlue;
			buildings2ChangeColorRect77.col = Color.PINK;  buildings2ChangeColorRect77.grayCol = grayBlue;
			buildings2ChangeColorRect78.col = Color.PINK;  buildings2ChangeColorRect78.grayCol = grayBlue;
			buildings2ChangeColorRect79.col = Color.PINK;  buildings2ChangeColorRect79.grayCol = grayBlue;
			buildings2ChangeColorRect80.col = Color.PINK;  buildings2ChangeColorRect80.grayCol = grayBlue;
			buildings2ChangeColorRect81.col = Color.PINK;  buildings2ChangeColorRect81.grayCol = grayBlue;
			buildings2ChangeColorRect82.col = Color.PINK;  buildings2ChangeColorRect82.grayCol = grayBlue;
			buildings2ChangeColorRect83.col = Color.PINK;  buildings2ChangeColorRect83.grayCol = grayBlue;
			buildings2ChangeColorRect84.col = Color.PINK;  buildings2ChangeColorRect84.grayCol = grayBlue;
			buildings2ChangeColorRect85.col = Color.PINK;  buildings2ChangeColorRect85.grayCol = grayBlue;
			buildings2ChangeColorRect86.col = Color.PINK;  buildings2ChangeColorRect86.grayCol = grayBlue;
			buildings2ChangeColorRect87.col = Color.PINK;  buildings2ChangeColorRect87.grayCol = grayBlue;
			buildings2ChangeColorRect88.col = Color.PINK;  buildings2ChangeColorRect88.grayCol = grayBlue;
			buildings2ChangeColorRect89.col = Color.PINK;  buildings2ChangeColorRect89.grayCol = grayBlue;
			buildings2ChangeColorRect90.col = Color.PINK;  buildings2ChangeColorRect90.grayCol = grayBlue;
			buildings2ChangeColorRect91.col = Color.PINK;  buildings2ChangeColorRect91.grayCol = grayBlue;
			buildings2ChangeColorRect92.col = Color.PINK;  buildings2ChangeColorRect92.grayCol = grayBlue;
			buildings2ChangeColorRect93.col = Color.PINK;  buildings2ChangeColorRect93.grayCol = grayBlue;
			buildings2ChangeColorRect94.col = Color.PINK;  buildings2ChangeColorRect94.grayCol = grayBlue;
			buildings2ChangeColorRect95.col = Color.PINK;  buildings2ChangeColorRect95.grayCol = grayBlue;
			buildings2ChangeColorRect96.col = Color.PINK;  buildings2ChangeColorRect96.grayCol = grayBlue;
			buildings2ChangeColorRect97.col = Color.PINK;  buildings2ChangeColorRect97.grayCol = grayBlue;
			buildings2ChangeColorRect98.col = Color.PINK;  buildings2ChangeColorRect98.grayCol = grayBlue;
			buildings2ChangeColorRect99.col = Color.PINK;  buildings2ChangeColorRect99.grayCol = grayBlue;
			buildings2ChangeColorRect100.col = Color.PINK;  buildings2ChangeColorRect100.grayCol = grayBlue;
			buildings2ChangeColorRect101.col = Color.PINK;  buildings2ChangeColorRect101.grayCol = grayBlue;
			buildings2ChangeColorRect102.col = Color.PINK;  buildings2ChangeColorRect102.grayCol = grayBlue;
			buildings2ChangeColorRect103.col = Color.PINK;  buildings2ChangeColorRect103.grayCol = grayBlue;
			buildings2ChangeColorRect104.col = Color.PINK;  buildings2ChangeColorRect104.grayCol = grayBlue;
			buildings2ChangeColorRect105.col = Color.PINK;  buildings2ChangeColorRect105.grayCol = grayBlue;
			buildings2ChangeColorRect106.col = Color.PINK;  buildings2ChangeColorRect106.grayCol = grayBlue;
			buildings2ChangeColorRect107.col = Color.PINK;  buildings2ChangeColorRect107.grayCol = grayBlue;
			buildings2ChangeColorRect108.col = Color.PINK;  buildings2ChangeColorRect108.grayCol = grayBlue;
			buildings2ChangeColorRect109.col = Color.PINK;  buildings2ChangeColorRect109.grayCol = grayBlue;
			buildings2ChangeColorRect110.col = Color.PINK;  buildings2ChangeColorRect110.grayCol = grayBlue;
			buildings2ChangeColorRect111.col = Color.PINK;  buildings2ChangeColorRect111.grayCol = grayBlue;
			buildings2ChangeColorRect112.col = Color.PINK;  buildings2ChangeColorRect112.grayCol = grayBlue;
			buildings2ChangeColorRect113.col = Color.PINK;  buildings2ChangeColorRect113.grayCol = grayBlue;
			buildings2ChangeColorRect114.col = Color.PINK;  buildings2ChangeColorRect114.grayCol = grayBlue;
			buildings2ChangeColorRect115.col = Color.PINK;  buildings2ChangeColorRect115.grayCol = grayBlue;
			buildings2ChangeColorRect116.col = Color.PINK;  buildings2ChangeColorRect116.grayCol = grayBlue;
			buildings2ChangeColorRect117.col = Color.PINK;  buildings2ChangeColorRect117.grayCol = grayBlue;
			buildings2ChangeColorRect118.col = Color.PINK;  buildings2ChangeColorRect118.grayCol = grayBlue;
			buildings2ChangeColorRect119.col = Color.PINK;  buildings2ChangeColorRect119.grayCol = grayBlue;
			buildings2ChangeColorRect120.col = Color.PINK;  buildings2ChangeColorRect120.grayCol = grayBlue;
			buildings2ChangeColorRect121.col = Color.PINK;  buildings2ChangeColorRect121.grayCol = grayBlue;
			buildings2ChangeColorRect122.col = Color.PINK;  buildings2ChangeColorRect122.grayCol = grayBlue;
			buildings2ChangeColorRect123.col = Color.PINK;  buildings2ChangeColorRect123.grayCol = grayBlue;
			buildings2ChangeColorRect124.col = Color.PINK;  buildings2ChangeColorRect124.grayCol = grayBlue;
			buildings2ChangeColorRect125.col = Color.PINK;  buildings2ChangeColorRect125.grayCol = grayBlue;
			buildings2ChangeColorRect126.col = Color.PINK;  buildings2ChangeColorRect126.grayCol = grayBlue;
			buildings2ChangeColorRect127.col = Color.PINK;  buildings2ChangeColorRect127.grayCol = grayBlue;
			buildings2ChangeColorRect128.col = Color.PINK;  buildings2ChangeColorRect128.grayCol = grayBlue;
			buildings2ChangeColorRect129.col = Color.PINK;  buildings2ChangeColorRect129.grayCol = grayBlue;
			buildings2ChangeColorRect130.col = Color.PINK;  buildings2ChangeColorRect130.grayCol = grayBlue;
			buildings2ChangeColorRect131.col = Color.PINK;  buildings2ChangeColorRect131.grayCol = grayBlue;
			buildings2ChangeColorRect132.col = Color.PINK;  buildings2ChangeColorRect132.grayCol = grayBlue;
			buildings2ChangeColorRect133.col = Color.PINK;  buildings2ChangeColorRect133.grayCol = grayBlue;
			buildings2ChangeColorRect134.col = Color.PINK;  buildings2ChangeColorRect134.grayCol = grayBlue;
			buildings2ChangeColorRect135.col = Color.PINK;  buildings2ChangeColorRect135.grayCol = grayBlue;
			buildings2ChangeColorRect136.col = Color.PINK;  buildings2ChangeColorRect136.grayCol = grayBlue;
			buildings2ChangeColorRect137.col = Color.PINK;  buildings2ChangeColorRect137.grayCol = grayBlue;
			buildings2ChangeColorRect138.col = Color.PINK;  buildings2ChangeColorRect138.grayCol = grayBlue;
			buildings2ChangeColorRect139.col = Color.PINK;  buildings2ChangeColorRect139.grayCol = grayBlue;
			buildings2ChangeColorRect140.col = Color.PINK;  buildings2ChangeColorRect140.grayCol = grayBlue;
			buildings2ChangeColorRect141.col = Color.PINK;  buildings2ChangeColorRect141.grayCol = grayBlue;
			buildings2ChangeColorRect142.col = Color.PINK;  buildings2ChangeColorRect142.grayCol = grayBlue;
			buildings2ChangeColorRect143.col = Color.PINK;  buildings2ChangeColorRect143.grayCol = grayBlue;
			buildings2ChangeColorRect144.col = Color.PINK;  buildings2ChangeColorRect144.grayCol = grayBlue;
			buildings2ChangeColorRect145.col = Color.PINK;  buildings2ChangeColorRect145.grayCol = grayBlue;
			buildings2ChangeColorRect146.col = Color.PINK;  buildings2ChangeColorRect146.grayCol = grayBlue;
			buildings2ChangeColorRect147.col = Color.PINK;  buildings2ChangeColorRect147.grayCol = grayBlue;
			buildings2ChangeColorRect148.col = Color.PINK;  buildings2ChangeColorRect148.grayCol = grayBlue;
			buildings2ChangeColorRect149.col = Color.PINK;  buildings2ChangeColorRect149.grayCol = grayBlue;
			buildings2ChangeColorRect150.col = Color.PINK;  buildings2ChangeColorRect150.grayCol = grayBlue;
			buildings2ChangeColorRect151.col = Color.PINK;  buildings2ChangeColorRect151.grayCol = grayBlue;
			buildings2ChangeColorRect152.col = Color.PINK;  buildings2ChangeColorRect152.grayCol = grayBlue;
			buildings2ChangeColorRect153.col = Color.PINK;  buildings2ChangeColorRect153.grayCol = grayBlue;
			buildings2ChangeColorRect154.col = Color.PINK;  buildings2ChangeColorRect154.grayCol = grayBlue;
			buildings2ChangeColorRect155.col = Color.PINK;  buildings2ChangeColorRect155.grayCol = grayBlue;
			buildings2ChangeColorRect156.col = Color.PINK;  buildings2ChangeColorRect156.grayCol = grayBlue;
			buildings2ChangeColorRect157.col = Color.PINK;  buildings2ChangeColorRect157.grayCol = grayBlue;
			buildings2ChangeColorRect158.col = Color.PINK;  buildings2ChangeColorRect158.grayCol = grayBlue;
			buildings2ChangeColorRect159.col = Color.PINK;  buildings2ChangeColorRect159.grayCol = grayBlue;
			buildings2ChangeColorRect160.col = Color.PINK;  buildings2ChangeColorRect160.grayCol = grayBlue;
			buildings2ChangeColorRect161.col = Color.PINK;  buildings2ChangeColorRect161.grayCol = grayBlue;
			buildings2ChangeColorRect162.col = Color.PINK;  buildings2ChangeColorRect162.grayCol = grayBlue;
			buildings2ChangeColorRect163.col = Color.PINK;  buildings2ChangeColorRect163.grayCol = grayBlue;
			buildings2ChangeColorRect164.col = Color.PINK;  buildings2ChangeColorRect164.grayCol = grayBlue;
			buildings2ChangeColorRect165.col = Color.PINK;  buildings2ChangeColorRect165.grayCol = grayBlue;
			buildings2ChangeColorRect166.col = Color.PINK;  buildings2ChangeColorRect166.grayCol = grayBlue;
			buildings2ChangeColorRect167.col = Color.PINK;  buildings2ChangeColorRect167.grayCol = grayBlue;
			buildings2ChangeColorRect168.col = Color.PINK;  buildings2ChangeColorRect168.grayCol = grayBlue;
			buildings2ChangeColorRect169.col = Color.PINK;  buildings2ChangeColorRect169.grayCol = grayBlue;
			buildings2ChangeColorRect170.col = Color.PINK;  buildings2ChangeColorRect170.grayCol = grayBlue;
			buildings2ChangeColorRect171.col = Color.PINK;  buildings2ChangeColorRect171.grayCol = grayBlue;
			buildings2ChangeColorRect172.col = Color.PINK;  buildings2ChangeColorRect172.grayCol = grayBlue;
			buildings2ChangeColorRect173.col = Color.PINK;  buildings2ChangeColorRect173.grayCol = grayBlue;
			buildings2ChangeColorRect174.col = Color.PINK;  buildings2ChangeColorRect174.grayCol = grayBlue;
			buildings2ChangeColorRect175.col = Color.PINK;  buildings2ChangeColorRect175.grayCol = grayBlue;
			buildings2ChangeColorRect176.col = Color.PINK;  buildings2ChangeColorRect176.grayCol = grayBlue;
			buildings2ChangeColorRect177.col = Color.PINK;  buildings2ChangeColorRect177.grayCol = grayBlue;
			buildings2ChangeColorRect178.col = Color.PINK;  buildings2ChangeColorRect178.grayCol = grayBlue;
			buildings2ChangeColorRect179.col = Color.PINK;  buildings2ChangeColorRect179.grayCol = grayBlue;
			buildings2ChangeColorRect180.col = Color.PINK;  buildings2ChangeColorRect180.grayCol = grayBlue;
			buildings2ChangeColorRect181.col = Color.PINK;  buildings2ChangeColorRect181.grayCol = grayBlue;
			buildings2ChangeColorRect182.col = Color.PINK;  buildings2ChangeColorRect182.grayCol = grayBlue;
			buildings2ChangeColorRect183.col = Color.PINK;  buildings2ChangeColorRect183.grayCol = grayBlue;
			buildings2ChangeColorRect184.col = Color.PINK;  buildings2ChangeColorRect184.grayCol = grayBlue;
			buildings2ChangeColorRect185.col = Color.PINK;  buildings2ChangeColorRect185.grayCol = grayBlue;
			buildings2ChangeColorRect186.col = Color.PINK;  buildings2ChangeColorRect186.grayCol = grayBlue;
			buildings2ChangeColorRect187.col = Color.PINK;  buildings2ChangeColorRect187.grayCol = grayBlue;
			buildings2ChangeColorRect188.col = Color.PINK;  buildings2ChangeColorRect188.grayCol = grayBlue;
			buildings2ChangeColorRect189.col = Color.PINK;  buildings2ChangeColorRect189.grayCol = grayBlue;
			buildings2ChangeColorRect190.col = Color.PINK;  buildings2ChangeColorRect190.grayCol = grayBlue;
			buildings2ChangeColorRect191.col = Color.PINK;  buildings2ChangeColorRect191.grayCol = grayBlue;
			buildings2ChangeColorRect192.col = Color.PINK;  buildings2ChangeColorRect192.grayCol = grayBlue;
			buildings2ChangeColorRect193.col = Color.PINK;  buildings2ChangeColorRect193.grayCol = grayBlue;
			buildings2ChangeColorRect194.col = Color.PINK;  buildings2ChangeColorRect194.grayCol = grayBlue;
			buildings2ChangeColorRect195.col = Color.PINK;  buildings2ChangeColorRect195.grayCol = grayBlue;
			buildings2ChangeColorRect196.col = Color.PINK;  buildings2ChangeColorRect196.grayCol = grayBlue;
			buildings2ChangeColorRect197.col = Color.PINK;  buildings2ChangeColorRect197.grayCol = grayBlue;
			buildings2ChangeColorRect198.col = Color.PINK;  buildings2ChangeColorRect198.grayCol = grayBlue;
			buildings2ChangeColorRect199.col = Color.PINK;  buildings2ChangeColorRect199.grayCol = grayBlue;
			buildings2ChangeColorRect200.col = Color.PINK;  buildings2ChangeColorRect200.grayCol = grayBlue;
			buildings2ChangeColorRect201.col = Color.PINK;  buildings2ChangeColorRect201.grayCol = grayBlue;
			buildings2ChangeColorRect202.col = Color.PINK;  buildings2ChangeColorRect202.grayCol = grayBlue;
			buildings2ChangeColorRect203.col = Color.PINK;  buildings2ChangeColorRect203.grayCol = grayBlue;
			buildings2ChangeColorRect204.col = Color.PINK;  buildings2ChangeColorRect204.grayCol = grayBlue;
			buildings2ChangeColorRect205.col = Color.PINK;  buildings2ChangeColorRect205.grayCol = grayBlue;
			buildings2ChangeColorRect206.col = Color.PINK;  buildings2ChangeColorRect206.grayCol = grayBlue;
			buildings2ChangeColorRect207.col = Color.PINK;  buildings2ChangeColorRect207.grayCol = grayBlue;
			buildings2ChangeColorRect208.col = Color.PINK;  buildings2ChangeColorRect208.grayCol = grayBlue;
			buildings2ChangeColorRect209.col = Color.PINK;  buildings2ChangeColorRect209.grayCol = grayBlue;
			buildings2ChangeColorRect210.col = Color.PINK;  buildings2ChangeColorRect210.grayCol = grayBlue;
			buildings2ChangeColorRect211.col = Color.PINK;  buildings2ChangeColorRect211.grayCol = grayBlue;
			buildings2ChangeColorRect212.col = Color.PINK;  buildings2ChangeColorRect212.grayCol = grayBlue;
			buildings2ChangeColorRect213.col = Color.PINK;  buildings2ChangeColorRect213.grayCol = grayBlue;
			buildings2ChangeColorRect214.col = Color.PINK;  buildings2ChangeColorRect214.grayCol = grayBlue;
			buildings2ChangeColorRect215.col = Color.PINK;  buildings2ChangeColorRect215.grayCol = grayBlue;
			buildings2ChangeColorRect216.col = Color.PINK;  buildings2ChangeColorRect216.grayCol = grayBlue;
			buildings2ChangeColorRect217.col = Color.PINK;  buildings2ChangeColorRect217.grayCol = grayBlue;
			buildings2ChangeColorRect218.col = Color.PINK;  buildings2ChangeColorRect218.grayCol = grayBlue;
			buildings2ChangeColorRect219.col = Color.PINK;  buildings2ChangeColorRect219.grayCol = grayBlue;
			buildings2ChangeColorRect220.col = Color.PINK;  buildings2ChangeColorRect220.grayCol = grayBlue;
			buildings2ChangeColorRect221.col = Color.PINK;  buildings2ChangeColorRect221.grayCol = grayBlue;
			buildings2ChangeColorRect222.col = Color.PINK;  buildings2ChangeColorRect222.grayCol = grayBlue;
			buildings2ChangeColorRect223.col = Color.PINK;  buildings2ChangeColorRect223.grayCol = grayBlue;
			buildings2ChangeColorRect224.col = Color.PINK;  buildings2ChangeColorRect224.grayCol = grayBlue;
			buildings2ChangeColorRect225.col = Color.PINK;  buildings2ChangeColorRect225.grayCol = grayBlue;
			buildings2ChangeColorRect226.col = Color.PINK;  buildings2ChangeColorRect226.grayCol = grayBlue;
			buildings2ChangeColorRect227.col = Color.PINK;  buildings2ChangeColorRect227.grayCol = grayBlue;
			buildings2ChangeColorRect228.col = Color.PINK;  buildings2ChangeColorRect228.grayCol = grayBlue;
			buildings2ChangeColorRect229.col = Color.PINK;  buildings2ChangeColorRect229.grayCol = grayBlue;
			buildings2ChangeColorRect230.col = Color.PINK;  buildings2ChangeColorRect230.grayCol = grayBlue;
			buildings2ChangeColorRect231.col = Color.PINK;  buildings2ChangeColorRect231.grayCol = grayBlue;
			buildings2ChangeColorRect232.col = Color.PINK;  buildings2ChangeColorRect232.grayCol = grayBlue;
			buildings2ChangeColorRect233.col = Color.PINK;  buildings2ChangeColorRect233.grayCol = grayBlue;
			buildings2ChangeColorRect234.col = Color.PINK;  buildings2ChangeColorRect234.grayCol = grayBlue;
			buildings2ChangeColorRect235.col = Color.PINK;  buildings2ChangeColorRect235.grayCol = grayBlue;
			buildings2ChangeColorRect236.col = Color.PINK;  buildings2ChangeColorRect236.grayCol = grayBlue;
			buildings2ChangeColorRect237.col = Color.PINK;  buildings2ChangeColorRect237.grayCol = grayBlue;
			buildings2ChangeColorRect238.col = Color.PINK;  buildings2ChangeColorRect238.grayCol = grayBlue;
			buildings2ChangeColorRect239.col = Color.PINK;  buildings2ChangeColorRect239.grayCol = grayBlue;
			buildings2ChangeColorRect240.col = Color.PINK;  buildings2ChangeColorRect240.grayCol = grayBlue;
			buildings2ChangeColorRect241.col = Color.PINK;  buildings2ChangeColorRect241.grayCol = grayBlue;
			buildings2ChangeColorRect242.col = Color.PINK;  buildings2ChangeColorRect242.grayCol = grayBlue;
			buildings2ChangeColorRect243.col = Color.PINK;  buildings2ChangeColorRect243.grayCol = grayBlue;
			buildings2ChangeColorRect244.col = Color.PINK;  buildings2ChangeColorRect244.grayCol = grayBlue;
			buildings2ChangeColorRect245.col = Color.PINK;  buildings2ChangeColorRect245.grayCol = grayBlue;
			buildings2ChangeColorRect246.col = Color.PINK;  buildings2ChangeColorRect246.grayCol = grayBlue;
			buildings2ChangeColorRect247.col = Color.PINK;  buildings2ChangeColorRect247.grayCol = grayBlue;
			buildings2ChangeColorRect248.col = Color.PINK;  buildings2ChangeColorRect248.grayCol = grayBlue;
			buildings2ChangeColorRect249.col = Color.PINK;  buildings2ChangeColorRect249.grayCol = grayBlue;
			buildings2ChangeColorRect250.col = Color.PINK;  buildings2ChangeColorRect250.grayCol = grayBlue;
			buildings2ChangeColorRect251.col = Color.PINK;  buildings2ChangeColorRect251.grayCol = grayBlue;
			buildings2ChangeColorRect252.col = Color.PINK;  buildings2ChangeColorRect252.grayCol = grayBlue;
			buildings2ChangeColorRect253.col = Color.PINK;  buildings2ChangeColorRect253.grayCol = grayBlue;
			buildings2ChangeColorRect254.col = Color.PINK;  buildings2ChangeColorRect254.grayCol = grayBlue;
			buildings2ChangeColorRect255.col = Color.PINK;  buildings2ChangeColorRect255.grayCol = grayBlue;
			buildings2ChangeColorRect256.col = Color.PINK;  buildings2ChangeColorRect256.grayCol = grayBlue;
			buildings2ChangeColorRect257.col = Color.PINK;  buildings2ChangeColorRect257.grayCol = grayBlue;
			buildings2ChangeColorRect258.col = Color.PINK;  buildings2ChangeColorRect258.grayCol = grayBlue;
			buildings2ChangeColorRect259.col = Color.PINK;  buildings2ChangeColorRect259.grayCol = grayBlue;
			buildings2ChangeColorRect260.col = Color.PINK;  buildings2ChangeColorRect260.grayCol = grayBlue;
			buildings2ChangeColorRect261.col = Color.PINK;  buildings2ChangeColorRect261.grayCol = grayBlue;
			buildings2ChangeColorRect262.col = Color.PINK;  buildings2ChangeColorRect262.grayCol = grayBlue;
			buildings2ChangeColorRect263.col = Color.PINK;  buildings2ChangeColorRect263.grayCol = grayBlue;
			buildings2ChangeColorRect264.col = Color.PINK;  buildings2ChangeColorRect264.grayCol = grayBlue;
			buildings2ChangeColorRect265.col = Color.PINK;  buildings2ChangeColorRect265.grayCol = grayBlue;
			buildings2ChangeColorRect266.col = Color.PINK;  buildings2ChangeColorRect266.grayCol = grayBlue;
			buildings2ChangeColorRect267.col = Color.PINK;  buildings2ChangeColorRect267.grayCol = grayBlue;
			buildings2ChangeColorRect268.col = Color.PINK;  buildings2ChangeColorRect268.grayCol = grayBlue;
			buildings2ChangeColorRect269.col = Color.PINK;  buildings2ChangeColorRect269.grayCol = grayBlue;
			buildings2ChangeColorRect270.col = Color.PINK;  buildings2ChangeColorRect270.grayCol = grayBlue;
			buildings2ChangeColorRect271.col = Color.PINK;  buildings2ChangeColorRect271.grayCol = grayBlue;
			buildings2ChangeColorRect272.col = Color.PINK;  buildings2ChangeColorRect272.grayCol = grayBlue;
			buildings2ChangeColorRect273.col = Color.PINK;  buildings2ChangeColorRect273.grayCol = grayBlue;
			buildings2ChangeColorRect274.col = Color.PINK;  buildings2ChangeColorRect274.grayCol = grayBlue;
			buildings2ChangeColorRect275.col = Color.PINK;  buildings2ChangeColorRect275.grayCol = grayBlue;
			buildings2ChangeColorRect276.col = Color.PINK;  buildings2ChangeColorRect276.grayCol = grayBlue;
			buildings2ChangeColorRect277.col = Color.PINK;  buildings2ChangeColorRect277.grayCol = grayBlue;
			buildings2ChangeColorRect278.col = Color.PINK;  buildings2ChangeColorRect278.grayCol = grayBlue;
			buildings2ChangeColorRect279.col = Color.PINK;  buildings2ChangeColorRect279.grayCol = grayBlue;
			buildings2ChangeColorRect280.col = Color.PINK;  buildings2ChangeColorRect280.grayCol = grayBlue;
			buildings2ChangeColorRect281.col = Color.PINK;  buildings2ChangeColorRect281.grayCol = grayBlue;
			buildings2ChangeColorRect282.col = Color.PINK;  buildings2ChangeColorRect282.grayCol = grayBlue;
			buildings2ChangeColorRect283.col = Color.PINK;  buildings2ChangeColorRect283.grayCol = grayBlue;
			buildings2ChangeColorRect284.col = Color.PINK;  buildings2ChangeColorRect284.grayCol = grayBlue;
			buildings2ChangeColorRect285.col = Color.PINK;  buildings2ChangeColorRect285.grayCol = grayBlue;
			buildings2ChangeColorRect286.col = Color.PINK;  buildings2ChangeColorRect286.grayCol = grayBlue;
			buildings2ChangeColorRect287.col = Color.PINK;  buildings2ChangeColorRect287.grayCol = grayBlue;
			buildings2ChangeColorRect288.col = Color.PINK;  buildings2ChangeColorRect288.grayCol = grayBlue;
			buildings2ChangeColorRect289.col = Color.PINK;  buildings2ChangeColorRect289.grayCol = grayBlue;
			buildings2ChangeColorRect290.col = Color.PINK;  buildings2ChangeColorRect290.grayCol = grayBlue;
			buildings2ChangeColorRect291.col = Color.PINK;  buildings2ChangeColorRect291.grayCol = grayBlue;
			buildings2ChangeColorRect292.col = Color.PINK;  buildings2ChangeColorRect292.grayCol = grayBlue;
			buildings2ChangeColorRect293.col = Color.PINK;  buildings2ChangeColorRect293.grayCol = grayBlue;
			buildings2ChangeColorRect294.col = Color.PINK;  buildings2ChangeColorRect294.grayCol = grayBlue;
			buildings2ChangeColorRect295.col = Color.PINK;  buildings2ChangeColorRect295.grayCol = grayBlue;
			buildings2ChangeColorRect296.col = Color.PINK;  buildings2ChangeColorRect296.grayCol = grayBlue;
			buildings2ChangeColorRect297.col = Color.PINK;  buildings2ChangeColorRect297.grayCol = grayBlue;
			buildings2ChangeColorRect298.col = Color.PINK;  buildings2ChangeColorRect298.grayCol = grayBlue;
			buildings2ChangeColorRect299.col = Color.PINK;  buildings2ChangeColorRect299.grayCol = grayBlue;
			buildings2ChangeColorRect300.col = Color.PINK;  buildings2ChangeColorRect300.grayCol = grayBlue;
			buildings2ChangeColorRect301.col = Color.PINK;  buildings2ChangeColorRect301.grayCol = grayBlue;
			buildings2ChangeColorRect302.col = Color.PINK;  buildings2ChangeColorRect302.grayCol = grayBlue;
			buildings2ChangeColorRect303.col = Color.PINK;  buildings2ChangeColorRect303.grayCol = grayBlue;
			buildings2ChangeColorRect304.col = Color.PINK;  buildings2ChangeColorRect304.grayCol = grayBlue;
			buildings2ChangeColorRect305.col = Color.PINK;  buildings2ChangeColorRect305.grayCol = grayBlue;
			buildings2ChangeColorRect306.col = Color.PINK;  buildings2ChangeColorRect306.grayCol = grayBlue;
			buildings2ChangeColorRect307.col = Color.PINK;  buildings2ChangeColorRect307.grayCol = grayBlue;
			buildings2ChangeColorRect308.col = Color.PINK;  buildings2ChangeColorRect308.grayCol = grayBlue;
			buildings2ChangeColorRect309.col = Color.PINK;  buildings2ChangeColorRect309.grayCol = grayBlue;
			buildings2ChangeColorRect310.col = Color.PINK;  buildings2ChangeColorRect310.grayCol = grayBlue;
			buildings2ChangeColorRect311.col = Color.PINK;  buildings2ChangeColorRect311.grayCol = grayBlue;
			buildings2ChangeColorRect312.col = Color.PINK;  buildings2ChangeColorRect312.grayCol = grayBlue;
			buildings2ChangeColorRect313.col = Color.PINK;  buildings2ChangeColorRect313.grayCol = grayBlue;
			buildings2ChangeColorRect314.col = Color.PINK;  buildings2ChangeColorRect314.grayCol = grayBlue;
			buildings2ChangeColorRect315.col = Color.PINK;  buildings2ChangeColorRect315.grayCol = grayBlue;
			buildings2ChangeColorRect316.col = Color.PINK;  buildings2ChangeColorRect316.grayCol = grayBlue;
			buildings2ChangeColorRect317.col = Color.PINK;  buildings2ChangeColorRect317.grayCol = grayBlue;
			buildings2ChangeColorRect318.col = Color.PINK;  buildings2ChangeColorRect318.grayCol = grayBlue;
			buildings2ChangeColorRect319.col = Color.PINK;  buildings2ChangeColorRect319.grayCol = grayBlue;
			buildings2ChangeColorRect320.col = Color.PINK;  buildings2ChangeColorRect320.grayCol = grayBlue;
			buildings2ChangeColorRect321.col = Color.PINK;  buildings2ChangeColorRect321.grayCol = grayBlue;
			buildings2ChangeColorRect322.col = Color.PINK;  buildings2ChangeColorRect322.grayCol = grayBlue;
			buildings2ChangeColorRect323.col = Color.PINK;  buildings2ChangeColorRect323.grayCol = grayBlue;
			buildings2ChangeColorRect324.col = Color.PINK;  buildings2ChangeColorRect324.grayCol = grayBlue;
			buildings2ChangeColorRect325.col = Color.PINK;  buildings2ChangeColorRect325.grayCol = grayBlue;
			buildings2ChangeColorRect326.col = Color.PINK;  buildings2ChangeColorRect326.grayCol = grayBlue;
			buildings2ChangeColorRect327.col = Color.PINK;  buildings2ChangeColorRect327.grayCol = grayBlue;
			buildings2ChangeColorRect328.col = Color.PINK;  buildings2ChangeColorRect328.grayCol = grayBlue;
			buildings2ChangeColorRect329.col = Color.PINK;  buildings2ChangeColorRect329.grayCol = grayBlue;
			buildings2ChangeColorRect330.col = Color.PINK;  buildings2ChangeColorRect330.grayCol = grayBlue;
			buildings2ChangeColorRect331.col = Color.PINK;  buildings2ChangeColorRect331.grayCol = grayBlue;
			buildings2ChangeColorRect332.col = Color.PINK;  buildings2ChangeColorRect332.grayCol = grayBlue;
			buildings2ChangeColorRect333.col = Color.PINK;  buildings2ChangeColorRect333.grayCol = grayBlue;
			buildings2ChangeColorRect334.col = Color.PINK;  buildings2ChangeColorRect334.grayCol = grayBlue;
			buildings2ChangeColorRect335.col = Color.PINK;  buildings2ChangeColorRect335.grayCol = grayBlue;
			buildings2ChangeColorRect336.col = Color.PINK;  buildings2ChangeColorRect336.grayCol = grayBlue;
			buildings2ChangeColorRect337.col = Color.PINK;  buildings2ChangeColorRect337.grayCol = grayBlue;
			buildings2ChangeColorRect338.col = Color.PINK;  buildings2ChangeColorRect338.grayCol = grayBlue;
			buildings2ChangeColorRect339.col = Color.PINK;  buildings2ChangeColorRect339.grayCol = grayBlue;
			buildings2ChangeColorRect340.col = Color.PINK;  buildings2ChangeColorRect340.grayCol = grayBlue;
			buildings2ChangeColorRect341.col = Color.PINK;  buildings2ChangeColorRect341.grayCol = grayBlue;
			buildings2ChangeColorRect342.col = Color.PINK;  buildings2ChangeColorRect342.grayCol = grayBlue;
			buildings2ChangeColorRect343.col = Color.PINK;  buildings2ChangeColorRect343.grayCol = grayBlue;
			buildings2ChangeColorRect344.col = Color.PINK;  buildings2ChangeColorRect344.grayCol = grayBlue;
			buildings2ChangeColorRect345.col = Color.PINK;  buildings2ChangeColorRect345.grayCol = grayBlue;
			buildings2ChangeColorRect346.col = Color.PINK;  buildings2ChangeColorRect346.grayCol = grayBlue;
			buildings2ChangeColorRect347.col = Color.PINK;  buildings2ChangeColorRect347.grayCol = grayBlue;
			buildings2ChangeColorRect348.col = Color.PINK;  buildings2ChangeColorRect348.grayCol = grayBlue;
			buildings2ChangeColorRect349.col = Color.PINK;  buildings2ChangeColorRect349.grayCol = grayBlue;
			buildings2ChangeColorRect350.col = Color.PINK;  buildings2ChangeColorRect350.grayCol = grayBlue;
			buildings2ChangeColorRect351.col = Color.PINK;  buildings2ChangeColorRect351.grayCol = grayBlue;
			buildings2ChangeColorRect352.col = Color.PINK;  buildings2ChangeColorRect352.grayCol = grayBlue;
			buildings2ChangeColorRect353.col = Color.PINK;  buildings2ChangeColorRect353.grayCol = grayBlue;
			buildings2ChangeColorRect354.col = Color.PINK;  buildings2ChangeColorRect354.grayCol = grayBlue;
			buildings2ChangeColorRect355.col = Color.PINK;  buildings2ChangeColorRect355.grayCol = grayBlue;
			buildings2ChangeColorRect356.col = Color.PINK;  buildings2ChangeColorRect356.grayCol = grayBlue;
			buildings2ChangeColorRect357.col = Color.PINK;  buildings2ChangeColorRect357.grayCol = grayBlue;
			buildings2ChangeColorRect358.col = Color.PINK;  buildings2ChangeColorRect358.grayCol = grayBlue;
			buildings2ChangeColorRect359.col = Color.PINK;  buildings2ChangeColorRect359.grayCol = grayBlue;
			buildings2ChangeColorRect360.col = Color.PINK;  buildings2ChangeColorRect360.grayCol = grayBlue;
			buildings2ChangeColorRect361.col = Color.PINK;  buildings2ChangeColorRect361.grayCol = grayBlue;
			buildings2ChangeColorRect362.col = Color.PINK;  buildings2ChangeColorRect362.grayCol = grayBlue;
			buildings2ChangeColorRect363.col = Color.PINK;  buildings2ChangeColorRect363.grayCol = grayBlue;
			buildings2ChangeColorRect364.col = Color.PINK;  buildings2ChangeColorRect364.grayCol = grayBlue;
			buildings2ChangeColorRect365.col = Color.PINK;  buildings2ChangeColorRect365.grayCol = grayBlue;
			buildings2ChangeColorRect366.col = Color.PINK;  buildings2ChangeColorRect366.grayCol = grayBlue;
			buildings2ChangeColorRect367.col = Color.PINK;  buildings2ChangeColorRect367.grayCol = grayBlue;
			buildings2ChangeColorRect368.col = Color.PINK;  buildings2ChangeColorRect368.grayCol = grayBlue;
			buildings2ChangeColorRect369.col = Color.PINK;  buildings2ChangeColorRect369.grayCol = grayBlue;
			buildings2ChangeColorRect370.col = Color.PINK;  buildings2ChangeColorRect370.grayCol = grayBlue;
			buildings2ChangeColorRect371.col = Color.PINK;  buildings2ChangeColorRect371.grayCol = grayBlue;
			buildings2ChangeColorRect372.col = Color.PINK;  buildings2ChangeColorRect372.grayCol = grayBlue;
			buildings2ChangeColorRect373.col = Color.PINK;  buildings2ChangeColorRect373.grayCol = grayBlue;
			buildings2ChangeColorRect374.col = Color.PINK;  buildings2ChangeColorRect374.grayCol = grayBlue;
			buildings2ChangeColorRect375.col = Color.PINK;  buildings2ChangeColorRect375.grayCol = grayBlue;
			buildings2ChangeColorRect376.col = Color.PINK;  buildings2ChangeColorRect376.grayCol = grayBlue;
			buildings2ChangeColorRect377.col = Color.PINK;  buildings2ChangeColorRect377.grayCol = grayBlue;
			buildings2ChangeColorRect378.col = Color.PINK;  buildings2ChangeColorRect378.grayCol = grayBlue;
			buildings2ChangeColorRect379.col = Color.PINK;  buildings2ChangeColorRect379.grayCol = grayBlue;
			buildings2ChangeColorRect380.col = Color.PINK;  buildings2ChangeColorRect380.grayCol = grayBlue;
			buildings2ChangeColorRect381.col = Color.PINK;  buildings2ChangeColorRect381.grayCol = grayBlue;
			buildings2ChangeColorRect382.col = Color.PINK;  buildings2ChangeColorRect382.grayCol = grayBlue;
			buildings2ChangeColorRect383.col = Color.PINK;  buildings2ChangeColorRect383.grayCol = grayBlue;
			buildings2ChangeColorRect384.col = Color.PINK;  buildings2ChangeColorRect384.grayCol = grayBlue;
			buildings2ChangeColorRect385.col = Color.PINK;  buildings2ChangeColorRect385.grayCol = grayBlue;
			buildings2ChangeColorRect386.col = Color.PINK;  buildings2ChangeColorRect386.grayCol = grayBlue;
			buildings2ChangeColorRect387.col = Color.PINK;  buildings2ChangeColorRect387.grayCol = grayBlue;
			buildings2ChangeColorRect388.col = Color.PINK;  buildings2ChangeColorRect388.grayCol = grayBlue;
			buildings2ChangeColorRect389.col = Color.PINK;  buildings2ChangeColorRect389.grayCol = grayBlue;
			buildings2ChangeColorRect390.col = Color.PINK;  buildings2ChangeColorRect390.grayCol = grayBlue;
			buildings2ChangeColorRect391.col = Color.PINK;  buildings2ChangeColorRect391.grayCol = grayBlue;
			buildings2ChangeColorRect392.col = Color.PINK;  buildings2ChangeColorRect392.grayCol = grayBlue;
			buildings2ChangeColorRect393.col = Color.PINK;  buildings2ChangeColorRect393.grayCol = grayBlue;
			buildings2ChangeColorRect394.col = Color.PINK;  buildings2ChangeColorRect394.grayCol = grayBlue;
			buildings2ChangeColorRect395.col = Color.PINK;  buildings2ChangeColorRect395.grayCol = grayBlue;
			buildings2ChangeColorRect396.col = Color.PINK;  buildings2ChangeColorRect396.grayCol = grayBlue;
			buildings2ChangeColorRect397.col = Color.PINK;  buildings2ChangeColorRect397.grayCol = grayBlue;
			buildings2ChangeColorRect398.col = Color.PINK;  buildings2ChangeColorRect398.grayCol = grayBlue;
			buildings2ChangeColorRect399.col = Color.PINK;  buildings2ChangeColorRect399.grayCol = grayBlue;
			buildings2ChangeColorRect400.col = Color.PINK;  buildings2ChangeColorRect400.grayCol = grayBlue;
			buildings2ChangeColorRect401.col = Color.PINK;  buildings2ChangeColorRect401.grayCol = grayBlue;
			buildings2ChangeColorRect402.col = Color.PINK;  buildings2ChangeColorRect402.grayCol = grayBlue;
			buildings2ChangeColorRect403.col = Color.PINK;  buildings2ChangeColorRect403.grayCol = grayBlue;
			buildings2ChangeColorRect404.col = Color.PINK;  buildings2ChangeColorRect404.grayCol = grayBlue;
			buildings2ChangeColorRect405.col = Color.PINK;  buildings2ChangeColorRect405.grayCol = grayBlue;
			buildings2ChangeColorRect406.col = Color.PINK;  buildings2ChangeColorRect406.grayCol = grayBlue;
			buildings2ChangeColorRect407.col = Color.PINK;  buildings2ChangeColorRect407.grayCol = grayBlue;
			buildings2ChangeColorRect408.col = Color.PINK;  buildings2ChangeColorRect408.grayCol = grayBlue;
			buildings2ChangeColorRect409.col = Color.PINK;  buildings2ChangeColorRect409.grayCol = grayBlue;
			buildings2ChangeColorRect410.col = Color.PINK;  buildings2ChangeColorRect410.grayCol = grayBlue;
			buildings2ChangeColorRect411.col = Color.PINK;  buildings2ChangeColorRect411.grayCol = grayBlue;
			buildings2ChangeColorRect412.col = Color.PINK;  buildings2ChangeColorRect412.grayCol = grayBlue;
			buildings2ChangeColorRect413.col = Color.PINK;  buildings2ChangeColorRect413.grayCol = grayBlue;
			buildings2ChangeColorRect414.col = Color.PINK;  buildings2ChangeColorRect414.grayCol = grayBlue;
			buildings2ChangeColorRect415.col = Color.PINK;  buildings2ChangeColorRect415.grayCol = grayBlue;
			buildings2ChangeColorRect416.col = Color.PINK;  buildings2ChangeColorRect416.grayCol = grayBlue;
			buildings2ChangeColorRect417.col = Color.PINK;  buildings2ChangeColorRect417.grayCol = grayBlue;
			buildings2ChangeColorRect418.col = Color.PINK;  buildings2ChangeColorRect418.grayCol = grayBlue;
			buildings2ChangeColorRect419.col = Color.PINK;  buildings2ChangeColorRect419.grayCol = grayBlue;
			buildings2ChangeColorRect420.col = Color.PINK;  buildings2ChangeColorRect420.grayCol = grayBlue;
			buildings2ChangeColorRect421.col = Color.PINK;  buildings2ChangeColorRect421.grayCol = grayBlue;
			buildings2ChangeColorRect422.col = Color.PINK;  buildings2ChangeColorRect422.grayCol = grayBlue;
			buildings2ChangeColorRect423.col = Color.PINK;  buildings2ChangeColorRect423.grayCol = grayBlue;
			buildings2ChangeColorRect424.col = Color.PINK;  buildings2ChangeColorRect424.grayCol = grayBlue;
			buildings2ChangeColorRect425.col = Color.PINK;  buildings2ChangeColorRect425.grayCol = grayBlue;
			buildings2ChangeColorRect426.col = Color.PINK;  buildings2ChangeColorRect426.grayCol = grayBlue;
			buildings2ChangeColorRect427.col = Color.PINK;  buildings2ChangeColorRect427.grayCol = grayBlue;
			buildings2ChangeColorRect428.col = Color.PINK;  buildings2ChangeColorRect428.grayCol = grayBlue;
			buildings2ChangeColorRect429.col = Color.PINK;  buildings2ChangeColorRect429.grayCol = grayBlue;
			buildings2ChangeColorRect430.col = Color.PINK;  buildings2ChangeColorRect430.grayCol = grayBlue;
			buildings2ChangeColorRect431.col = Color.PINK;  buildings2ChangeColorRect431.grayCol = grayBlue;
			buildings2ChangeColorRect432.col = Color.PINK;  buildings2ChangeColorRect432.grayCol = grayBlue;
			buildings2ChangeColorRect433.col = Color.PINK;  buildings2ChangeColorRect433.grayCol = grayBlue;
			buildings2ChangeColorRect434.col = Color.PINK;  buildings2ChangeColorRect434.grayCol = grayBlue;
			buildings2ChangeColorRect435.col = Color.PINK;  buildings2ChangeColorRect435.grayCol = grayBlue;
			buildings2ChangeColorRect436.col = Color.PINK;  buildings2ChangeColorRect436.grayCol = grayBlue;
			buildings2ChangeColorRect437.col = Color.PINK;  buildings2ChangeColorRect437.grayCol = grayBlue;
			buildings2ChangeColorRect438.col = Color.PINK;  buildings2ChangeColorRect438.grayCol = grayBlue;
			buildings2ChangeColorRect439.col = Color.PINK;  buildings2ChangeColorRect439.grayCol = grayBlue;
			buildings2ChangeColorRect440.col = Color.PINK;  buildings2ChangeColorRect440.grayCol = grayBlue;
			buildings2ChangeColorRect441.col = Color.PINK;  buildings2ChangeColorRect441.grayCol = grayBlue;
			buildings2ChangeColorRect442.col = Color.PINK;  buildings2ChangeColorRect442.grayCol = grayBlue;
			buildings2ChangeColorRect443.col = Color.PINK;  buildings2ChangeColorRect443.grayCol = grayBlue;
			buildings2ChangeColorRect444.col = Color.PINK;  buildings2ChangeColorRect444.grayCol = grayBlue;
			buildings2ChangeColorRect445.col = Color.PINK;  buildings2ChangeColorRect445.grayCol = grayBlue;
			buildings2ChangeColorRect446.col = Color.PINK;  buildings2ChangeColorRect446.grayCol = grayBlue;
			buildings2ChangeColorRect447.col = Color.PINK;  buildings2ChangeColorRect447.grayCol = grayBlue;
			buildings2ChangeColorRect448.col = Color.PINK;  buildings2ChangeColorRect448.grayCol = grayBlue;
			buildings2ChangeColorRect449.col = Color.PINK;  buildings2ChangeColorRect449.grayCol = grayBlue;
			buildings2ChangeColorRect450.col = Color.PINK;  buildings2ChangeColorRect450.grayCol = grayBlue;
			buildings2ChangeColorRect451.col = Color.PINK;  buildings2ChangeColorRect451.grayCol = grayBlue;
			buildings2ChangeColorRect452.col = Color.PINK;  buildings2ChangeColorRect452.grayCol = grayBlue;
			buildings2ChangeColorRect453.col = Color.PINK;  buildings2ChangeColorRect453.grayCol = grayBlue;
			buildings2ChangeColorRect454.col = Color.PINK;  buildings2ChangeColorRect454.grayCol = grayBlue;
			buildings2ChangeColorRect455.col = Color.PINK;  buildings2ChangeColorRect455.grayCol = grayBlue;
			buildings2ChangeColorRect456.col = Color.PINK;  buildings2ChangeColorRect456.grayCol = grayBlue;
			buildings2ChangeColorRect457.col = Color.PINK;  buildings2ChangeColorRect457.grayCol = grayBlue;
			buildings2ChangeColorRect458.col = Color.PINK;  buildings2ChangeColorRect458.grayCol = grayBlue;
			buildings2ChangeColorRect459.col = Color.PINK;  buildings2ChangeColorRect459.grayCol = grayBlue;
			buildings2ChangeColorRect460.col = Color.PINK;  buildings2ChangeColorRect460.grayCol = grayBlue;
			buildings2ChangeColorRect461.col = Color.PINK;  buildings2ChangeColorRect461.grayCol = grayBlue;
			buildings2ChangeColorRect462.col = Color.PINK;  buildings2ChangeColorRect462.grayCol = grayBlue;
			buildings2ChangeColorRect463.col = Color.PINK;  buildings2ChangeColorRect463.grayCol = grayBlue;
			buildings2ChangeColorRect464.col = Color.PINK;  buildings2ChangeColorRect464.grayCol = grayBlue;
			buildings2ChangeColorRect465.col = Color.PINK;  buildings2ChangeColorRect465.grayCol = grayBlue;
			buildings2ChangeColorRect466.col = Color.PINK;  buildings2ChangeColorRect466.grayCol = grayBlue;
			buildings2ChangeColorRect467.col = Color.PINK;  buildings2ChangeColorRect467.grayCol = grayBlue;
			buildings2ChangeColorRect468.col = Color.PINK;  buildings2ChangeColorRect468.grayCol = grayBlue;
			buildings2ChangeColorRect469.col = Color.PINK;  buildings2ChangeColorRect469.grayCol = grayBlue;
			buildings2ChangeColorRect470.col = Color.PINK;  buildings2ChangeColorRect470.grayCol = grayBlue;
			buildings2ChangeColorRect471.col = Color.PINK;  buildings2ChangeColorRect471.grayCol = grayBlue;
			buildings2ChangeColorRect472.col = Color.PINK;  buildings2ChangeColorRect472.grayCol = grayBlue;
			buildings2ChangeColorRect473.col = Color.PINK;  buildings2ChangeColorRect473.grayCol = grayBlue;
			buildings2ChangeColorRect474.col = Color.PINK;  buildings2ChangeColorRect474.grayCol = grayBlue;
			buildings2ChangeColorRect475.col = Color.PINK;  buildings2ChangeColorRect475.grayCol = grayBlue;
			buildings2ChangeColorRect476.col = Color.PINK;  buildings2ChangeColorRect476.grayCol = grayBlue;
			buildings2ChangeColorRect477.col = Color.PINK;  buildings2ChangeColorRect477.grayCol = grayBlue;
			buildings2ChangeColorRect478.col = Color.PINK;  buildings2ChangeColorRect478.grayCol = grayBlue;
			buildings2ChangeColorRect479.col = Color.PINK;  buildings2ChangeColorRect479.grayCol = grayBlue;
			buildings2ChangeColorRect480.col = Color.PINK;  buildings2ChangeColorRect480.grayCol = grayBlue;
			buildings2ChangeColorRect481.col = Color.PINK;  buildings2ChangeColorRect481.grayCol = grayBlue;
			buildings2ChangeColorRect482.col = Color.PINK;  buildings2ChangeColorRect482.grayCol = grayBlue;
			buildings2ChangeColorRect483.col = Color.PINK;  buildings2ChangeColorRect483.grayCol = grayBlue;
			buildings2ChangeColorRect484.col = Color.PINK;  buildings2ChangeColorRect484.grayCol = grayBlue;
			buildings2ChangeColorRect485.col = Color.PINK;  buildings2ChangeColorRect485.grayCol = grayBlue;
			buildings2ChangeColorRect486.col = Color.PINK;  buildings2ChangeColorRect486.grayCol = grayBlue;
			buildings2ChangeColorRect487.col = Color.PINK;  buildings2ChangeColorRect487.grayCol = grayBlue;
			buildings2ChangeColorRect488.col = Color.PINK;  buildings2ChangeColorRect488.grayCol = grayBlue;
			buildings2ChangeColorRect489.col = Color.PINK;  buildings2ChangeColorRect489.grayCol = grayBlue;
			buildings2ChangeColorRect490.col = Color.PINK;  buildings2ChangeColorRect490.grayCol = grayBlue;
			buildings2ChangeColorRect491.col = Color.PINK;  buildings2ChangeColorRect491.grayCol = grayBlue;
			buildings2ChangeColorRect492.col = Color.PINK;  buildings2ChangeColorRect492.grayCol = grayBlue;
			buildings2ChangeColorRect493.col = Color.PINK;  buildings2ChangeColorRect493.grayCol = grayBlue;
			buildings2ChangeColorRect494.col = Color.PINK;  buildings2ChangeColorRect494.grayCol = grayBlue;
			buildings2ChangeColorRect495.col = Color.PINK;  buildings2ChangeColorRect495.grayCol = grayBlue;
			buildings2ChangeColorRect496.col = Color.PINK;  buildings2ChangeColorRect496.grayCol = grayBlue;
			buildings2ChangeColorRect497.col = Color.PINK;  buildings2ChangeColorRect497.grayCol = grayBlue;
			buildings2ChangeColorRect498.col = Color.PINK;  buildings2ChangeColorRect498.grayCol = grayBlue;
			buildings2ChangeColorRect499.col = Color.PINK;  buildings2ChangeColorRect499.grayCol = grayBlue;
			buildings2ChangeColorRect500.col = Color.PINK;  buildings2ChangeColorRect500.grayCol = grayBlue;
			buildings2ChangeColorRect501.col = Color.PINK;  buildings2ChangeColorRect501.grayCol = grayBlue;
			buildings2ChangeColorRect502.col = Color.PINK;  buildings2ChangeColorRect502.grayCol = grayBlue;
			buildings2ChangeColorRect503.col = Color.PINK;  buildings2ChangeColorRect503.grayCol = grayBlue;
			buildings2ChangeColorRect504.col = Color.PINK;  buildings2ChangeColorRect504.grayCol = grayBlue;
			buildings2ChangeColorRect505.col = Color.PINK;  buildings2ChangeColorRect505.grayCol = grayBlue;
			buildings2ChangeColorRect506.col = Color.PINK;  buildings2ChangeColorRect506.grayCol = grayBlue;
			buildings2ChangeColorRect507.col = Color.PINK;  buildings2ChangeColorRect507.grayCol = grayBlue;
			buildings2ChangeColorRect508.col = Color.PINK;  buildings2ChangeColorRect508.grayCol = grayBlue;
			buildings2ChangeColorRect509.col = Color.PINK;  buildings2ChangeColorRect509.grayCol = grayBlue;
			buildings2ChangeColorRect510.col = Color.PINK;  buildings2ChangeColorRect510.grayCol = grayBlue;
			buildings2ChangeColorRect511.col = Color.PINK;  buildings2ChangeColorRect511.grayCol = grayBlue;
			buildings2ChangeColorRect512.col = Color.PINK;  buildings2ChangeColorRect512.grayCol = grayBlue;
			buildings2ChangeColorRect513.col = Color.PINK;  buildings2ChangeColorRect513.grayCol = grayBlue;
			buildings2ChangeColorRect514.col = Color.PINK;  buildings2ChangeColorRect514.grayCol = grayBlue;
			buildings2ChangeColorRect515.col = Color.PINK;  buildings2ChangeColorRect515.grayCol = grayBlue;
			buildings2ChangeColorRect516.col = Color.PINK;  buildings2ChangeColorRect516.grayCol = grayBlue;
			buildings2ChangeColorRect517.col = Color.PINK;  buildings2ChangeColorRect517.grayCol = grayBlue;
			buildings2ChangeColorRect518.col = Color.PINK;  buildings2ChangeColorRect518.grayCol = grayBlue;
			buildings2ChangeColorRect519.col = Color.PINK;  buildings2ChangeColorRect519.grayCol = grayBlue;
			buildings2ChangeColorRect520.col = Color.PINK;  buildings2ChangeColorRect520.grayCol = grayBlue;
			buildings2ChangeColorRect521.col = Color.PINK;  buildings2ChangeColorRect521.grayCol = grayBlue;
			...
			buildings2ChangeColorRect1.col = Color.BLUE;  buildings2ChangeColorRect1.grayCol = grayGreen;
			buildings2ChangeColorRect2.col = Color.BLUE;  buildings2ChangeColorRect2.grayCol = grayGreen;
			buildings2ChangeColorRect3.col = Color.BLUE;  buildings2ChangeColorRect3.grayCol = grayGreen;
			buildings2ChangeColorRect4.col = Color.BLUE;  buildings2ChangeColorRect4.grayCol = grayGreen;
			buildings2ChangeColorRect5.col = Color.BLUE;  buildings2ChangeColorRect5.grayCol = grayGreen;
			buildings2ChangeColorRect6.col = Color.BLUE;  buildings2ChangeColorRect6.grayCol = grayGreen;
			buildings2ChangeColorRect7.col = Color.BLUE;  buildings2ChangeColorRect7.grayCol = grayGreen;
			buildings2ChangeColorRect8.col = Color.BLUE;  buildings2ChangeColorRect8.grayCol = grayGreen;
			buildings2ChangeColorRect9.col = Color.BLUE;  buildings2ChangeColorRect9.grayCol = grayGreen;
			buildings2ChangeColorRect10.col = Color.BLUE;  buildings2ChangeColorRect10.grayCol = grayGreen;
			buildings2ChangeColorRect11.col = Color.BLUE;  buildings2ChangeColorRect11.grayCol = grayGreen;
			buildings2ChangeColorRect12.col = Color.BLUE;  buildings2ChangeColorRect12.grayCol = grayGreen;
			buildings2ChangeColorRect13.col = Color.BLUE;  buildings2ChangeColorRect13.grayCol = grayGreen;
			buildings2ChangeColorRect14.col = Color.BLUE;  buildings2ChangeColorRect14.grayCol = grayGreen;
			buildings2ChangeColorRect15.col = Color.BLUE;  buildings2ChangeColorRect15.grayCol = grayGreen;
			buildings2ChangeColorRect16.col = Color.BLUE;  buildings2ChangeColorRect16.grayCol = grayGreen;
			buildings2ChangeColorRect17.col = Color.BLUE;  buildings2ChangeColorRect17.grayCol = grayGreen;
			buildings2ChangeColorRect18.col = Color.BLUE;  buildings2ChangeColorRect18.grayCol = grayGreen;
			buildings2ChangeColorRect19.col = Color.BLUE;  buildings2ChangeColorRect19.grayCol = grayGreen;
			buildings2ChangeColorRect20.col = Color.BLUE;  buildings2ChangeColorRect20.grayCol = grayGreen;
			buildings2ChangeColorRect21.col = Color.BLUE;  buildings2ChangeColorRect21.grayCol = grayGreen;
			buildings2ChangeColorRect22.col = Color.BLUE;  buildings2ChangeColorRect22.grayCol = grayGreen;
			buildings2ChangeColorRect23.col = Color.BLUE;  buildings2ChangeColorRect23.grayCol = grayGreen;
			buildings2ChangeColorRect24.col = Color.BLUE;  buildings2ChangeColorRect24.grayCol = grayGreen;
			buildings2ChangeColorRect25.col = Color.BLUE;  buildings2ChangeColorRect25.grayCol = grayGreen;
			buildings2ChangeColorRect26.col = Color.BLUE;  buildings2ChangeColorRect26.grayCol = grayGreen;
			buildings2ChangeColorRect27.col = Color.BLUE;  buildings2ChangeColorRect27.grayCol = grayGreen;
			buildings2ChangeColorRect28.col = Color.BLUE;  buildings2ChangeColorRect28.grayCol = grayGreen;
			buildings2ChangeColorRect29.col = Color.BLUE;  buildings2ChangeColorRect29.grayCol = grayGreen;
			buildings2ChangeColorRect30.col = Color.BLUE;  buildings2ChangeColorRect30.grayCol = grayGreen;
			buildings2ChangeColorRect31.col = Color.BLUE;  buildings2ChangeColorRect31.grayCol = grayGreen;
			buildings2ChangeColorRect32.col = Color.BLUE;  buildings2ChangeColorRect32.grayCol = grayGreen;
			buildings2ChangeColorRect33.col = Color.BLUE;  buildings2ChangeColorRect33.grayCol = grayGreen;
			buildings2ChangeColorRect34.col = Color.BLUE;  buildings2ChangeColorRect34.grayCol = grayGreen;
			buildings2ChangeColorRect35.col = Color.BLUE;  buildings2ChangeColorRect35.grayCol = grayGreen;
			buildings2ChangeColorRect36.col = Color.BLUE;  buildings2ChangeColorRect36.grayCol = grayGreen;
			buildings2ChangeColorRect37.col = Color.BLUE;  buildings2ChangeColorRect37.grayCol = grayGreen;
			buildings2ChangeColorRect38.col = Color.BLUE;  buildings2ChangeColorRect38.grayCol = grayGreen;
			buildings2ChangeColorRect39.col = Color.BLUE;  buildings2ChangeColorRect39.grayCol = grayGreen;
			buildings2ChangeColorRect40.col = Color.BLUE;  buildings2ChangeColorRect40.grayCol = grayGreen;
			buildings2ChangeColorRect41.col = Color.BLUE;  buildings2ChangeColorRect41.grayCol = grayGreen;
			buildings2ChangeColorRect42.col = Color.BLUE;  buildings2ChangeColorRect42.grayCol = grayGreen;
			buildings2ChangeColorRect43.col = Color.BLUE;  buildings2ChangeColorRect43.grayCol = grayGreen;
			buildings2ChangeColorRect44.col = Color.BLUE;  buildings2ChangeColorRect44.grayCol = grayGreen;
			buildings2ChangeColorRect45.col = Color.BLUE;  buildings2ChangeColorRect45.grayCol = grayGreen;
			buildings2ChangeColorRect46.col = Color.BLUE;  buildings2ChangeColorRect46.grayCol = grayGreen;
			buildings2ChangeColorRect47.col = Color.BLUE;  buildings2ChangeColorRect47.grayCol = grayGreen;
			buildings2ChangeColorRect48.col = Color.BLUE;  buildings2ChangeColorRect48.grayCol = grayGreen;
			buildings2ChangeColorRect49.col = Color.BLUE;  buildings2ChangeColorRect49.grayCol = grayGreen;
			buildings2ChangeColorRect50.col = Color.BLUE;  buildings2ChangeColorRect50.grayCol = grayGreen;
			buildings2ChangeColorRect51.col = Color.BLUE;  buildings2ChangeColorRect51.grayCol = grayGreen;
			buildings2ChangeColorRect52.col = Color.BLUE;  buildings2ChangeColorRect52.grayCol = grayGreen;
			buildings2ChangeColorRect53.col = Color.BLUE;  buildings2ChangeColorRect53.grayCol = grayGreen;
			buildings2ChangeColorRect53a.col = Color.BLUE;
			buildings2ChangeColorRect54.col = Color.BLUE;  buildings2ChangeColorRect54.grayCol = grayGreen;
			buildings2ChangeColorRect55.col = Color.BLUE;  buildings2ChangeColorRect55.grayCol = grayGreen;
			buildings2ChangeColorRect56.col = Color.BLUE;  buildings2ChangeColorRect56.grayCol = grayGreen;
			buildings2ChangeColorRect57.col = Color.BLUE;  buildings2ChangeColorRect57.grayCol = grayGreen;
			buildings2ChangeColorRect58.col = Color.BLUE;  buildings2ChangeColorRect58.grayCol = grayGreen;
			buildings2ChangeColorRect59.col = Color.BLUE;  buildings2ChangeColorRect59.grayCol = grayGreen;
			buildings2ChangeColorRect60.col = Color.BLUE;  buildings2ChangeColorRect60.grayCol = grayGreen;
			buildings2ChangeColorRect61.col = Color.BLUE;  buildings2ChangeColorRect61.grayCol = grayGreen;
			buildings2ChangeColorRect62.col = Color.BLUE;  buildings2ChangeColorRect62.grayCol = grayGreen;
			buildings2ChangeColorRect63.col = Color.BLUE;  buildings2ChangeColorRect63.grayCol = grayGreen;
			buildings2ChangeColorRect64.col = Color.BLUE;  buildings2ChangeColorRect64.grayCol = grayGreen;
			buildings2ChangeColorRect65.col = Color.BLUE;  buildings2ChangeColorRect65.grayCol = grayGreen;
			buildings2ChangeColorRect66.col = Color.BLUE;  buildings2ChangeColorRect66.grayCol = grayGreen;
			buildings2ChangeColorRect67.col = Color.BLUE;  buildings2ChangeColorRect67.grayCol = grayGreen;
			buildings2ChangeColorRect68.col = Color.BLUE;  buildings2ChangeColorRect68.grayCol = grayGreen;
			buildings2ChangeColorRect69.col = Color.BLUE;  buildings2ChangeColorRect69.grayCol = grayGreen;
			buildings2ChangeColorRect70.col = Color.BLUE;  buildings2ChangeColorRect70.grayCol = grayGreen;
			buildings2ChangeColorRect71.col = Color.BLUE;  buildings2ChangeColorRect71.grayCol = grayGreen;
			buildings2ChangeColorRect72.col = Color.BLUE;  buildings2ChangeColorRect72.grayCol = grayGreen;
			buildings2ChangeColorRect73.col = Color.BLUE;  buildings2ChangeColorRect73.grayCol = grayGreen;
			buildings2ChangeColorRect74.col = Color.BLUE;  buildings2ChangeColorRect74.grayCol = grayGreen;
			buildings2ChangeColorRect75.col = Color.BLUE;  buildings2ChangeColorRect75.grayCol = grayGreen;
			buildings2ChangeColorRect76.col = Color.BLUE;  buildings2ChangeColorRect76.grayCol = grayGreen;
			buildings2ChangeColorRect77.col = Color.BLUE;  buildings2ChangeColorRect77.grayCol = grayGreen;
			buildings2ChangeColorRect78.col = Color.BLUE;  buildings2ChangeColorRect78.grayCol = grayGreen;
			buildings2ChangeColorRect79.col = Color.BLUE;  buildings2ChangeColorRect79.grayCol = grayGreen;
			buildings2ChangeColorRect80.col = Color.BLUE;  buildings2ChangeColorRect80.grayCol = grayGreen;
			buildings2ChangeColorRect81.col = Color.BLUE;  buildings2ChangeColorRect81.grayCol = grayGreen;
			buildings2ChangeColorRect82.col = Color.BLUE;  buildings2ChangeColorRect82.grayCol = grayGreen;
			buildings2ChangeColorRect83.col = Color.BLUE;  buildings2ChangeColorRect83.grayCol = grayGreen;
			buildings2ChangeColorRect84.col = Color.BLUE;  buildings2ChangeColorRect84.grayCol = grayGreen;
			buildings2ChangeColorRect85.col = Color.BLUE;  buildings2ChangeColorRect85.grayCol = grayGreen;
			buildings2ChangeColorRect86.col = Color.BLUE;  buildings2ChangeColorRect86.grayCol = grayGreen;
			buildings2ChangeColorRect87.col = Color.BLUE;  buildings2ChangeColorRect87.grayCol = grayGreen;
			buildings2ChangeColorRect88.col = Color.BLUE;  buildings2ChangeColorRect88.grayCol = grayGreen;
			buildings2ChangeColorRect89.col = Color.BLUE;  buildings2ChangeColorRect89.grayCol = grayGreen;
			buildings2ChangeColorRect90.col = Color.BLUE;  buildings2ChangeColorRect90.grayCol = grayGreen;
			buildings2ChangeColorRect91.col = Color.BLUE;  buildings2ChangeColorRect91.grayCol = grayGreen;
			buildings2ChangeColorRect92.col = Color.BLUE;  buildings2ChangeColorRect92.grayCol = grayGreen;
			buildings2ChangeColorRect93.col = Color.BLUE;  buildings2ChangeColorRect93.grayCol = grayGreen;
			buildings2ChangeColorRect94.col = Color.BLUE;  buildings2ChangeColorRect94.grayCol = grayGreen;
			buildings2ChangeColorRect95.col = Color.BLUE;  buildings2ChangeColorRect95.grayCol = grayGreen;
			buildings2ChangeColorRect96.col = Color.BLUE;  buildings2ChangeColorRect96.grayCol = grayGreen;
			buildings2ChangeColorRect97.col = Color.BLUE;  buildings2ChangeColorRect97.grayCol = grayGreen;
			buildings2ChangeColorRect98.col = Color.BLUE;  buildings2ChangeColorRect98.grayCol = grayGreen;
			buildings2ChangeColorRect99.col = Color.BLUE;  buildings2ChangeColorRect99.grayCol = grayGreen;
			buildings2ChangeColorRect100.col = Color.BLUE;  buildings2ChangeColorRect100.grayCol = grayGreen;
			buildings2ChangeColorRect101.col = Color.BLUE;  buildings2ChangeColorRect101.grayCol = grayGreen;
			buildings2ChangeColorRect102.col = Color.BLUE;  buildings2ChangeColorRect102.grayCol = grayGreen;
			buildings2ChangeColorRect103.col = Color.BLUE;  buildings2ChangeColorRect103.grayCol = grayGreen;
			buildings2ChangeColorRect104.col = Color.BLUE;  buildings2ChangeColorRect104.grayCol = grayGreen;
			buildings2ChangeColorRect105.col = Color.BLUE;  buildings2ChangeColorRect105.grayCol = grayGreen;
			buildings2ChangeColorRect106.col = Color.BLUE;  buildings2ChangeColorRect106.grayCol = grayGreen;
			buildings2ChangeColorRect107.col = Color.BLUE;  buildings2ChangeColorRect107.grayCol = grayGreen;
			buildings2ChangeColorRect108.col = Color.BLUE;  buildings2ChangeColorRect108.grayCol = grayGreen;
			buildings2ChangeColorRect109.col = Color.BLUE;  buildings2ChangeColorRect109.grayCol = grayGreen;
			buildings2ChangeColorRect110.col = Color.BLUE;  buildings2ChangeColorRect110.grayCol = grayGreen;
			buildings2ChangeColorRect111.col = Color.BLUE;  buildings2ChangeColorRect111.grayCol = grayGreen;
			buildings2ChangeColorRect112.col = Color.BLUE;  buildings2ChangeColorRect112.grayCol = grayGreen;
			buildings2ChangeColorRect113.col = Color.BLUE;  buildings2ChangeColorRect113.grayCol = grayGreen;
			buildings2ChangeColorRect114.col = Color.BLUE;  buildings2ChangeColorRect114.grayCol = grayGreen;
			buildings2ChangeColorRect115.col = Color.BLUE;  buildings2ChangeColorRect115.grayCol = grayGreen;
			buildings2ChangeColorRect116.col = Color.BLUE;  buildings2ChangeColorRect116.grayCol = grayGreen;
			buildings2ChangeColorRect117.col = Color.BLUE;  buildings2ChangeColorRect117.grayCol = grayGreen;
			buildings2ChangeColorRect118.col = Color.BLUE;  buildings2ChangeColorRect118.grayCol = grayGreen;
			buildings2ChangeColorRect119.col = Color.BLUE;  buildings2ChangeColorRect119.grayCol = grayGreen;
			buildings2ChangeColorRect120.col = Color.BLUE;  buildings2ChangeColorRect120.grayCol = grayGreen;
			buildings2ChangeColorRect121.col = Color.BLUE;  buildings2ChangeColorRect121.grayCol = grayGreen;
			buildings2ChangeColorRect122.col = Color.BLUE;  buildings2ChangeColorRect122.grayCol = grayGreen;
			buildings2ChangeColorRect123.col = Color.BLUE;  buildings2ChangeColorRect123.grayCol = grayGreen;
			buildings2ChangeColorRect124.col = Color.BLUE;  buildings2ChangeColorRect124.grayCol = grayGreen;
			buildings2ChangeColorRect125.col = Color.BLUE;  buildings2ChangeColorRect125.grayCol = grayGreen;
			buildings2ChangeColorRect126.col = Color.BLUE;  buildings2ChangeColorRect126.grayCol = grayGreen;
			buildings2ChangeColorRect127.col = Color.BLUE;  buildings2ChangeColorRect127.grayCol = grayGreen;
			buildings2ChangeColorRect128.col = Color.BLUE;  buildings2ChangeColorRect128.grayCol = grayGreen;
			buildings2ChangeColorRect129.col = Color.BLUE;  buildings2ChangeColorRect129.grayCol = grayGreen;
			buildings2ChangeColorRect130.col = Color.BLUE;  buildings2ChangeColorRect130.grayCol = grayGreen;
			buildings2ChangeColorRect131.col = Color.BLUE;  buildings2ChangeColorRect131.grayCol = grayGreen;
			buildings2ChangeColorRect132.col = Color.BLUE;  buildings2ChangeColorRect132.grayCol = grayGreen;
			buildings2ChangeColorRect133.col = Color.BLUE;  buildings2ChangeColorRect133.grayCol = grayGreen;
			buildings2ChangeColorRect134.col = Color.BLUE;  buildings2ChangeColorRect134.grayCol = grayGreen;
			buildings2ChangeColorRect135.col = Color.BLUE;  buildings2ChangeColorRect135.grayCol = grayGreen;
			buildings2ChangeColorRect136.col = Color.BLUE;  buildings2ChangeColorRect136.grayCol = grayGreen;
			buildings2ChangeColorRect137.col = Color.BLUE;  buildings2ChangeColorRect137.grayCol = grayGreen;
			buildings2ChangeColorRect138.col = Color.BLUE;  buildings2ChangeColorRect138.grayCol = grayGreen;
			buildings2ChangeColorRect139.col = Color.BLUE;  buildings2ChangeColorRect139.grayCol = grayGreen;
			buildings2ChangeColorRect140.col = Color.BLUE;  buildings2ChangeColorRect140.grayCol = grayGreen;
			buildings2ChangeColorRect141.col = Color.BLUE;  buildings2ChangeColorRect141.grayCol = grayGreen;
			buildings2ChangeColorRect142.col = Color.BLUE;  buildings2ChangeColorRect142.grayCol = grayGreen;
			buildings2ChangeColorRect143.col = Color.BLUE;  buildings2ChangeColorRect143.grayCol = grayGreen;
			buildings2ChangeColorRect144.col = Color.BLUE;  buildings2ChangeColorRect144.grayCol = grayGreen;
			buildings2ChangeColorRect145.col = Color.BLUE;  buildings2ChangeColorRect145.grayCol = grayGreen;
			buildings2ChangeColorRect146.col = Color.BLUE;  buildings2ChangeColorRect146.grayCol = grayGreen;
			buildings2ChangeColorRect147.col = Color.BLUE;  buildings2ChangeColorRect147.grayCol = grayGreen;
			buildings2ChangeColorRect148.col = Color.BLUE;  buildings2ChangeColorRect148.grayCol = grayGreen;
			buildings2ChangeColorRect149.col = Color.BLUE;  buildings2ChangeColorRect149.grayCol = grayGreen;
			buildings2ChangeColorRect150.col = Color.BLUE;  buildings2ChangeColorRect150.grayCol = grayGreen;
			buildings2ChangeColorRect151.col = Color.BLUE;  buildings2ChangeColorRect151.grayCol = grayGreen;
			buildings2ChangeColorRect152.col = Color.BLUE;  buildings2ChangeColorRect152.grayCol = grayGreen;
			buildings2ChangeColorRect153.col = Color.BLUE;  buildings2ChangeColorRect153.grayCol = grayGreen;
			buildings2ChangeColorRect154.col = Color.BLUE;  buildings2ChangeColorRect154.grayCol = grayGreen;
			buildings2ChangeColorRect155.col = Color.BLUE;  buildings2ChangeColorRect155.grayCol = grayGreen;
			buildings2ChangeColorRect156.col = Color.BLUE;  buildings2ChangeColorRect156.grayCol = grayGreen;
			buildings2ChangeColorRect157.col = Color.BLUE;  buildings2ChangeColorRect157.grayCol = grayGreen;
			buildings2ChangeColorRect158.col = Color.BLUE;  buildings2ChangeColorRect158.grayCol = grayGreen;
			buildings2ChangeColorRect159.col = Color.BLUE;  buildings2ChangeColorRect159.grayCol = grayGreen;
			buildings2ChangeColorRect160.col = Color.BLUE;  buildings2ChangeColorRect160.grayCol = grayGreen;
			buildings2ChangeColorRect161.col = Color.BLUE;  buildings2ChangeColorRect161.grayCol = grayGreen;
			buildings2ChangeColorRect162.col = Color.BLUE;  buildings2ChangeColorRect162.grayCol = grayGreen;
			buildings2ChangeColorRect163.col = Color.BLUE;  buildings2ChangeColorRect163.grayCol = grayGreen;
			buildings2ChangeColorRect164.col = Color.BLUE;  buildings2ChangeColorRect164.grayCol = grayGreen;
			buildings2ChangeColorRect165.col = Color.BLUE;  buildings2ChangeColorRect165.grayCol = grayGreen;
			buildings2ChangeColorRect166.col = Color.BLUE;  buildings2ChangeColorRect166.grayCol = grayGreen;
			buildings2ChangeColorRect167.col = Color.BLUE;  buildings2ChangeColorRect167.grayCol = grayGreen;
			buildings2ChangeColorRect168.col = Color.BLUE;  buildings2ChangeColorRect168.grayCol = grayGreen;
			buildings2ChangeColorRect169.col = Color.BLUE;  buildings2ChangeColorRect169.grayCol = grayGreen;
			buildings2ChangeColorRect170.col = Color.BLUE;  buildings2ChangeColorRect170.grayCol = grayGreen;
			buildings2ChangeColorRect171.col = Color.BLUE;  buildings2ChangeColorRect171.grayCol = grayGreen;
			buildings2ChangeColorRect172.col = Color.BLUE;  buildings2ChangeColorRect172.grayCol = grayGreen;
			buildings2ChangeColorRect173.col = Color.BLUE;  buildings2ChangeColorRect173.grayCol = grayGreen;
			buildings2ChangeColorRect174.col = Color.BLUE;  buildings2ChangeColorRect174.grayCol = grayGreen;
			buildings2ChangeColorRect175.col = Color.BLUE;  buildings2ChangeColorRect175.grayCol = grayGreen;
			buildings2ChangeColorRect176.col = Color.BLUE;  buildings2ChangeColorRect176.grayCol = grayGreen;
			buildings2ChangeColorRect177.col = Color.BLUE;  buildings2ChangeColorRect177.grayCol = grayGreen;
			buildings2ChangeColorRect178.col = Color.BLUE;  buildings2ChangeColorRect178.grayCol = grayGreen;
			buildings2ChangeColorRect179.col = Color.BLUE;  buildings2ChangeColorRect179.grayCol = grayGreen;
			buildings2ChangeColorRect180.col = Color.BLUE;  buildings2ChangeColorRect180.grayCol = grayGreen;
			buildings2ChangeColorRect181.col = Color.BLUE;  buildings2ChangeColorRect181.grayCol = grayGreen;
			buildings2ChangeColorRect182.col = Color.BLUE;  buildings2ChangeColorRect182.grayCol = grayGreen;
			buildings2ChangeColorRect183.col = Color.BLUE;  buildings2ChangeColorRect183.grayCol = grayGreen;
			buildings2ChangeColorRect184.col = Color.BLUE;  buildings2ChangeColorRect184.grayCol = grayGreen;
			buildings2ChangeColorRect185.col = Color.BLUE;  buildings2ChangeColorRect185.grayCol = grayGreen;
			buildings2ChangeColorRect186.col = Color.BLUE;  buildings2ChangeColorRect186.grayCol = grayGreen;
			buildings2ChangeColorRect187.col = Color.BLUE;  buildings2ChangeColorRect187.grayCol = grayGreen;
			buildings2ChangeColorRect188.col = Color.BLUE;  buildings2ChangeColorRect188.grayCol = grayGreen;
			buildings2ChangeColorRect189.col = Color.BLUE;  buildings2ChangeColorRect189.grayCol = grayGreen;
			buildings2ChangeColorRect190.col = Color.BLUE;  buildings2ChangeColorRect190.grayCol = grayGreen;
			buildings2ChangeColorRect191.col = Color.BLUE;  buildings2ChangeColorRect191.grayCol = grayGreen;
			buildings2ChangeColorRect192.col = Color.BLUE;  buildings2ChangeColorRect192.grayCol = grayGreen;
			buildings2ChangeColorRect193.col = Color.BLUE;  buildings2ChangeColorRect193.grayCol = grayGreen;
			buildings2ChangeColorRect194.col = Color.BLUE;  buildings2ChangeColorRect194.grayCol = grayGreen;
			buildings2ChangeColorRect195.col = Color.BLUE;  buildings2ChangeColorRect195.grayCol = grayGreen;
			buildings2ChangeColorRect196.col = Color.BLUE;  buildings2ChangeColorRect196.grayCol = grayGreen;
			buildings2ChangeColorRect197.col = Color.BLUE;  buildings2ChangeColorRect197.grayCol = grayGreen;
			buildings2ChangeColorRect198.col = Color.BLUE;  buildings2ChangeColorRect198.grayCol = grayGreen;
			buildings2ChangeColorRect199.col = Color.BLUE;  buildings2ChangeColorRect199.grayCol = grayGreen;
			buildings2ChangeColorRect200.col = Color.BLUE;  buildings2ChangeColorRect200.grayCol = grayGreen;
			buildings2ChangeColorRect201.col = Color.BLUE;  buildings2ChangeColorRect201.grayCol = grayGreen;
			buildings2ChangeColorRect202.col = Color.BLUE;  buildings2ChangeColorRect202.grayCol = grayGreen;
			buildings2ChangeColorRect203.col = Color.BLUE;  buildings2ChangeColorRect203.grayCol = grayGreen;
			buildings2ChangeColorRect204.col = Color.BLUE;  buildings2ChangeColorRect204.grayCol = grayGreen;
			buildings2ChangeColorRect205.col = Color.BLUE;  buildings2ChangeColorRect205.grayCol = grayGreen;
			buildings2ChangeColorRect206.col = Color.BLUE;  buildings2ChangeColorRect206.grayCol = grayGreen;
			buildings2ChangeColorRect207.col = Color.BLUE;  buildings2ChangeColorRect207.grayCol = grayGreen;
			buildings2ChangeColorRect208.col = Color.BLUE;  buildings2ChangeColorRect208.grayCol = grayGreen;
			buildings2ChangeColorRect209.col = Color.BLUE;  buildings2ChangeColorRect209.grayCol = grayGreen;
			buildings2ChangeColorRect210.col = Color.BLUE;  buildings2ChangeColorRect210.grayCol = grayGreen;
			buildings2ChangeColorRect211.col = Color.BLUE;  buildings2ChangeColorRect211.grayCol = grayGreen;
			buildings2ChangeColorRect212.col = Color.BLUE;  buildings2ChangeColorRect212.grayCol = grayGreen;
			buildings2ChangeColorRect213.col = Color.BLUE;  buildings2ChangeColorRect213.grayCol = grayGreen;
			buildings2ChangeColorRect214.col = Color.BLUE;  buildings2ChangeColorRect214.grayCol = grayGreen;
			buildings2ChangeColorRect215.col = Color.BLUE;  buildings2ChangeColorRect215.grayCol = grayGreen;
			buildings2ChangeColorRect216.col = Color.BLUE;  buildings2ChangeColorRect216.grayCol = grayGreen;
			buildings2ChangeColorRect217.col = Color.BLUE;  buildings2ChangeColorRect217.grayCol = grayGreen;
			buildings2ChangeColorRect218.col = Color.BLUE;  buildings2ChangeColorRect218.grayCol = grayGreen;
			buildings2ChangeColorRect219.col = Color.BLUE;  buildings2ChangeColorRect219.grayCol = grayGreen;
			buildings2ChangeColorRect220.col = Color.BLUE;  buildings2ChangeColorRect220.grayCol = grayGreen;
			buildings2ChangeColorRect221.col = Color.BLUE;  buildings2ChangeColorRect221.grayCol = grayGreen;
			buildings2ChangeColorRect222.col = Color.BLUE;  buildings2ChangeColorRect222.grayCol = grayGreen;
			buildings2ChangeColorRect223.col = Color.BLUE;  buildings2ChangeColorRect223.grayCol = grayGreen;
			buildings2ChangeColorRect224.col = Color.BLUE;  buildings2ChangeColorRect224.grayCol = grayGreen;
			buildings2ChangeColorRect225.col = Color.BLUE;  buildings2ChangeColorRect225.grayCol = grayGreen;
			buildings2ChangeColorRect226.col = Color.BLUE;  buildings2ChangeColorRect226.grayCol = grayGreen;
			buildings2ChangeColorRect227.col = Color.BLUE;  buildings2ChangeColorRect227.grayCol = grayGreen;
			buildings2ChangeColorRect228.col = Color.BLUE;  buildings2ChangeColorRect228.grayCol = grayGreen;
			buildings2ChangeColorRect229.col = Color.BLUE;  buildings2ChangeColorRect229.grayCol = grayGreen;
			buildings2ChangeColorRect230.col = Color.BLUE;  buildings2ChangeColorRect230.grayCol = grayGreen;
			buildings2ChangeColorRect231.col = Color.BLUE;  buildings2ChangeColorRect231.grayCol = grayGreen;
			buildings2ChangeColorRect232.col = Color.BLUE;  buildings2ChangeColorRect232.grayCol = grayGreen;
			buildings2ChangeColorRect233.col = Color.BLUE;  buildings2ChangeColorRect233.grayCol = grayGreen;
			buildings2ChangeColorRect234.col = Color.BLUE;  buildings2ChangeColorRect234.grayCol = grayGreen;
			buildings2ChangeColorRect235.col = Color.BLUE;  buildings2ChangeColorRect235.grayCol = grayGreen;
			buildings2ChangeColorRect236.col = Color.BLUE;  buildings2ChangeColorRect236.grayCol = grayGreen;
			buildings2ChangeColorRect237.col = Color.BLUE;  buildings2ChangeColorRect237.grayCol = grayGreen;
			buildings2ChangeColorRect238.col = Color.BLUE;  buildings2ChangeColorRect238.grayCol = grayGreen;
			buildings2ChangeColorRect239.col = Color.BLUE;  buildings2ChangeColorRect239.grayCol = grayGreen;
			buildings2ChangeColorRect240.col = Color.BLUE;  buildings2ChangeColorRect240.grayCol = grayGreen;
			buildings2ChangeColorRect241.col = Color.BLUE;  buildings2ChangeColorRect241.grayCol = grayGreen;
			buildings2ChangeColorRect242.col = Color.BLUE;  buildings2ChangeColorRect242.grayCol = grayGreen;
			buildings2ChangeColorRect243.col = Color.BLUE;  buildings2ChangeColorRect243.grayCol = grayGreen;
			buildings2ChangeColorRect244.col = Color.BLUE;  buildings2ChangeColorRect244.grayCol = grayGreen;
			buildings2ChangeColorRect245.col = Color.BLUE;  buildings2ChangeColorRect245.grayCol = grayGreen;
			buildings2ChangeColorRect246.col = Color.BLUE;  buildings2ChangeColorRect246.grayCol = grayGreen;
			buildings2ChangeColorRect247.col = Color.BLUE;  buildings2ChangeColorRect247.grayCol = grayGreen;
			buildings2ChangeColorRect248.col = Color.BLUE;  buildings2ChangeColorRect248.grayCol = grayGreen;
			buildings2ChangeColorRect249.col = Color.BLUE;  buildings2ChangeColorRect249.grayCol = grayGreen;
			buildings2ChangeColorRect250.col = Color.BLUE;  buildings2ChangeColorRect250.grayCol = grayGreen;
			buildings2ChangeColorRect251.col = Color.BLUE;  buildings2ChangeColorRect251.grayCol = grayGreen;
			buildings2ChangeColorRect252.col = Color.BLUE;  buildings2ChangeColorRect252.grayCol = grayGreen;
			buildings2ChangeColorRect253.col = Color.BLUE;  buildings2ChangeColorRect253.grayCol = grayGreen;
			buildings2ChangeColorRect254.col = Color.BLUE;  buildings2ChangeColorRect254.grayCol = grayGreen;
			buildings2ChangeColorRect255.col = Color.BLUE;  buildings2ChangeColorRect255.grayCol = grayGreen;
			buildings2ChangeColorRect256.col = Color.BLUE;  buildings2ChangeColorRect256.grayCol = grayGreen;
			buildings2ChangeColorRect257.col = Color.BLUE;  buildings2ChangeColorRect257.grayCol = grayGreen;
			buildings2ChangeColorRect258.col = Color.BLUE;  buildings2ChangeColorRect258.grayCol = grayGreen;
			buildings2ChangeColorRect259.col = Color.BLUE;  buildings2ChangeColorRect259.grayCol = grayGreen;
			buildings2ChangeColorRect260.col = Color.BLUE;  buildings2ChangeColorRect260.grayCol = grayGreen;
			buildings2ChangeColorRect261.col = Color.BLUE;  buildings2ChangeColorRect261.grayCol = grayGreen;
			buildings2ChangeColorRect262.col = Color.BLUE;  buildings2ChangeColorRect262.grayCol = grayGreen;
			buildings2ChangeColorRect263.col = Color.BLUE;  buildings2ChangeColorRect263.grayCol = grayGreen;
			buildings2ChangeColorRect264.col = Color.BLUE;  buildings2ChangeColorRect264.grayCol = grayGreen;
			buildings2ChangeColorRect265.col = Color.BLUE;  buildings2ChangeColorRect265.grayCol = grayGreen;
			buildings2ChangeColorRect266.col = Color.BLUE;  buildings2ChangeColorRect266.grayCol = grayGreen;
			buildings2ChangeColorRect267.col = Color.BLUE;  buildings2ChangeColorRect267.grayCol = grayGreen;
			buildings2ChangeColorRect268.col = Color.BLUE;  buildings2ChangeColorRect268.grayCol = grayGreen;
			buildings2ChangeColorRect269.col = Color.BLUE;  buildings2ChangeColorRect269.grayCol = grayGreen;
			buildings2ChangeColorRect270.col = Color.BLUE;  buildings2ChangeColorRect270.grayCol = grayGreen;
			buildings2ChangeColorRect271.col = Color.BLUE;  buildings2ChangeColorRect271.grayCol = grayGreen;
			buildings2ChangeColorRect272.col = Color.BLUE;  buildings2ChangeColorRect272.grayCol = grayGreen;
			buildings2ChangeColorRect273.col = Color.BLUE;  buildings2ChangeColorRect273.grayCol = grayGreen;
			buildings2ChangeColorRect274.col = Color.BLUE;  buildings2ChangeColorRect274.grayCol = grayGreen;
			buildings2ChangeColorRect275.col = Color.BLUE;  buildings2ChangeColorRect275.grayCol = grayGreen;
			buildings2ChangeColorRect276.col = Color.BLUE;  buildings2ChangeColorRect276.grayCol = grayGreen;
			buildings2ChangeColorRect277.col = Color.BLUE;  buildings2ChangeColorRect277.grayCol = grayGreen;
			buildings2ChangeColorRect278.col = Color.BLUE;  buildings2ChangeColorRect278.grayCol = grayGreen;
			buildings2ChangeColorRect279.col = Color.BLUE;  buildings2ChangeColorRect279.grayCol = grayGreen;
			buildings2ChangeColorRect280.col = Color.BLUE;  buildings2ChangeColorRect280.grayCol = grayGreen;
			buildings2ChangeColorRect281.col = Color.BLUE;  buildings2ChangeColorRect281.grayCol = grayGreen;
			buildings2ChangeColorRect282.col = Color.BLUE;  buildings2ChangeColorRect282.grayCol = grayGreen;
			buildings2ChangeColorRect283.col = Color.BLUE;  buildings2ChangeColorRect283.grayCol = grayGreen;
			buildings2ChangeColorRect284.col = Color.BLUE;  buildings2ChangeColorRect284.grayCol = grayGreen;
			buildings2ChangeColorRect285.col = Color.BLUE;  buildings2ChangeColorRect285.grayCol = grayGreen;
			buildings2ChangeColorRect286.col = Color.BLUE;  buildings2ChangeColorRect286.grayCol = grayGreen;
			buildings2ChangeColorRect287.col = Color.BLUE;  buildings2ChangeColorRect287.grayCol = grayGreen;
			buildings2ChangeColorRect288.col = Color.BLUE;  buildings2ChangeColorRect288.grayCol = grayGreen;
			buildings2ChangeColorRect289.col = Color.BLUE;  buildings2ChangeColorRect289.grayCol = grayGreen;
			buildings2ChangeColorRect290.col = Color.BLUE;  buildings2ChangeColorRect290.grayCol = grayGreen;
			buildings2ChangeColorRect291.col = Color.BLUE;  buildings2ChangeColorRect291.grayCol = grayGreen;
			buildings2ChangeColorRect292.col = Color.BLUE;  buildings2ChangeColorRect292.grayCol = grayGreen;
			buildings2ChangeColorRect293.col = Color.BLUE;  buildings2ChangeColorRect293.grayCol = grayGreen;
			buildings2ChangeColorRect294.col = Color.BLUE;  buildings2ChangeColorRect294.grayCol = grayGreen;
			buildings2ChangeColorRect295.col = Color.BLUE;  buildings2ChangeColorRect295.grayCol = grayGreen;
			buildings2ChangeColorRect296.col = Color.BLUE;  buildings2ChangeColorRect296.grayCol = grayGreen;
			buildings2ChangeColorRect297.col = Color.BLUE;  buildings2ChangeColorRect297.grayCol = grayGreen;
			buildings2ChangeColorRect298.col = Color.BLUE;  buildings2ChangeColorRect298.grayCol = grayGreen;
			buildings2ChangeColorRect299.col = Color.BLUE;  buildings2ChangeColorRect299.grayCol = grayGreen;
			buildings2ChangeColorRect300.col = Color.BLUE;  buildings2ChangeColorRect300.grayCol = grayGreen;
			buildings2ChangeColorRect301.col = Color.BLUE;  buildings2ChangeColorRect301.grayCol = grayGreen;
			buildings2ChangeColorRect302.col = Color.BLUE;  buildings2ChangeColorRect302.grayCol = grayGreen;
			buildings2ChangeColorRect303.col = Color.BLUE;  buildings2ChangeColorRect303.grayCol = grayGreen;
			buildings2ChangeColorRect304.col = Color.BLUE;  buildings2ChangeColorRect304.grayCol = grayGreen;
			buildings2ChangeColorRect305.col = Color.BLUE;  buildings2ChangeColorRect305.grayCol = grayGreen;
			buildings2ChangeColorRect306.col = Color.BLUE;  buildings2ChangeColorRect306.grayCol = grayGreen;
			buildings2ChangeColorRect307.col = Color.BLUE;  buildings2ChangeColorRect307.grayCol = grayGreen;
			buildings2ChangeColorRect308.col = Color.BLUE;  buildings2ChangeColorRect308.grayCol = grayGreen;
			buildings2ChangeColorRect309.col = Color.BLUE;  buildings2ChangeColorRect309.grayCol = grayGreen;
			buildings2ChangeColorRect310.col = Color.BLUE;  buildings2ChangeColorRect310.grayCol = grayGreen;
			buildings2ChangeColorRect311.col = Color.BLUE;  buildings2ChangeColorRect311.grayCol = grayGreen;
			buildings2ChangeColorRect312.col = Color.BLUE;  buildings2ChangeColorRect312.grayCol = grayGreen;
			buildings2ChangeColorRect313.col = Color.BLUE;  buildings2ChangeColorRect313.grayCol = grayGreen;
			buildings2ChangeColorRect314.col = Color.BLUE;  buildings2ChangeColorRect314.grayCol = grayGreen;
			buildings2ChangeColorRect315.col = Color.BLUE;  buildings2ChangeColorRect315.grayCol = grayGreen;
			buildings2ChangeColorRect316.col = Color.BLUE;  buildings2ChangeColorRect316.grayCol = grayGreen;
			buildings2ChangeColorRect317.col = Color.BLUE;  buildings2ChangeColorRect317.grayCol = grayGreen;
			buildings2ChangeColorRect318.col = Color.BLUE;  buildings2ChangeColorRect318.grayCol = grayGreen;
			buildings2ChangeColorRect319.col = Color.BLUE;  buildings2ChangeColorRect319.grayCol = grayGreen;
			buildings2ChangeColorRect320.col = Color.BLUE;  buildings2ChangeColorRect320.grayCol = grayGreen;
			buildings2ChangeColorRect321.col = Color.BLUE;  buildings2ChangeColorRect321.grayCol = grayGreen;
			buildings2ChangeColorRect322.col = Color.BLUE;  buildings2ChangeColorRect322.grayCol = grayGreen;
			buildings2ChangeColorRect323.col = Color.BLUE;  buildings2ChangeColorRect323.grayCol = grayGreen;
			buildings2ChangeColorRect324.col = Color.BLUE;  buildings2ChangeColorRect324.grayCol = grayGreen;
			buildings2ChangeColorRect325.col = Color.BLUE;  buildings2ChangeColorRect325.grayCol = grayGreen;
			buildings2ChangeColorRect326.col = Color.BLUE;  buildings2ChangeColorRect326.grayCol = grayGreen;
			buildings2ChangeColorRect327.col = Color.BLUE;  buildings2ChangeColorRect327.grayCol = grayGreen;
			buildings2ChangeColorRect328.col = Color.BLUE;  buildings2ChangeColorRect328.grayCol = grayGreen;
			buildings2ChangeColorRect329.col = Color.BLUE;  buildings2ChangeColorRect329.grayCol = grayGreen;
			buildings2ChangeColorRect330.col = Color.BLUE;  buildings2ChangeColorRect330.grayCol = grayGreen;
			buildings2ChangeColorRect331.col = Color.BLUE;  buildings2ChangeColorRect331.grayCol = grayGreen;
			buildings2ChangeColorRect332.col = Color.BLUE;  buildings2ChangeColorRect332.grayCol = grayGreen;
			buildings2ChangeColorRect333.col = Color.BLUE;  buildings2ChangeColorRect333.grayCol = grayGreen;
			buildings2ChangeColorRect334.col = Color.BLUE;  buildings2ChangeColorRect334.grayCol = grayGreen;
			buildings2ChangeColorRect335.col = Color.BLUE;  buildings2ChangeColorRect335.grayCol = grayGreen;
			buildings2ChangeColorRect336.col = Color.BLUE;  buildings2ChangeColorRect336.grayCol = grayGreen;
			buildings2ChangeColorRect337.col = Color.BLUE;  buildings2ChangeColorRect337.grayCol = grayGreen;
			buildings2ChangeColorRect338.col = Color.BLUE;  buildings2ChangeColorRect338.grayCol = grayGreen;
			buildings2ChangeColorRect339.col = Color.BLUE;  buildings2ChangeColorRect339.grayCol = grayGreen;
			buildings2ChangeColorRect340.col = Color.BLUE;  buildings2ChangeColorRect340.grayCol = grayGreen;
			buildings2ChangeColorRect341.col = Color.BLUE;  buildings2ChangeColorRect341.grayCol = grayGreen;
			buildings2ChangeColorRect342.col = Color.BLUE;  buildings2ChangeColorRect342.grayCol = grayGreen;
			buildings2ChangeColorRect343.col = Color.BLUE;  buildings2ChangeColorRect343.grayCol = grayGreen;
			buildings2ChangeColorRect344.col = Color.BLUE;  buildings2ChangeColorRect344.grayCol = grayGreen;
			buildings2ChangeColorRect345.col = Color.BLUE;  buildings2ChangeColorRect345.grayCol = grayGreen;
			buildings2ChangeColorRect346.col = Color.BLUE;  buildings2ChangeColorRect346.grayCol = grayGreen;
			buildings2ChangeColorRect347.col = Color.BLUE;  buildings2ChangeColorRect347.grayCol = grayGreen;
			buildings2ChangeColorRect348.col = Color.BLUE;  buildings2ChangeColorRect348.grayCol = grayGreen;
			buildings2ChangeColorRect349.col = Color.BLUE;  buildings2ChangeColorRect349.grayCol = grayGreen;
			buildings2ChangeColorRect350.col = Color.BLUE;  buildings2ChangeColorRect350.grayCol = grayGreen;
			buildings2ChangeColorRect351.col = Color.BLUE;  buildings2ChangeColorRect351.grayCol = grayGreen;
			buildings2ChangeColorRect352.col = Color.BLUE;  buildings2ChangeColorRect352.grayCol = grayGreen;
			buildings2ChangeColorRect353.col = Color.BLUE;  buildings2ChangeColorRect353.grayCol = grayGreen;
			buildings2ChangeColorRect354.col = Color.BLUE;  buildings2ChangeColorRect354.grayCol = grayGreen;
			buildings2ChangeColorRect355.col = Color.BLUE;  buildings2ChangeColorRect355.grayCol = grayGreen;
			buildings2ChangeColorRect356.col = Color.BLUE;  buildings2ChangeColorRect356.grayCol = grayGreen;
			buildings2ChangeColorRect357.col = Color.BLUE;  buildings2ChangeColorRect357.grayCol = grayGreen;
			buildings2ChangeColorRect358.col = Color.BLUE;  buildings2ChangeColorRect358.grayCol = grayGreen;
			buildings2ChangeColorRect359.col = Color.BLUE;  buildings2ChangeColorRect359.grayCol = grayGreen;
			buildings2ChangeColorRect360.col = Color.BLUE;  buildings2ChangeColorRect360.grayCol = grayGreen;
			buildings2ChangeColorRect361.col = Color.BLUE;  buildings2ChangeColorRect361.grayCol = grayGreen;
			buildings2ChangeColorRect362.col = Color.BLUE;  buildings2ChangeColorRect362.grayCol = grayGreen;
			buildings2ChangeColorRect363.col = Color.BLUE;  buildings2ChangeColorRect363.grayCol = grayGreen;
			buildings2ChangeColorRect364.col = Color.BLUE;  buildings2ChangeColorRect364.grayCol = grayGreen;
			buildings2ChangeColorRect365.col = Color.BLUE;  buildings2ChangeColorRect365.grayCol = grayGreen;
			buildings2ChangeColorRect366.col = Color.BLUE;  buildings2ChangeColorRect366.grayCol = grayGreen;
			buildings2ChangeColorRect367.col = Color.BLUE;  buildings2ChangeColorRect367.grayCol = grayGreen;
			buildings2ChangeColorRect368.col = Color.BLUE;  buildings2ChangeColorRect368.grayCol = grayGreen;
			buildings2ChangeColorRect369.col = Color.BLUE;  buildings2ChangeColorRect369.grayCol = grayGreen;
			buildings2ChangeColorRect370.col = Color.BLUE;  buildings2ChangeColorRect370.grayCol = grayGreen;
			buildings2ChangeColorRect371.col = Color.BLUE;  buildings2ChangeColorRect371.grayCol = grayGreen;
			buildings2ChangeColorRect372.col = Color.BLUE;  buildings2ChangeColorRect372.grayCol = grayGreen;
			buildings2ChangeColorRect373.col = Color.BLUE;  buildings2ChangeColorRect373.grayCol = grayGreen;
			buildings2ChangeColorRect374.col = Color.BLUE;  buildings2ChangeColorRect374.grayCol = grayGreen;
			buildings2ChangeColorRect375.col = Color.BLUE;  buildings2ChangeColorRect375.grayCol = grayGreen;
			buildings2ChangeColorRect376.col = Color.BLUE;  buildings2ChangeColorRect376.grayCol = grayGreen;
			buildings2ChangeColorRect377.col = Color.BLUE;  buildings2ChangeColorRect377.grayCol = grayGreen;
			buildings2ChangeColorRect378.col = Color.BLUE;  buildings2ChangeColorRect378.grayCol = grayGreen;
			buildings2ChangeColorRect379.col = Color.BLUE;  buildings2ChangeColorRect379.grayCol = grayGreen;
			buildings2ChangeColorRect380.col = Color.BLUE;  buildings2ChangeColorRect380.grayCol = grayGreen;
			buildings2ChangeColorRect381.col = Color.BLUE;  buildings2ChangeColorRect381.grayCol = grayGreen;
			buildings2ChangeColorRect382.col = Color.BLUE;  buildings2ChangeColorRect382.grayCol = grayGreen;
			buildings2ChangeColorRect383.col = Color.BLUE;  buildings2ChangeColorRect383.grayCol = grayGreen;
			buildings2ChangeColorRect384.col = Color.BLUE;  buildings2ChangeColorRect384.grayCol = grayGreen;
			buildings2ChangeColorRect385.col = Color.BLUE;  buildings2ChangeColorRect385.grayCol = grayGreen;
			buildings2ChangeColorRect386.col = Color.BLUE;  buildings2ChangeColorRect386.grayCol = grayGreen;
			buildings2ChangeColorRect387.col = Color.BLUE;  buildings2ChangeColorRect387.grayCol = grayGreen;
			buildings2ChangeColorRect388.col = Color.BLUE;  buildings2ChangeColorRect388.grayCol = grayGreen;
			buildings2ChangeColorRect389.col = Color.BLUE;  buildings2ChangeColorRect389.grayCol = grayGreen;
			buildings2ChangeColorRect390.col = Color.BLUE;  buildings2ChangeColorRect390.grayCol = grayGreen;
			buildings2ChangeColorRect391.col = Color.BLUE;  buildings2ChangeColorRect391.grayCol = grayGreen;
			buildings2ChangeColorRect392.col = Color.BLUE;  buildings2ChangeColorRect392.grayCol = grayGreen;
			buildings2ChangeColorRect393.col = Color.BLUE;  buildings2ChangeColorRect393.grayCol = grayGreen;
			buildings2ChangeColorRect394.col = Color.BLUE;  buildings2ChangeColorRect394.grayCol = grayGreen;
			buildings2ChangeColorRect395.col = Color.BLUE;  buildings2ChangeColorRect395.grayCol = grayGreen;
			buildings2ChangeColorRect396.col = Color.BLUE;  buildings2ChangeColorRect396.grayCol = grayGreen;
			buildings2ChangeColorRect397.col = Color.BLUE;  buildings2ChangeColorRect397.grayCol = grayGreen;
			buildings2ChangeColorRect398.col = Color.BLUE;  buildings2ChangeColorRect398.grayCol = grayGreen;
			buildings2ChangeColorRect399.col = Color.BLUE;  buildings2ChangeColorRect399.grayCol = grayGreen;
			buildings2ChangeColorRect400.col = Color.BLUE;  buildings2ChangeColorRect400.grayCol = grayGreen;
			buildings2ChangeColorRect401.col = Color.BLUE;  buildings2ChangeColorRect401.grayCol = grayGreen;
			buildings2ChangeColorRect402.col = Color.BLUE;  buildings2ChangeColorRect402.grayCol = grayGreen;
			buildings2ChangeColorRect403.col = Color.BLUE;  buildings2ChangeColorRect403.grayCol = grayGreen;
			buildings2ChangeColorRect404.col = Color.BLUE;  buildings2ChangeColorRect404.grayCol = grayGreen;
			buildings2ChangeColorRect405.col = Color.BLUE;  buildings2ChangeColorRect405.grayCol = grayGreen;
			buildings2ChangeColorRect406.col = Color.BLUE;  buildings2ChangeColorRect406.grayCol = grayGreen;
			buildings2ChangeColorRect407.col = Color.BLUE;  buildings2ChangeColorRect407.grayCol = grayGreen;
			buildings2ChangeColorRect408.col = Color.BLUE;  buildings2ChangeColorRect408.grayCol = grayGreen;
			buildings2ChangeColorRect409.col = Color.BLUE;  buildings2ChangeColorRect409.grayCol = grayGreen;
			buildings2ChangeColorRect410.col = Color.BLUE;  buildings2ChangeColorRect410.grayCol = grayGreen;
			buildings2ChangeColorRect411.col = Color.BLUE;  buildings2ChangeColorRect411.grayCol = grayGreen;
			buildings2ChangeColorRect412.col = Color.BLUE;  buildings2ChangeColorRect412.grayCol = grayGreen;
			buildings2ChangeColorRect413.col = Color.BLUE;  buildings2ChangeColorRect413.grayCol = grayGreen;
			buildings2ChangeColorRect414.col = Color.BLUE;  buildings2ChangeColorRect414.grayCol = grayGreen;
			buildings2ChangeColorRect415.col = Color.BLUE;  buildings2ChangeColorRect415.grayCol = grayGreen;
			buildings2ChangeColorRect416.col = Color.BLUE;  buildings2ChangeColorRect416.grayCol = grayGreen;
			buildings2ChangeColorRect417.col = Color.BLUE;  buildings2ChangeColorRect417.grayCol = grayGreen;
			buildings2ChangeColorRect418.col = Color.BLUE;  buildings2ChangeColorRect418.grayCol = grayGreen;
			buildings2ChangeColorRect419.col = Color.BLUE;  buildings2ChangeColorRect419.grayCol = grayGreen;
			buildings2ChangeColorRect420.col = Color.BLUE;  buildings2ChangeColorRect420.grayCol = grayGreen;
			buildings2ChangeColorRect421.col = Color.BLUE;  buildings2ChangeColorRect421.grayCol = grayGreen;
			buildings2ChangeColorRect422.col = Color.BLUE;  buildings2ChangeColorRect422.grayCol = grayGreen;
			buildings2ChangeColorRect423.col = Color.BLUE;  buildings2ChangeColorRect423.grayCol = grayGreen;
			buildings2ChangeColorRect424.col = Color.BLUE;  buildings2ChangeColorRect424.grayCol = grayGreen;
			buildings2ChangeColorRect425.col = Color.BLUE;  buildings2ChangeColorRect425.grayCol = grayGreen;
			buildings2ChangeColorRect426.col = Color.BLUE;  buildings2ChangeColorRect426.grayCol = grayGreen;
			buildings2ChangeColorRect427.col = Color.BLUE;  buildings2ChangeColorRect427.grayCol = grayGreen;
			buildings2ChangeColorRect428.col = Color.BLUE;  buildings2ChangeColorRect428.grayCol = grayGreen;
			buildings2ChangeColorRect429.col = Color.BLUE;  buildings2ChangeColorRect429.grayCol = grayGreen;
			buildings2ChangeColorRect430.col = Color.BLUE;  buildings2ChangeColorRect430.grayCol = grayGreen;
			buildings2ChangeColorRect431.col = Color.BLUE;  buildings2ChangeColorRect431.grayCol = grayGreen;
			buildings2ChangeColorRect432.col = Color.BLUE;  buildings2ChangeColorRect432.grayCol = grayGreen;
			buildings2ChangeColorRect433.col = Color.BLUE;  buildings2ChangeColorRect433.grayCol = grayGreen;
			buildings2ChangeColorRect434.col = Color.BLUE;  buildings2ChangeColorRect434.grayCol = grayGreen;
			buildings2ChangeColorRect435.col = Color.BLUE;  buildings2ChangeColorRect435.grayCol = grayGreen;
			buildings2ChangeColorRect436.col = Color.BLUE;  buildings2ChangeColorRect436.grayCol = grayGreen;
			buildings2ChangeColorRect437.col = Color.BLUE;  buildings2ChangeColorRect437.grayCol = grayGreen;
			buildings2ChangeColorRect438.col = Color.BLUE;  buildings2ChangeColorRect438.grayCol = grayGreen;
			buildings2ChangeColorRect439.col = Color.BLUE;  buildings2ChangeColorRect439.grayCol = grayGreen;
			buildings2ChangeColorRect440.col = Color.BLUE;  buildings2ChangeColorRect440.grayCol = grayGreen;
			buildings2ChangeColorRect441.col = Color.BLUE;  buildings2ChangeColorRect441.grayCol = grayGreen;
			buildings2ChangeColorRect442.col = Color.BLUE;  buildings2ChangeColorRect442.grayCol = grayGreen;
			buildings2ChangeColorRect443.col = Color.BLUE;  buildings2ChangeColorRect443.grayCol = grayGreen;
			buildings2ChangeColorRect444.col = Color.BLUE;  buildings2ChangeColorRect444.grayCol = grayGreen;
			buildings2ChangeColorRect445.col = Color.BLUE;  buildings2ChangeColorRect445.grayCol = grayGreen;
			buildings2ChangeColorRect446.col = Color.BLUE;  buildings2ChangeColorRect446.grayCol = grayGreen;
			buildings2ChangeColorRect447.col = Color.BLUE;  buildings2ChangeColorRect447.grayCol = grayGreen;
			buildings2ChangeColorRect448.col = Color.BLUE;  buildings2ChangeColorRect448.grayCol = grayGreen;
			buildings2ChangeColorRect449.col = Color.BLUE;  buildings2ChangeColorRect449.grayCol = grayGreen;
			buildings2ChangeColorRect450.col = Color.BLUE;  buildings2ChangeColorRect450.grayCol = grayGreen;
			buildings2ChangeColorRect451.col = Color.BLUE;  buildings2ChangeColorRect451.grayCol = grayGreen;
			buildings2ChangeColorRect452.col = Color.BLUE;  buildings2ChangeColorRect452.grayCol = grayGreen;
			buildings2ChangeColorRect453.col = Color.BLUE;  buildings2ChangeColorRect453.grayCol = grayGreen;
			buildings2ChangeColorRect454.col = Color.BLUE;  buildings2ChangeColorRect454.grayCol = grayGreen;
			buildings2ChangeColorRect455.col = Color.BLUE;  buildings2ChangeColorRect455.grayCol = grayGreen;
			buildings2ChangeColorRect456.col = Color.BLUE;  buildings2ChangeColorRect456.grayCol = grayGreen;
			buildings2ChangeColorRect457.col = Color.BLUE;  buildings2ChangeColorRect457.grayCol = grayGreen;
			buildings2ChangeColorRect458.col = Color.BLUE;  buildings2ChangeColorRect458.grayCol = grayGreen;
			buildings2ChangeColorRect459.col = Color.BLUE;  buildings2ChangeColorRect459.grayCol = grayGreen;
			buildings2ChangeColorRect460.col = Color.BLUE;  buildings2ChangeColorRect460.grayCol = grayGreen;
			buildings2ChangeColorRect461.col = Color.BLUE;  buildings2ChangeColorRect461.grayCol = grayGreen;
			buildings2ChangeColorRect462.col = Color.BLUE;  buildings2ChangeColorRect462.grayCol = grayGreen;
			buildings2ChangeColorRect463.col = Color.BLUE;  buildings2ChangeColorRect463.grayCol = grayGreen;
			buildings2ChangeColorRect464.col = Color.BLUE;  buildings2ChangeColorRect464.grayCol = grayGreen;
			buildings2ChangeColorRect465.col = Color.BLUE;  buildings2ChangeColorRect465.grayCol = grayGreen;
			buildings2ChangeColorRect466.col = Color.BLUE;  buildings2ChangeColorRect466.grayCol = grayGreen;
			buildings2ChangeColorRect467.col = Color.BLUE;  buildings2ChangeColorRect467.grayCol = grayGreen;
			buildings2ChangeColorRect468.col = Color.BLUE;  buildings2ChangeColorRect468.grayCol = grayGreen;
			buildings2ChangeColorRect469.col = Color.BLUE;  buildings2ChangeColorRect469.grayCol = grayGreen;
			buildings2ChangeColorRect470.col = Color.BLUE;  buildings2ChangeColorRect470.grayCol = grayGreen;
			buildings2ChangeColorRect471.col = Color.BLUE;  buildings2ChangeColorRect471.grayCol = grayGreen;
			buildings2ChangeColorRect472.col = Color.BLUE;  buildings2ChangeColorRect472.grayCol = grayGreen;
			buildings2ChangeColorRect473.col = Color.BLUE;  buildings2ChangeColorRect473.grayCol = grayGreen;
			buildings2ChangeColorRect474.col = Color.BLUE;  buildings2ChangeColorRect474.grayCol = grayGreen;
			buildings2ChangeColorRect475.col = Color.BLUE;  buildings2ChangeColorRect475.grayCol = grayGreen;
			buildings2ChangeColorRect476.col = Color.BLUE;  buildings2ChangeColorRect476.grayCol = grayGreen;
			buildings2ChangeColorRect477.col = Color.BLUE;  buildings2ChangeColorRect477.grayCol = grayGreen;
			buildings2ChangeColorRect478.col = Color.BLUE;  buildings2ChangeColorRect478.grayCol = grayGreen;
			buildings2ChangeColorRect479.col = Color.BLUE;  buildings2ChangeColorRect479.grayCol = grayGreen;
			buildings2ChangeColorRect480.col = Color.BLUE;  buildings2ChangeColorRect480.grayCol = grayGreen;
			buildings2ChangeColorRect481.col = Color.BLUE;  buildings2ChangeColorRect481.grayCol = grayGreen;
			buildings2ChangeColorRect482.col = Color.BLUE;  buildings2ChangeColorRect482.grayCol = grayGreen;
			buildings2ChangeColorRect483.col = Color.BLUE;  buildings2ChangeColorRect483.grayCol = grayGreen;
			buildings2ChangeColorRect484.col = Color.BLUE;  buildings2ChangeColorRect484.grayCol = grayGreen;
			buildings2ChangeColorRect485.col = Color.BLUE;  buildings2ChangeColorRect485.grayCol = grayGreen;
			buildings2ChangeColorRect486.col = Color.BLUE;  buildings2ChangeColorRect486.grayCol = grayGreen;
			buildings2ChangeColorRect487.col = Color.BLUE;  buildings2ChangeColorRect487.grayCol = grayGreen;
			buildings2ChangeColorRect488.col = Color.BLUE;  buildings2ChangeColorRect488.grayCol = grayGreen;
			buildings2ChangeColorRect489.col = Color.BLUE;  buildings2ChangeColorRect489.grayCol = grayGreen;
			buildings2ChangeColorRect490.col = Color.BLUE;  buildings2ChangeColorRect490.grayCol = grayGreen;
			buildings2ChangeColorRect491.col = Color.BLUE;  buildings2ChangeColorRect491.grayCol = grayGreen;
			buildings2ChangeColorRect492.col = Color.BLUE;  buildings2ChangeColorRect492.grayCol = grayGreen;
			buildings2ChangeColorRect493.col = Color.BLUE;  buildings2ChangeColorRect493.grayCol = grayGreen;
			buildings2ChangeColorRect494.col = Color.BLUE;  buildings2ChangeColorRect494.grayCol = grayGreen;
			buildings2ChangeColorRect495.col = Color.BLUE;  buildings2ChangeColorRect495.grayCol = grayGreen;
			buildings2ChangeColorRect496.col = Color.BLUE;  buildings2ChangeColorRect496.grayCol = grayGreen;
			buildings2ChangeColorRect497.col = Color.BLUE;  buildings2ChangeColorRect497.grayCol = grayGreen;
			buildings2ChangeColorRect498.col = Color.BLUE;  buildings2ChangeColorRect498.grayCol = grayGreen;
			buildings2ChangeColorRect499.col = Color.BLUE;  buildings2ChangeColorRect499.grayCol = grayGreen;
			buildings2ChangeColorRect500.col = Color.BLUE;  buildings2ChangeColorRect500.grayCol = grayGreen;
			buildings2ChangeColorRect501.col = Color.BLUE;  buildings2ChangeColorRect501.grayCol = grayGreen;
			buildings2ChangeColorRect502.col = Color.BLUE;  buildings2ChangeColorRect502.grayCol = grayGreen;
			buildings2ChangeColorRect503.col = Color.BLUE;  buildings2ChangeColorRect503.grayCol = grayGreen;
			buildings2ChangeColorRect504.col = Color.BLUE;  buildings2ChangeColorRect504.grayCol = grayGreen;
			buildings2ChangeColorRect505.col = Color.BLUE;  buildings2ChangeColorRect505.grayCol = grayGreen;
			buildings2ChangeColorRect506.col = Color.BLUE;  buildings2ChangeColorRect506.grayCol = grayGreen;
			buildings2ChangeColorRect507.col = Color.BLUE;  buildings2ChangeColorRect507.grayCol = grayGreen;
			buildings2ChangeColorRect508.col = Color.BLUE;  buildings2ChangeColorRect508.grayCol = grayGreen;
			buildings2ChangeColorRect509.col = Color.BLUE;  buildings2ChangeColorRect509.grayCol = grayGreen;
			buildings2ChangeColorRect510.col = Color.BLUE;  buildings2ChangeColorRect510.grayCol = grayGreen;
			buildings2ChangeColorRect511.col = Color.BLUE;  buildings2ChangeColorRect511.grayCol = grayGreen;
			buildings2ChangeColorRect512.col = Color.BLUE;  buildings2ChangeColorRect512.grayCol = grayGreen;
			buildings2ChangeColorRect513.col = Color.BLUE;  buildings2ChangeColorRect513.grayCol = grayGreen;
			buildings2ChangeColorRect514.col = Color.BLUE;  buildings2ChangeColorRect514.grayCol = grayGreen;
			buildings2ChangeColorRect515.col = Color.BLUE;  buildings2ChangeColorRect515.grayCol = grayGreen;
			buildings2ChangeColorRect516.col = Color.BLUE;  buildings2ChangeColorRect516.grayCol = grayGreen;
			buildings2ChangeColorRect517.col = Color.BLUE;  buildings2ChangeColorRect517.grayCol = grayGreen;
			buildings2ChangeColorRect518.col = Color.BLUE;  buildings2ChangeColorRect518.grayCol = grayGreen;
			buildings2ChangeColorRect519.col = Color.BLUE;  buildings2ChangeColorRect519.grayCol = grayGreen;
			buildings2ChangeColorRect520.col = Color.BLUE;  buildings2ChangeColorRect520.grayCol = grayGreen;
			buildings2ChangeColorRect521.col = Color.BLUE;  buildings2ChangeColorRect521.grayCol = grayGreen;
	...
	public void buildings() {
		...
		enemyBorder.add(new ColorfulRectangle(movex+-1100,movey+100, 50, 50, EnemyBorderColor));
		enemyBorder.add(new ColorfulRectangle(movex+-1300,movey+50, 50, 50, EnemyBorderColor));
		enemyBorder.add(new ColorfulRectangle(movex+-1300,movey+100, 50, 50, EnemyBorderColor));
		enemyBorder.add(new ColorfulRectangle(movex+350,movey+200, 50, 50, EnemyBorderColor));
		enemyBorder.add(new ColorfulRectangle(movex+400,movey+200, 50, 50, EnemyBorderColor));
		enemyBorder.add(new ColorfulRectangle(movex+400,movey+250, 50, 50, EnemyBorderColor));
		enemyBorder.add(new ColorfulRectangle(movex+400,movey+300, 50, 50,EnemyBorderColor));
		enemyBorder.add(new ColorfulRectangle(movex+350,movey+300, 50, 50,EnemyBorderColor));
		...
		enemyBorder.add(new ColorfulRectangle(movex+-1600,movey+-400, 50, 50, EnemyBorderColor));
		enemyBorder.add(new ColorfulRectangle(movex+-1550,movey+-400, 50, 50, EnemyBorderColor));
	...
	int marker;
	if(wall1==true) {
	rects.add(new ColorfulRectangle(351,36, 126, 45, bgColor));
	rects.add(new ColorfulRectangle(189,144, 81, 108, bgColor));
	rects.add(new ColorfulRectangle(252,144, 36, 72, bgColor));
	rects.add(new ColorfulRectangle(225,252, 45, 117, bgColor));
	rects.add(new ColorfulRectangle(261,369, 36, 27, bgColor));
	rects.add(new ColorfulRectangle(270,351, 18, 27, bgColor));
	rects.add(new ColorfulRectangle(522,54, 45, 27, bgColor));
	rects.add(new ColorfulRectangle(522,207, 108, 126, bgColor));
	rects.add(new ColorfulRectangle(549,90, 9, 9, bgColor));
	rects.add(new ColorfulRectangle(540,126, 54, 81, bgColor));
	rects.add(new ColorfulRectangle(630,171, 27, 27, bgColor));
	rects.add(new ColorfulRectangle(288,351, 153, 45, bgColor));
	rects.add(new ColorfulRectangle(279,81, 81, 63, bgColor));
	rects.add(new ColorfulRectangle(540,81, 144, 189, bgColor));
	rects.add(new ColorfulRectangle(441,333, 108, 81, bgColor));
	rects.add(new ColorfulRectangle(549,342, 9, 72, bgColor));
	}
	
	if(wall2==true) {
	rects.add(new ColorfulRectangle(9,9, 342, 126, bgColor));
	rects.add(new ColorfulRectangle(9,135, 270, 9, bgColor));
	rects.add(new ColorfulRectangle(351,9, 126, 27, bgColor));
	rects.add(new ColorfulRectangle(477,9, 45, 72, bgColor));
	rects.add(new ColorfulRectangle(522,9, 261, 45, bgColor));
	rects.add(new ColorfulRectangle(567,54, 207, 36, bgColor));
	rects.add(new ColorfulRectangle(621,90, 162, 63, bgColor));
	rects.add(new ColorfulRectangle(594,90, 27, 36, bgColor));
	rects.add(new ColorfulRectangle(639,153, 144, 9, bgColor));
	rects.add(new ColorfulRectangle(666,162, 9, 36, bgColor));
	rects.add(new ColorfulRectangle(675,162, 108, 315, bgColor));
	rects.add(new ColorfulRectangle(666,234, 9, 9, bgColor));
	rects.add(new ColorfulRectangle(648,243, 27, 234, bgColor));
	rects.add(new ColorfulRectangle(630,261, 18, 216, bgColor));
	rects.add(new ColorfulRectangle(558,333, 81, 144, bgColor));
	rects.add(new ColorfulRectangle(9,414, 540, 63, bgColor));
	rects.add(new ColorfulRectangle(9,396, 432, 18, bgColor));
	rects.add(new ColorfulRectangle(9,144, 180, 252, bgColor));
	rects.add(new ColorfulRectangle(189,252, 36, 144, bgColor));
	rects.add(new ColorfulRectangle(351,36, 9, 9, bgColor));
	rects.add(new ColorfulRectangle(225,369, 36, 27, bgColor));	
	...
	public void buildingdarkness() {
		if(wall1==true) {
		rects.add(new ColorfulRectangle(movex+-850,movey+-700, 500, 400, bgColor));
		rects.add(new ColorfulRectangle(movex+-900,movey+-300, 100, 400, bgColor));
		rects.add(new ColorfulRectangle(movex+-700,movey+750, 750, 250, bgColor));
		rects.add(new ColorfulRectangle(movex+-450,movey+-1000, 500, 300, bgColor));
		rects.add(new ColorfulRectangle(movex+50,movey+-1000, 200, 250, bgColor));
		rects.add(new ColorfulRectangle(movex+50,movey+650, 500, 450, bgColor));
		rects.add(new ColorfulRectangle(movex+550,movey+650, 150, 450, bgColor));
		rects.add(new ColorfulRectangle(movex+500,movey+-50, 600, 700, bgColor));
		rects.add(new ColorfulRectangle(movex+600,movey+-750, 1400, 1050, bgColor));
		rects.add(new ColorfulRectangle(movex+-1150,movey+-50, 250, 900, bgColor));
		rects.add(new ColorfulRectangle(movex+-1150,movey+850, 200, 550, bgColor));
		rects.add(new ColorfulRectangle(movex+-950,movey+800, 50, 400, bgColor));
		rects.add(new ColorfulRectangle(movex+-850,movey+750, 150, 100, bgColor));
		rects.add(new ColorfulRectangle(movex+-1350,movey+-400, 450, 600, bgColor));
		rects.add(new ColorfulRectangle(movex+-900,movey+-400, 50, 50, bgColor));
		rects.add(new ColorfulRectangle(movex+-900,movey+800, 150, 200, bgColor));
		rects.add(new ColorfulRectangle(movex+500,movey+-900, 50, 50, bgColor));
		rects.add(new ColorfulRectangle(movex+700,movey+-800, 50, 50, bgColor));
		rects.add(new ColorfulRectangle(movex+500,movey+-900, 250, 150, bgColor));
		}
		
		if(wall2==true) {
		rects.add(new ColorfulRectangle(movex+-2350,movey+-1150, 1900, 700, bgColor));
		rects.add(new ColorfulRectangle(movex+-900,movey+1000, 150, 400, bgColor));
		rects.add(new ColorfulRectangle(movex+-2350,movey+1000, 1450, 450, bgColor));
		rects.add(new ColorfulRectangle(movex+-2350,movey+-450, 1000, 1350, bgColor));
		rects.add(new ColorfulRectangle(movex+-1350,movey+-450, 450, 50, bgColor));
		rects.add(new ColorfulRectangle(movex+-1350,movey+200, 200, 700, bgColor));
		rects.add(new ColorfulRectangle(movex+-2350,movey+900, 1350, 100, bgColor));
		rects.add(new ColorfulRectangle(movex+50,movey+1100, 1900, 350, bgColor));
		rects.add(new ColorfulRectangle(movex+700,movey+650, 1250, 450, bgColor));
		rects.add(new ColorfulRectangle(movex+1100,movey+250, 850, 400, bgColor));
		rects.add(new ColorfulRectangle(movex+1200,movey+150, 750, 100, bgColor));
		rects.add(new ColorfulRectangle(movex+1300,movey+100, 650, 50, bgColor));
		rects.add(new ColorfulRectangle(movex+1350,movey+-50, 600, 150, bgColor));
		rects.add(new ColorfulRectangle(movex+1300,movey+-250, 650, 150, bgColor));
		rects.add(new ColorfulRectangle(movex+1350,movey+-100, 600, 50, bgColor));
		rects.add(new ColorfulRectangle(movex+1050,movey+-1150, 900, 800, bgColor));
		rects.add(new ColorfulRectangle(movex+-750,movey+1100, 1550, 450, bgColor));
		rects.add(new ColorfulRectangle(movex+-450,movey+-1150, 900, 150, bgColor));
		rects.add(new ColorfulRectangle(movex+450,movey+-1150, 600, 150, bgColor));
		rects.add(new ColorfulRectangle(movex+900,movey+-750, 150, 250, bgColor));
		rects.add(new ColorfulRectangle(movex+1300,movey+-350, 650, 100, bgColor));
		rects.add(new ColorfulRectangle(movex+-700,movey+1000, 700, 100, bgColor));
		rects.add(new ColorfulRectangle(movex+450,movey+-1000, 600, 100, bgColor));
		rects.add(new ColorfulRectangle(movex+750,movey+-900, 300, 200, bgColor));
		rects.add(new ColorfulRectangle(movex+300,movey+-1000, 150, 250, bgColor));
		}
		
		if(secret==false) {
		rects.add(new ColorfulRectangle(movex+-1000,movey+1100, 200, 200, bgColor));
		rects.add(new ColorfulRectangle(movex+800,movey+1350, 200, 100, bgColor));
		}
...
//		image(pausedImg,0,0,800,600);
	...
	public void optionsBlocks() {
		...
		//BACK ARROW
		rects.add(new ColorfulRectangle(9,513, 72, 72, Color.WHITE));
		rects.add(new ColorfulRectangle(36,522, 9, 54, Color.BLACK));
		rects.add(new ColorfulRectangle(27,531, 9, 36, Color.BLACK));
		rects.add(new ColorfulRectangle(18,540, 54, 18, Color.BLACK));

		//STROKE
		//X 50-350
		//Y 50-150
		rects.add(new ColorfulRectangle(53,53, 300, 100, Color.WHITE));
		//S
		rects.add(new ColorfulRectangle(63,63, 27, 9, Color.BLACK));
		rects.add(new ColorfulRectangle(63,72, 9, 27, Color.BLACK));
		rects.add(new ColorfulRectangle(63,99, 27, 9, Color.BLACK));
		rects.add(new ColorfulRectangle(81,108, 9, 27, Color.BLACK));
		rects.add(new ColorfulRectangle(63,135, 27, 9, Color.BLACK));
		//T
		rects.add(new ColorfulRectangle(99,63, 27, 9, Color.BLACK));
		rects.add(new ColorfulRectangle(108,72, 9, 72, Color.BLACK));
		//R
		rects.add(new ColorfulRectangle(135,63, 9, 81, Color.BLACK));
		rects.add(new ColorfulRectangle(144,63, 18, 9, Color.BLACK));
		rects.add(new ColorfulRectangle(153,72, 9, 27, Color.BLACK));
		rects.add(new ColorfulRectangle(144,90, 18, 9, Color.BLACK));
		rects.add(new ColorfulRectangle(144,99, 9, 18, Color.BLACK));
		rects.add(new ColorfulRectangle(153,117, 9, 27, Color.BLACK));
		rects.add(new ColorfulRectangle(150,110, 5, 15, Color.BLACK));
		//O
		rects.add(new ColorfulRectangle(171,63, 9, 81, Color.BLACK));
		rects.add(new ColorfulRectangle(189,63, 9, 81, Color.BLACK));
		rects.add(new ColorfulRectangle(180,63, 9, 9, Color.BLACK));
		rects.add(new ColorfulRectangle(180,135, 9, 9, Color.BLACK));
		//K
		rects.add(new ColorfulRectangle(207,63, 9, 81, Color.BLACK));
		rects.add(new ColorfulRectangle(216,99, 9, 9, Color.BLACK));
		rects.add(new ColorfulRectangle(225,63, 9, 27, Color.BLACK));
		rects.add(new ColorfulRectangle(225,117, 9, 27, Color.BLACK));
		rects.add(new ColorfulRectangle(220,110, 5, 5, Color.BLACK));
		rects.add(new ColorfulRectangle(220,105, 5, 5, Color.BLACK));
		rects.add(new ColorfulRectangle(220,95, 5, 5, Color.BLACK));
		rects.add(new ColorfulRectangle(220,90, 5, 5, Color.BLACK));
		rects.add(new ColorfulRectangle(225,95, 5, 5, Color.BLACK));
		rects.add(new ColorfulRectangle(225,90, 5, 5, Color.BLACK));
		rects.add(new ColorfulRectangle(225,110, 5, 5, Color.BLACK));
		rects.add(new ColorfulRectangle(225,115, 5, 5, Color.BLACK));
		//E
		rects.add(new ColorfulRectangle(243,63, 9, 81, Color.BLACK));
		rects.add(new ColorfulRectangle(252,63, 18, 9, Color.BLACK));
		rects.add(new ColorfulRectangle(252,99, 18, 9, Color.BLACK));
		rects.add(new ColorfulRectangle(252,135, 18, 9, Color.BLACK));
		//:
		rects.add(new ColorfulRectangle(279,81, 9, 9, Color.BLACK));
		rects.add(new ColorfulRectangle(279,117, 9, 9, Color.BLACK));
		//CHECK MARK
		if(Stroke==true) {
		rects.add(new ColorfulRectangle(297,117, 9, 9, Color.GREEN));
		rects.add(new ColorfulRectangle(306,126, 9, 9, Color.GREEN));
		rects.add(new ColorfulRectangle(315,108, 9, 18, Color.GREEN));
		rects.add(new ColorfulRectangle(324,90, 9, 18, Color.GREEN));
		rects.add(new ColorfulRectangle(333,72, 9, 18, Color.GREEN));
		}
		//X MARK
		if(Stroke==false) {
		rects.add(new ColorfulRectangle(306,90, 9, 9, Color.RED));
		rects.add(new ColorfulRectangle(315,99, 9, 9, Color.RED));
		rects.add(new ColorfulRectangle(324,90, 9, 9, Color.RED));
		rects.add(new ColorfulRectangle(306,108, 9, 9, Color.RED));
		rects.add(new ColorfulRectangle(324,108, 9, 9, Color.RED));
		rects.add(new ColorfulRectangle(333,117, 9, 18, Color.RED));
		rects.add(new ColorfulRectangle(333,72, 9, 18, Color.RED));
		rects.add(new ColorfulRectangle(297,117, 9, 18, Color.RED));
		rects.add(new ColorfulRectangle(297,72, 9, 18, Color.RED));
		}
		
		//BG COLOR
		rects.add(new ColorfulRectangle(450, 53, 300, 100, Color.WHITE));
		//OUTLINE
		...
		//C
		rects.add(new ColorfulRectangle(459,63, 9, 81, Color.BLACK));
		rects.add(new ColorfulRectangle(468,63, 18, 9, Color.BLACK));
		rects.add(new ColorfulRectangle(468,135, 18, 9, Color.BLACK));
		//O
		rects.add(new ColorfulRectangle(495,63, 9, 81, Color.BLACK));
		rects.add(new ColorfulRectangle(504,63, 9, 9, Color.BLACK));
		rects.add(new ColorfulRectangle(513,63, 9, 81, Color.BLACK));
		rects.add(new ColorfulRectangle(504,135, 9, 9, Color.BLACK));
		//L
		rects.add(new ColorfulRectangle(531,63, 9, 81, Color.BLACK));
		rects.add(new ColorfulRectangle(540,135, 18, 9, Color.BLACK));
		//O
		rects.add(new ColorfulRectangle(567,63, 9, 81, Color.BLACK));
		rects.add(new ColorfulRectangle(576,63, 9, 9, Color.BLACK));
		rects.add(new ColorfulRectangle(585,63, 9, 81, Color.BLACK));
		rects.add(new ColorfulRectangle(576,135, 9, 9, Color.BLACK));
		//R
		rects.add(new ColorfulRectangle(603,63, 9, 81, Color.BLACK));
		rects.add(new ColorfulRectangle(612,63, 18, 9, Color.BLACK));
		rects.add(new ColorfulRectangle(621,72, 9, 18, Color.BLACK));
		rects.add(new ColorfulRectangle(612,90, 18, 9, Color.BLACK));
		rects.add(new ColorfulRectangle(612,99, 9, 9, Color.BLACK));
		rects.add(new ColorfulRectangle(612,108, 9, 9, Color.BLACK));
		rects.add(new ColorfulRectangle(621,117, 9, 27, Color.BLACK));
		rects.add(new ColorfulRectangle(620,110, 5, 15, Color.BLACK));

		//:
		rects.add(new ColorfulRectangle(639,81, 9, 9, Color.BLACK));
		rects.add(new ColorfulRectangle(639,117, 9, 9, Color.BLACK));
		//RED
		rects.add(new ColorfulRectangle(657,63, 18, 36, Color.RED));
		//YELLOW
		rects.add(new ColorfulRectangle(684,63, 18, 36, Color.YELLOW));
		//GREEN
		rects.add(new ColorfulRectangle(711,63, 18, 36, Color.GREEN));
		//BLUE
		rects.add(new ColorfulRectangle(657,108, 18, 36, Color.BLUE));
		//MAGENTA
		rects.add(new ColorfulRectangle(684,108, 18, 36, Color.MAGENTA));
		//BLACK
		rects.add(new ColorfulRectangle(711,108, 18, 36, Color.BLACK));
		
		//ENEMY DIFFICULTY
		rects.add(new ColorfulRectangle(50,197, 300, 100, Color.WHITE));	
		//OUTLINE
		...
		//E
		rects.add(new ColorfulRectangle(63,207, 9, 81, Color.BLACK));
		rects.add(new ColorfulRectangle(72,207, 18, 9, Color.BLACK));
		rects.add(new ColorfulRectangle(72,243, 18, 9, Color.BLACK));
		rects.add(new ColorfulRectangle(72,279, 18, 9, Color.BLACK));
		//N
		rects.add(new ColorfulRectangle(99,207, 9, 81, Color.BLACK));
		rects.add(new ColorfulRectangle(117,207, 9, 81, Color.BLACK));
		rects.add(new ColorfulRectangle(105,225, 5, 30, Color.BLACK));
		rects.add(new ColorfulRectangle(110,235, 5, 30, Color.BLACK));
		rects.add(new ColorfulRectangle(115,245, 5, 30, Color.BLACK));
		//E
		rects.add(new ColorfulRectangle(144,207, 18, 9, Color.BLACK));
		rects.add(new ColorfulRectangle(144,243, 18, 9, Color.BLACK));
		rects.add(new ColorfulRectangle(144,279, 18, 9, Color.BLACK));
		rects.add(new ColorfulRectangle(135,207, 9, 81, Color.BLACK));
		//M
		rects.add(new ColorfulRectangle(171,207, 9, 81, Color.BLACK));
		rects.add(new ColorfulRectangle(198,207, 9, 81, Color.BLACK));
		rects.add(new ColorfulRectangle(180,210, 5, 15, Color.BLACK));
		rects.add(new ColorfulRectangle(195,210, 5, 15, Color.BLACK));
		rects.add(new ColorfulRectangle(185,215, 5, 15, Color.BLACK));
		rects.add(new ColorfulRectangle(190,215, 5, 15, Color.BLACK));
		//Y
		rects.add(new ColorfulRectangle(216,207, 9, 27, Color.BLACK));
		rects.add(new ColorfulRectangle(234,207, 9, 27, Color.BLACK));
		rects.add(new ColorfulRectangle(225,234, 9, 54, Color.BLACK));
		rects.add(new ColorfulRectangle(234,234, 9, 9, Color.BLACK));
		rects.add(new ColorfulRectangle(216,234, 9, 9, Color.BLACK));
		rects.add(new ColorfulRectangle(235,240, 5, 10, Color.BLACK));
		rects.add(new ColorfulRectangle(230,240, 5, 10, Color.BLACK));
		rects.add(new ColorfulRectangle(220,240, 5, 10, Color.BLACK));
		//:
		rects.add(new ColorfulRectangle(252,225, 9, 9, Color.BLACK));
		rects.add(new ColorfulRectangle(252,261, 9, 9, Color.BLACK));
		//Easy
		rects.add(new ColorfulRectangle(270,207, 27, 36, Color.GREEN));
		//Medium		
		rects.add(new ColorfulRectangle(306,207, 27, 36, Color.YELLOW));
		//Hard
		...
		//GRAYSCALE
		rects.add(new ColorfulRectangle(450,197, 300, 100, Color.WHITE));
		//C
		...
		//FLASHING LIGHTS
		rects.add(new ColorfulRectangle(50,350, 375, 100, Color.WHITE));

		//F
		rects.add(new ColorfulRectangle(72,360, 18, 9, Color.BLACK));
		rects.add(new ColorfulRectangle(63,360, 9, 81, Color.BLACK));
		rects.add(new ColorfulRectangle(72,396, 18, 9, Color.BLACK));
		//L
		rects.add(new ColorfulRectangle(99,360, 9, 81, Color.BLACK));
		rects.add(new ColorfulRectangle(108,432, 18, 9, Color.BLACK));
		//A
		rects.add(new ColorfulRectangle(135,369, 9, 72, Color.BLACK));
		rects.add(new ColorfulRectangle(144,360, 9, 9, Color.BLACK));
		rects.add(new ColorfulRectangle(153,369, 9, 72, Color.BLACK));
		rects.add(new ColorfulRectangle(144,396, 9, 9, Color.BLACK));
		//S
		rects.add(new ColorfulRectangle(171,360, 27, 9, Color.BLACK));
		rects.add(new ColorfulRectangle(171,369, 9, 36, Color.BLACK));
		rects.add(new ColorfulRectangle(180,396, 18, 9, Color.BLACK));
		rects.add(new ColorfulRectangle(189,405, 9, 36, Color.BLACK));		
		rects.add(new ColorfulRectangle(171,432, 18, 9, Color.BLACK));
		//H
		rects.add(new ColorfulRectangle(207,360, 9, 81, Color.BLACK));		
		rects.add(new ColorfulRectangle(216,396, 9, 9, Color.BLACK));
		rects.add(new ColorfulRectangle(225,360, 9, 81, Color.BLACK));
		//I
		rects.add(new ColorfulRectangle(243,360, 27, 9, Color.BLACK));
		rects.add(new ColorfulRectangle(252,369, 9, 63, Color.BLACK));		
		rects.add(new ColorfulRectangle(243,432, 27, 9, Color.BLACK));
		//N
		rects.add(new ColorfulRectangle(279,360, 9, 81, Color.BLACK));
		rects.add(new ColorfulRectangle(285,380, 5, 25, Color.BLACK));
		rects.add(new ColorfulRectangle(290,390, 5, 25, Color.BLACK));
		rects.add(new ColorfulRectangle(295,400, 5, 25, Color.BLACK));
		rects.add(new ColorfulRectangle(297,360, 9, 81, Color.BLACK));
		//G
		rects.add(new ColorfulRectangle(315,360, 27, 9, Color.BLACK));
		rects.add(new ColorfulRectangle(315,369, 9, 72, Color.BLACK));
		rects.add(new ColorfulRectangle(324,432, 18, 9, Color.BLACK));
		rects.add(new ColorfulRectangle(333,396, 9, 36, Color.BLACK));
		rects.add(new ColorfulRectangle(330,395, 15, 10, Color.BLACK));
		//:
		rects.add(new ColorfulRectangle(351,378, 9, 9, Color.BLACK));
		rects.add(new ColorfulRectangle(351,414, 9, 9, Color.BLACK));
		//CHECK MARK
		if(FlashingLights) {
		rects.add(new ColorfulRectangle(369,414, 9, 9, Color.GREEN));
		rects.add(new ColorfulRectangle(378,423, 9, 9, Color.GREEN));
		rects.add(new ColorfulRectangle(387,405, 9, 18, Color.GREEN));
		rects.add(new ColorfulRectangle(396,387, 9, 18, Color.GREEN));
		rects.add(new ColorfulRectangle(405,369, 9, 18, Color.GREEN));
		}
		//X MARK
		if(!FlashingLights) {
		rects.add(new ColorfulRectangle(369,414, 9, 18, Color.RED));
		rects.add(new ColorfulRectangle(369,369, 9, 18, Color.RED));
		rects.add(new ColorfulRectangle(378,387, 9, 9, Color.RED));
		rects.add(new ColorfulRectangle(378,405, 9, 9, Color.RED));
		rects.add(new ColorfulRectangle(387,396, 9, 9, Color.RED));
		rects.add(new ColorfulRectangle(396,387, 9, 9, Color.RED));
		rects.add(new ColorfulRectangle(396,405, 9, 9, Color.RED));
		rects.add(new ColorfulRectangle(405,414, 9, 18, Color.RED));
		rects.add(new ColorfulRectangle(405,369, 9, 18, Color.RED));
		}
		
		//DEV
//		rects.add(new ColorfulRectangle(650,450, 100, 100, Color.WHITE));
	...
	public void winScreen() {
		...
		rects.add(new ColorfulRectangle(90,120, 70, 10, Color.WHITE));
		rects.add(new ColorfulRectangle(80,110, 90, 10, Color.WHITE));
		rects.add(new ColorfulRectangle(70,100, 110, 10, Color.WHITE));
		rects.add(new ColorfulRectangle(60,90, 130, 10, Color.WHITE));
		rects.add(new ColorfulRectangle(50,80, 70, 10, Color.WHITE));
		rects.add(new ColorfulRectangle(50,70, 60, 10, Color.WHITE));
		rects.add(new ColorfulRectangle(50,60, 50, 10, Color.WHITE));
		rects.add(new ColorfulRectangle(50,50, 40, 10, Color.WHITE));
		rects.add(new ColorfulRectangle(130,80, 70, 10, Color.WHITE));
		rects.add(new ColorfulRectangle(140,70, 60, 10, Color.WHITE));
		rects.add(new ColorfulRectangle(150,60, 50, 10, Color.WHITE));
		rects.add(new ColorfulRectangle(160,50, 40, 10, Color.WHITE));

		//O
		rects.add(new ColorfulRectangle(325,100, 50, 50, Color.WHITE));
		rects.add(new ColorfulRectangle(425,100, 50, 50, Color.WHITE));
		rects.add(new ColorfulRectangle(375,50, 50, 50, Color.WHITE));
		rects.add(new ColorfulRectangle(375,150, 50, 50, Color.WHITE));	
		rects.add(new ColorfulRectangle(345,70, 40, 40, Color.WHITE));
		rects.add(new ColorfulRectangle(355,60, 20, 10, Color.WHITE));
		rects.add(new ColorfulRectangle(335,80, 10, 20, Color.WHITE));
		rects.add(new ColorfulRectangle(415,70, 40, 40, Color.WHITE));
		rects.add(new ColorfulRectangle(425,60, 20, 10, Color.WHITE));
		rects.add(new ColorfulRectangle(455,80, 10, 20, Color.WHITE));
		rects.add(new ColorfulRectangle(345,140, 40, 40, Color.WHITE));
		rects.add(new ColorfulRectangle(335,150, 10, 20, Color.WHITE));
		rects.add(new ColorfulRectangle(355,180, 20, 10, Color.WHITE));
		rects.add(new ColorfulRectangle(415,140, 40, 40, Color.WHITE));
		rects.add(new ColorfulRectangle(455,150, 10, 20, Color.WHITE));
		rects.add(new ColorfulRectangle(425,180, 20, 10, Color.WHITE));
		...
		rects.add(new ColorfulRectangle(610,140, 50, 50, Color.WHITE));
		rects.add(new ColorfulRectangle(690,140, 50, 50, Color.WHITE));
		rects.add(new ColorfulRectangle(630,190, 20, 10, Color.WHITE));		
		rects.add(new ColorfulRectangle(600,150, 10, 20, Color.WHITE));
		rects.add(new ColorfulRectangle(700,190, 20, 10, Color.WHITE));
		rects.add(new ColorfulRectangle(740,150, 10, 20, Color.WHITE));
		...
		rects.add(new ColorfulRectangle(60,460, 50, 60, Color.WHITE));
		rects.add(new ColorfulRectangle(70,480, 50, 50, Color.WHITE));
		rects.add(new ColorfulRectangle(80,530, 20, 10, Color.WHITE));
		rects.add(new ColorfulRectangle(120,490, 110, 10, Color.WHITE));
		rects.add(new ColorfulRectangle(130,480, 40, 60, Color.WHITE));
		rects.add(new ColorfulRectangle(140,460, 70, 60, Color.WHITE));
		rects.add(new ColorfulRectangle(180,480, 40, 60, Color.WHITE));
		rects.add(new ColorfulRectangle(170,520, 10, 10, Color.WHITE));
		rects.add(new ColorfulRectangle(180,530, 90, 10, Color.WHITE));
		rects.add(new ColorfulRectangle(230,480, 50, 50, Color.WHITE));
		rects.add(new ColorfulRectangle(240,460, 50, 60, Color.WHITE));

		//I
		rects.add(new ColorfulRectangle(350,300, 100, 50, Color.WHITE));
		rects.add(new ColorfulRectangle(375,350, 50, 150, Color.WHITE));
		rects.add(new ColorfulRectangle(350,500, 100, 50, Color.WHITE));
		
		//N
		rects.add(new ColorfulRectangle(500,300, 50, 250, Color.WHITE));		
		rects.add(new ColorfulRectangle(700,300, 50, 250, Color.WHITE));
		rects.add(new ColorfulRectangle(550,310, 10, 90, Color.WHITE));
		rects.add(new ColorfulRectangle(560,320, 10, 90, Color.WHITE));
		rects.add(new ColorfulRectangle(570,330, 10, 90, Color.WHITE));
		rects.add(new ColorfulRectangle(580,340, 10, 90, Color.WHITE));
		rects.add(new ColorfulRectangle(590,350, 10, 90, Color.WHITE));
		rects.add(new ColorfulRectangle(600,360, 10, 90, Color.WHITE));
		rects.add(new ColorfulRectangle(610,370, 10, 90, Color.WHITE));
		rects.add(new ColorfulRectangle(620,380, 10, 90, Color.WHITE));
		rects.add(new ColorfulRectangle(630,390, 10, 90, Color.WHITE));
		rects.add(new ColorfulRectangle(640,400, 10, 90, Color.WHITE));
		rects.add(new ColorfulRectangle(650,410, 10, 90, Color.WHITE));
		rects.add(new ColorfulRectangle(660,420, 10, 90, Color.WHITE));
		rects.add(new ColorfulRectangle(670,430, 10, 90, Color.WHITE));
		rects.add(new ColorfulRectangle(680,440, 10, 90, Color.WHITE));
		rects.add(new ColorfulRectangle(690,450, 10, 90, Color.WHITE));

		//COVER
		if(winscreenanimation<=5) {
			rects.add(new ColorfulRectangle(50,50, 75, 150, bgColor));
		} if(winscreenanimation<=10) {
			rects.add(new ColorfulRectangle(125,50, 75, 150, bgColor));
		} if(winscreenanimation<=15) {
			rects.add(new ColorfulRectangle(325,50, 75, 150, bgColor));
		} if(winscreenanimation<=20) {
			rects.add(new ColorfulRectangle(400,50, 75, 150, bgColor));
		} if(winscreenanimation<=25) {
			rects.add(new ColorfulRectangle(600,50, 75, 150, bgColor));
		} if(winscreenanimation<=30) {
			rects.add(new ColorfulRectangle(675,50, 75, 150, bgColor));
		} if(winscreenanimation<=35) {
			rects.add(new ColorfulRectangle(50,300, 125, 250, bgColor));
		} if(winscreenanimation<=40) {
			rects.add(new ColorfulRectangle(175,300, 125, 250, bgColor));
		} if(winscreenanimation<=45) {
			rects.add(new ColorfulRectangle(350,300, 50, 250, bgColor));
		} if(winscreenanimation<=50) {
			rects.add(new ColorfulRectangle(400,300, 50, 250, bgColor));
		} if(winscreenanimation<=55) {
			rects.add(new ColorfulRectangle(500,300, 125, 250, bgColor));
		} if(winscreenanimation<=60) {		
			rects.add(new ColorfulRectangle(625,300, 125, 250, bgColor));
		}
		
		winscreenanimation+=1;
		if(winscreenanimation>=200) {
...
//	int moX = ((mouseX/25)*25);
//	int moY = ((mouseY/25)*25);
//	System.out.println("rects.add(new ColorfulRectangle("+ moX +"," + moY + ", 25, 25, Color.WHITE));");
//	rects.add(new ColorfulRectangle(moX,moY, 25, 25, Color.WHITE));	
...
//	rects.add(new ColorfulRectangle(moX,moY, 10, 10, Color.WHITE));	
	...
	class Ending extends ColorfulRectangle{
		...
		public void update() {
			...
			ColorfulRectangle Endingred = new ColorfulRectangle(x,y,50,50,Red,grayRed);
			ColorfulRectangle Endingorange = new ColorfulRectangle(x+2,y+2,45,45,Orange,grayOrange);
			ColorfulRectangle Endingyellow = new ColorfulRectangle(x+5,y+5,40,40,Yellow,grayYellow);
			ColorfulRectangle Endinggreen = new ColorfulRectangle(x+7,y+7,35,35,Green,grayGreen);
			ColorfulRectangle Endingblue = new ColorfulRectangle(x+10,y+10,30,30,Blue,grayBlue);
			ColorfulRectangle Endingpurple = new ColorfulRectangle(x+12,y+12,25,25,Magenta,grayMagenta);
			...
			if(FlashingLights && !mapshown && !optionsshown && !pausedshown && !winscreenshown) {
			if(colorSwitch==0) {
				Endingred.draw();
			...
			}else if(!FlashingLights && !mapshown && !optionsshown && !pausedshown && !winscreenshown) {
				Endingred.draw();
				Endingorange.draw();
				Endingyellow.draw();
				Endinggreen.draw();
	...
	class SecretEnding extends ColorfulRectangle{
		...
		public void update() {
			...
			ColorfulRectangle SecretEnding1 = new ColorfulRectangle(x,y,50,50,Red,grayRed);
			ColorfulRectangle SecretEnding2 = new ColorfulRectangle(x+1,y+1,48,48,Magenta,grayMagenta);
			ColorfulRectangle SecretEnding3 = new ColorfulRectangle(x+2,y+2,46,46,Orange,grayOrange);
			ColorfulRectangle SecretEnding4 = new ColorfulRectangle(x+3,y+3,46,46,Pink,grayPink);
			ColorfulRectangle SecretEnding5 = new ColorfulRectangle(x+4,y+4,42,42,Blue,grayBlue);
			ColorfulRectangle SecretEnding6 = new ColorfulRectangle(x+5,y+5,40,40,Yellow,grayYellow);
			ColorfulRectangle SecretEnding7 = new ColorfulRectangle(x+6,y+6,38,38,Pink,grayPink);
			ColorfulRectangle SecretEnding8 = new ColorfulRectangle(x+7,y+7,36,36,Green,grayGreen);
			ColorfulRectangle SecretEnding9 = new ColorfulRectangle(x+8,y+8,34,34,Blue,grayBlue);
			ColorfulRectangle SecretEnding10 = new ColorfulRectangle(x+9,y+9,32,32,Magenta,grayMagenta);
			ColorfulRectangle SecretEnding11 = new ColorfulRectangle(x+10,y+10,30,30,Blue,grayBlue);
			ColorfulRectangle SecretEnding12 = new ColorfulRectangle(x+11,y+11,28,28,Pink,grayPink);
			ColorfulRectangle SecretEnding13 = new ColorfulRectangle(x+12,y+12,26,26,Magenta,grayMagenta);
			ColorfulRectangle SecretEnding14 = new ColorfulRectangle(x+13,y+13,24,24,Blue,grayBlue);
			ColorfulRectangle SecretEnding15 = new ColorfulRectangle(x+12,y+12,22,22,Pink,grayPink);
			ColorfulRectangle SecretEnding16 = new ColorfulRectangle(x+13,y+13,22,22,Magenta,grayMagenta);
			ColorfulRectangle SecretEnding17 = new ColorfulRectangle(x+14,y+14,22,22,Blue,grayBlue);
			ColorfulRectangle SecretEnding18 = new ColorfulRectangle(x+15,y+15,20,20,Color.LIGHT_GRAY);
			ColorfulRectangle SecretEnding19 = new ColorfulRectangle(x+16,y+16,20,20,Pink,grayPink);
			...
			}else if(!FlashingLights && !menushown && !optionsshown && !pausedshown && !mapshown && !winscreenshown){
				SecretEnding2.draw();
				SecretEnding6.draw();
				SecretEnding8.draw();
				SecretEnding10.draw();
	...
	class Endingdoor extends ColorfulRectangle{
		...
		public void update() {
			...
			if(!mapshown && !optionsshown && !pausedshown && !winscreenshown) {
