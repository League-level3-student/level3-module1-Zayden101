...
public class RetroCube extends PApplet {
...
//    float w = 2 * 150;
    ...
    public void setup() {
        ...
        Rectangle rct = new Rectangle(250, 450, 800, 250);
        rects.add(rct);

        
        Rectangle rct1 = new Rectangle(250, 495, 800, 250);
        rects.add(rct1);
        
        Rectangle rct2 = new Rectangle(250, 540, 800, 250);
        rects.add(rct2);
        
        Rectangle rct3 = new Rectangle(250, 585, 800, 250);
        rects.add(rct3);
    ...
    public void draw() {
        ...
        // Draw an rect for the sun in the center of the window
...
//        }
    ...
    static public void main(String[] passedArgs) {
        PApplet.main(RetroCube.class.getName());
    }
