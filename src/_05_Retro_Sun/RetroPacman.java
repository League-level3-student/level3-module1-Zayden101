...
public class RetroPacman extends PApplet {
...
//    float w = 2 * 150;
    ...
    public void draw() {
        ...
        // Draw an arc for the sun in the center of the window
        // Use fill(sunColors[0]) to make it yellow
        // Use noStroke() to remove the black outline
        fill(sunColors[0]);
        stroke(0,0,0,0);
        arc(400,300,300,300, HALF_PI-QUARTER_PI, TWO_PI-QUARTER_PI);
       
        
        
//        fill(25,255,255,50);
//        arc(mouseX,mouseY,30,30);
...
//        }
    ...
    static public void main(String[] passedArgs) {
        PApplet.main(RetroPacman.class.getName());
    }
