...
//    float w = 2 * 150;
    ...
    public void setup() {
        ...
        Rectangle rct1 = new Rectangle(250, 500, 300, 250);
        rects.add(rct1);
        
        Rectangle rct2 = new Rectangle(250, 550, 300, 250);
        rects.add(rct2);
        
        Rectangle rct3 = new Rectangle(250, 600, 300, 250);
        rects.add(rct3);
    }
