...
public class RetroSun2 extends PApplet {
    ...
    public void draw() {
        ...
        // to check if the pixel is the color of the yellow circle.
                ...
                delay(650);
             	...
             	a1 = new Random().nextInt(600);
             	a2 = new Random().nextInt(600);
 ...
 if(srt==0){
	...
	srt=1;
     ...
     if(mouseX<=wid1 && mouseX>=wid2 && mouseY<=hig1 && mouseY>=hig2) {
    	 ...
    	 JOptionPane.showMessageDialog(null, " mousex: " + mouseX + " mousey: " + mouseY + "   wid1: " + wid1 + " wid2: " + wid2 + "   hig1: " + hig1 + " hig2: " + hig2);
     	//System.exit(0);
     }
...
//        }
    ...
    static public void main(String[] passedArgs) {
        PApplet.main(RetroSun2.class.getName());
    }
