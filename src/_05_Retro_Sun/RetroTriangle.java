...
public class RetroTriangle extends PApplet {
...
//    float w = 2 * 150;
    ...
    public void setup() {
        ...
        Rectangle rct = new Rectangle(250, 550, 300, 250);
        rects.add(rct);

        
        Rectangle rct1 = new Rectangle(250, 600, 300, 250);
        rects.add(rct1);
        
        Rectangle rct2 = new Rectangle(250, 650, 300, 250);
        rects.add(rct2);
        
        Rectangle rct3 = new Rectangle(250, 700, 300, 250);
        rects.add(rct3);
        
        Rectangle rct4 = new Rectangle(250, 750, 300, 250);
        rects.add(rct4);
    }
    ...
    public void draw() {
        ...
        // Draw an triangle for the sun in the center of the window
        // Use fill(sunColors[0]) to make it yellow
        // Use noStroke() to remove the black outline
        fill(sunColors[0]);
        stroke(0,0,0,0);
        triangle(650,100,400,500,150,100);
...
//        }
    ...
    static public void main(String[] passedArgs) {
        PApplet.main(RetroTriangle.class.getName());
    }
