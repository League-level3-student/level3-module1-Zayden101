package _05_Retro_Sun_game_test;
...
public class RetroSunGame_Clicker extends PApplet {
	...
	public void draw() {
		...
		int a1 = new Random().nextInt(600);
		int a2 = new Random().nextInt(600);
		...
		//put ellipse ad wid and hig
		if(srt==0){
			JOptionPane.showMessageDialog(null, "Keep cursor inside circle");
			srt=1;
			fill(0,255,0);
		...
		if(clicked==1) {
			if(mosx<=wid1 && mosx>=wid2 && mosy<=hig1 && mosy>=hig2) {
				...
				mosx=0;
				mosy=0;
				//JOptionPane.showMessageDialog(null, "   wid1: " + wid1 + "    mousex: " + mouseX + "    wid2: " + wid2 + "      hig1: " + hig1 + "   mousey: " + mouseY + "   hig2: " + hig2);
				//System.exit(0);
			}
		}else {
...
//		}
	...
	public void mousePressed() {
		...
		ellipse(mosx,mosy,100,100);
	
	}

	static public void main(String[] passedArgs) {
		PApplet.main(RetroSunGame_Clicker.class.getName());
	}
